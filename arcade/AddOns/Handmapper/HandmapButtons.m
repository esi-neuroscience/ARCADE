classdef HandmapButtons < handle
    ...
    methods (Static)
        ...
        function [ hEdit ] = dropdown(parent, Label, Value, Choices, posLL, callback)
            ...
            % rearrange
            set(hEdit, 'Position', [1, 3, pos2(3), pos2(4)]);
            set(h, 'Position', [posLL panPos(3:4)]);
            set(label, 'Position', [0 pos2(4)-4 pos(3:4)]);
        end
        ...
        function [ editBox ] = editbox(parent, Label, Value, posLL, callback)
            ...
            % rearrange
            set(editBox, 'Position', [3, 1, pos2(3)-20, pos2(4)], ...
                'String',Value);
            %pos2 = get(editBox, 'Position');
            set(h, 'Position', [posLL panPos(3:4)]);
            set(label, 'Position', [-4 pos2(4)-4 pos(3:4)]);
        end
        ...
        function hEdit = editbox_range(parent, Label, Value, Min, Max, posLL, callback)
            ...
            % rearrange
            set(hEdit, 'Position', [3, 1, pos2(3)-20, pos2(4)], ...
                'String',Value);
            %pos2 = get(hEdit, 'Position');
            set(h, 'Position', [posLL panPos(3:4)]);
            set(label, 'Position', [-4 pos2(4)-4 pos(3:4)]);
        ...
        function [ hEdit ] = editbox_rgb( parent, String, Value, Min, Max, posLL, ...
            ...
            set(edit1, 'Position', [1, 1, pos1(3)-30, pos1(4)], ...
                'String',Value(1));
            pos1 = get(edit1, 'Position');
            ...
            edit2 = uicontrol(h, ...
                'Style','Edit', ...
                'Callback', callback, ...
                'Position', [pos1(3), 1, pos1(3), pos1(4)], ...
                'String',Value(2));
            ...
            edit3 = uicontrol(h, ...
                'Style','Edit', ...
                'Callback', callback, ...
                'Position', [pos2(1)+pos2(3), 1, pos2(3), pos2(4)], ...
                'String',Value(3));
            pos3 = get(edit3, 'Position');
            
            % rearrange
            set(h, 'Position', [posLL panPos(3:4)]);
            labelStart = pos2(1) + pos2(3)/2 - pos(3)/2;
            set(label, 'Position', [labelStart pos2(4)-4 pos(3:4)]);
