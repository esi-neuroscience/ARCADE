classdef HLOGratingCutout < OBJPixelShader & SPCHighLevelObject
    % [HIGH LEVEL OBJECT]
    ...
    %# constructor
    methods (Static)
        function this = HLOGratingCutout
            this.mCreateInputParser; % create input parser

            gratfxFile = 'Grating_maskLT1000p_cutout.fx'; % file for this stimulus 
...
%                 'phaseShift'};
    ...
    methods (Access = protected)
        ...
        function mCreateInputParser(this)
            ...
            val.maskRadius     = validateScalar;
            val.maskX          = validateScalar;
            val.maskY          = validateScalar;
