classdef EyelinkConfig < handle
    ...
    properties ( Access = public )
        ...
        elcl_select_configuration = 'BLRR';
        ...
        function param = read_param(parameterName)
            ...
            switch param
                case 'Unknown Variable Name'
                    error('Eyelink: failed to read %s from tracker, unknown variable name')
                case 'Variable read not supported'
                    error('Eyelink: failed to read %s from tracker, variable not supported')
            end
