...
#define DNS_RCLASS_INTERNET 256 
#define DNS_RCLASS_CSNET 512 
#define DNS_RCLASS_CHAOS 768 
#define DNS_RCLASS_HESIOD 1024 
...
#define DNS_RTYPE_A 256 
#define DNS_RTYPE_NS 512 
#define DNS_RTYPE_MD 768 
#define DNS_RTYPE_MF 1024 
#define DNS_RTYPE_CNAME 1280 
#define DNS_RTYPE_SOA 1536 
#define DNS_RTYPE_MB 1792 
#define DNS_RTYPE_MG 2048 
#define DNS_RTYPE_MR 2304 
#define DNS_RTYPE_NULL 2560 
#define DNS_RTYPE_WKS 2816 
#define DNS_RTYPE_PTR 3072 
#define DNS_RTYPE_HINFO 3328 
#define DNS_RTYPE_MINFO 3584 
#define DNS_RTYPE_MX 3840 
...
#define DNS_RTYPE_WINS 511 
#define DNS_RTYPE_WINSR 767 
#ifndef ATMA_E164
...
#define DNSSEC_KEY_FLAG_NOAUTH 1
#define DNSSEC_KEY_FLAG_NOCONF 2
#define DNSSEC_KEY_FLAG_FLAG2 4
#define DNSSEC_KEY_FLAG_EXTEND 8
#define DNSSEC_KEY_FLAG_
#define DNSSEC_KEY_FLAG_FLAG4 16
#define DNSSEC_KEY_FLAG_FLAG5 32
#define DNSSEC_KEY_FLAG_USER 0
#define DNSSEC_KEY_FLAG_ZONE 64
#define DNSSEC_KEY_FLAG_HOST 128
#define DNSSEC_KEY_FLAG_NTPE3 192
#define DNSSEC_KEY_FLAG_FLAG8 256
#define DNSSEC_KEY_FLAG_FLAG9 512
#define DNSSEC_KEY_FLAG_FLAG10 1024
#define DNSSEC_KEY_FLAG_FLAG11 2048
#define DNSSEC_KEY_FLAG_SIG0 0
...
#define DNS_WINS_FLAG_LOCAL 0x10000
...
typedef enum {
	DnsConfigPrimaryDomainName_W,DnsConfigPrimaryDomainName_A,DnsConfigPrimaryDomainName_UTF8,DnsConfigAdapterDomainName_W,DnsConfigAdapterDomainName_A,DnsConfigAdapterDomainName_UTF8,DnsConfigDnsServerList,DnsConfigSearchList,DnsConfigAdapterInfo,
	DnsConfigPrimaryHostNameRegistrationEnabled,DnsConfigAdapterHostNameRegistrationEnabled,DnsConfigAddressRegistrationMaxCount,DnsConfigHostName_W,DnsConfigHostName_A,DnsConfigHostName_UTF8,DnsConfigFullHostName_W,DnsConfigFullHostName_A,DnsConfigFullHostName_UTF8
}
DNS_CONFIG_TYPE;
#define DNS_CONFIG_FLAG_ALLOC 1
...
#define DNSREC_SECTION 3
#define DNSREC_QUESTION 0
#define DNSREC_ANSWER 1
#define DNSREC_AUTHORITY 2
#define DNSREC_ADDITIONAL 3
#define DNSREC_ZONE 0
#define DNSREC_PREREQ 1
#define DNSREC_UPDATE 2
#define DNSREC_DELETE 4
#define DNSREC_NOEXIST 4
#ifdef MIDL_PASS
...
#define DNS_QUERY_ACCEPT_TRUNCATED_RESPONSE 1
#define DNS_QUERY_USE_TCP_ONLY 2
#define DNS_QUERY_NO_RECURSION 4
#define DNS_QUERY_BYPASS_CACHE 8
#define DNS_QUERY_NO_WIRE_QUERY 16
#define DNS_QUERY_NO_LOCAL_NAME 32
#define DNS_QUERY_NO_HOSTS_FILE 64
#define DNS_QUERY_NO_NETBT 128
#define DNS_QUERY_WIRE_ONLY 256
#define DNS_QUERY_RETURN_MESSAGE 512
...
DNS_STATUS WINAPI DnsQuery_A(PCSTR pszName,WORD wType,DWORD Options,PIP4_ARRAY aipServers,PDNS_RECORD * ppQueryResults,PVOID * pReserved OPTIONAL);
DNS_STATUS WINAPI DnsQuery_UTF8(PCSTR pszName,WORD wType,DWORD Options,PIP4_ARRAY aipServers,PDNS_RECORD * ppQueryResults,PVOID * pReserved OPTIONAL);
DNS_STATUS WINAPI DnsQuery_W(PCWSTR pszName,WORD wType,DWORD Options,PIP4_ARRAY aipServers,PDNS_RECORD * ppQueryResults,PVOID * pReserved OPTIONAL);
#ifdef UNICODE
#define DnsQuery DnsQuery_W
#else
#define DnsQuery DnsQuery_A
#endif
#define DNS_UPDATE_SECURITY_USE_DEFAULT 0
#define DNS_UPDATE_SECURITY_OFF 16
#define DNS_UPDATE_SECURITY_ON 32
#define DNS_UPDATE_SECURITY_ONLY 256
#define DNS_UPDATE_CACHE_SECURITY_CONTEXT 512
#define DNS_UPDATE_TEST_USE_LOCAL_SYS_ACCT 1024
#define DNS_UPDATE_FORCE_SECURITY_NEGO 2048
#define DNS_UPDATE_TRY_ALL_MASTER_SERVERS 0x1000
#define DNS_UPDATE_SKIP_NO_UPDATE_ADAPTERS 0x2000
#define DNS_UPDATE_REMOTE_SERVER 0x4000
#define DNS_UPDATE_RESERVED 0xffff0000
DNS_STATUS WINAPI DnsAcquireContextHandle_W(DWORD CredentialFlags,PVOID pCredentials,OPTIONAL
	 PHANDLE pContextHandle);
DNS_STATUS WINAPI DnsAcquireContextHandle_A(DWORD CredentialFlags,PVOID pCredentials,OPTIONAL
	 PHANDLE pContextHandle);
#ifdef UNICODE
...
DNS_STATUS WINAPI DnsModifyRecordsInSet_W(PDNS_RECORD pAddRecords,PDNS_RECORD pDeleteRecords,DWORD Options,HANDLE hContext,OPTIONAL
	 PIP4_ARRAY pServerList,OPTIONAL
	 PVOID pReserved);
DNS_STATUS WINAPI DnsModifyRecordsInSet_A(PDNS_RECORD pAddRecords,PDNS_RECORD pDeleteRecords,DWORD Options,HANDLE hContext,OPTIONAL
	 PIP4_ARRAY pServerList,OPTIONAL
	 PVOID pReserved);
DNS_STATUS WINAPI DnsModifyRecordsInSet_UTF8(PDNS_RECORD pAddRecords,PDNS_RECORD pDeleteRecords,DWORD Options,HANDLE hContext,OPTIONAL
	 PIP4_ARRAY pServerList,OPTIONAL
	 PVOID pReserved);
#ifdef UNICODE
...
#endif
DNS_STATUS WINAPI DnsReplaceRecordSetW(PDNS_RECORD pNewSet,DWORD Options,HANDLE hContext,OPTIONAL
	 PIP4_ARRAY pServerList,OPTIONAL
	 PVOID pReserved);
DNS_STATUS WINAPI DnsReplaceRecordSetA(PDNS_RECORD pNewSet,DWORD Options,HANDLE hContext,OPTIONAL
	 PIP4_ARRAY pServerList,OPTIONAL
	 PVOID pReserved);
DNS_STATUS WINAPI DnsReplaceRecordSetUTF8(PDNS_RECORD pNewSet,DWORD Options,HANDLE hContext,OPTIONAL
	 PIP4_ARRAY pServerList,OPTIONAL
	 PVOID pReserved);
#ifdef UNICODE
...
BOOL WINAPI DnsNameCompare_W(LPWSTR pName1,LPWSTR pName2);
#ifdef UNICODE
...
BOOL WINAPI DnsWriteQuestionToBuffer_W(PDNS_MESSAGE_BUFFER pDnsBuffer,PDWORD pdwBufferSize,LPWSTR pszName,WORD wType,WORD Xid,BOOL fRecursionDesired);
BOOL WINAPI
DnsWriteQuestionToBuffer_UTF8(PDNS_MESSAGE_BUFFER pDnsBuffer,LPDWORD pdwBufferSize,LPSTR pszName,WORD wType,WORD Xid,BOOL fRecursionDesired);
