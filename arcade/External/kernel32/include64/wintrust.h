...
#define WTPF_OFFLINEOKNBU_IND 0x1000 
#define WTPF_OFFLINEOKNBU_COM 0x2000 
#define WTPF_VERIFY_V1_OFF 0x10000 
#define WTPF_IGNOREREVOCATIONONTS 0x20000 
#define WTPF_ALLOWONLYPERTRUST 0x40000 
...
typedef BOOL (*PFN_CPD_ADD_SGNR)( struct _CRYPT_PROVIDER_DATA *pProvData,BOOL fCounterSigner,OPTIONAL DWORD idxSigner,struct _CRYPT_PROVIDER_SGNR *pSgnr2Add);
typedef BOOL (*PFN_CPD_ADD_CERT)( struct _CRYPT_PROVIDER_DATA *pProvData,DWORD idxSigner,BOOL fCounterSigner,OPTIONAL DWORD idxCounterSigner,PCCERT_CONTEXT pCert2Add);
...
typedef BOOL (*PFN_PROVIDER_CERTCHKPOLICY_CALL)( struct _CRYPT_PROVIDER_DATA *pProvData,DWORD idxSigner,BOOL fCounterSignerChain,OPTIONAL DWORD idxCounterSigner);
...
typedef BOOL (*PFN_ALLOCANDFILLDEFUSAGE)( const char *pszUsageOID,struct _CRYPT_PROVIDER_DEFUSAGE *psDefUsage);
typedef BOOL (*PFN_FREEDEFUSAGE)( const char *pszUsageOID,struct _CRYPT_PROVIDER_DEFUSAGE *psDefUsage);
...
extern BOOL WINAPI WintrustAddActionID( GUID *pgActionID,DWORD fdwFlags,CRYPT_REGISTER_ACTIONID *psProvInfo);
#define WT_ADD_ACTION_ID_RET_RESULT_FLAG 1
extern BOOL WINAPI WintrustRemoveActionID( GUID *pgActionID);
extern BOOL WINAPI WintrustLoadFunctionPointers(GUID *pgActionID, CRYPT_PROVIDER_FUNCTIONS *pPfns);
extern BOOL WINAPI WintrustAddDefaultForUsage( const char *pszUsageOID,CRYPT_PROVIDER_REGDEFUSAGE *psDefUsage);
#define DWACTION_ALLOCANDFILL 1
#define DWACTION_FREE 2
extern BOOL WINAPI WintrustGetDefaultForUsage( DWORD dwAction,const char *pszUsageOID,CRYPT_PROVIDER_DEFUSAGE *psUsage);
extern CRYPT_PROVIDER_SGNR * WINAPI WTHelperGetProvSignerFromChain(CRYPT_PROVIDER_DATA *pProvData,DWORD idxSigner,BOOL fCounterSigner,DWORD idxCounterSigner);
