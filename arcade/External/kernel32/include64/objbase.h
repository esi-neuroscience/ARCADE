...
#else
*/
//#define WINOLEAPI        EXTERN_C DECLSPEC_IMPORT HRESULT
#define WINOLEAPI	__declspec(dllimport) HRESULT
#define WINOLEAPI_(type) EXTERN_C __declspec(dllimport) type 
//#endif
