...
#else	
#define RICHEDIT_CLASSW		TEXT("RichEdit20W")	
#endif 
...
typedef enum tagTextMode {
	TM_PLAINTEXT			=1,TM_RICHTEXT				=2,	
	TM_SINGLELEVELUNDO		=4,TM_MULTILEVELUNDO		=8,	
	TM_SINGLECODEPAGE		=16,TM_MULTICODEPAGE		=32	
} TEXTMODE;
...
#define SES_CTFALLOWSMARTTAG	0x400000
#define SES_CTFALLOWPROOFING	0x800000
...
#define CTFMODEBIAS_FULLWIDTHALPHANUMERIC	11
#define CTFMODEBIAS_HALFWIDTHALPHANUMERIC	12
#define IMF_SMODE_PLAURALCLAUSE	1
...
typedef enum _undonameid {
	UID_UNKNOWN=0,UID_TYPING		=1,UID_DELETE 		=2,UID_DRAGDROP	=3,UID_CUT			=4,UID_PASTE		=5,UID_AUTOCORRECT=6
} UNDONAMEID;
#define ST_DEFAULT		0
