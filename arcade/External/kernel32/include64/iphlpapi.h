...
DWORD WINAPI GetUniDirectionalAdapterInfo(OUT PIP_UNIDIRECTIONAL_ADAPTER_ADDRESS pIPIfInfo,PULONG dwOutBufLen);
...
#pragma warning(pop)
DWORD WINAPI GetBestRoute(DWORD dwDestAddr,DWORD dwSourceAddr,OPTIONAL
...
WINAPI GetAdapterOrderMap(VOID);
#ifdef _WINSOCK2API_
