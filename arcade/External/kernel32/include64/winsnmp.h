...
typedef struct {
	 smiUINT32 hipart;
	 smiUINT32 lopart;} smiCNTR64,*smiLPCNTR64;
...
typedef SNMPAPI_STATUS (CALLBACK *SNMPAPI_CALLBACK)
				(HSNMP_SESSION hSession,HWND hWnd,UINT wMsg,WPARAM wParam,LPARAM lParam,LPVOID lpClientData);
...
SNMPAPI_STATUS SNMPAPI_CALL SnmpGetTimeout
				(HSNMP_ENTITY hEntity,smiLPTIMETICKS nPolicyTimeout,smiLPTIMETICKS nActualTimeout);
SNMPAPI_STATUS SNMPAPI_CALL SnmpSetTimeout
				(HSNMP_ENTITY hEntity,smiTIMETICKS nPolicyTimeout);
SNMPAPI_STATUS SNMPAPI_CALL SnmpGetRetry
				(HSNMP_ENTITY hEntity,smiLPUINT32 nPolicyRetry,smiLPUINT32 nActualRetry);
SNMPAPI_STATUS SNMPAPI_CALL SnmpSetRetry
				(HSNMP_ENTITY hEntity,smiUINT32 nPolicyRetry);
SNMPAPI_STATUS SNMPAPI_CALL SnmpGetVendorInfo
				(OUT smiLPVENDORINFO vendorInfo);
SNMPAPI_STATUS SNMPAPI_CALL SnmpStartup
				(OUT smiLPUINT32 nMajorVersion,smiLPUINT32 nMinorVersion,smiLPUINT32 nLevel,smiLPUINT32 nTranslateMode,smiLPUINT32 nRetransmitMode);
...
SNMPAPI_STATUS SNMPAPI_CALL SnmpSendMsg
				(HSNMP_SESSION session,HSNMP_ENTITY srcEntity,HSNMP_ENTITY dstEntity,HSNMP_CONTEXT context,HSNMP_PDU PDU);
SNMPAPI_STATUS SNMPAPI_CALL SnmpRecvMsg
				(HSNMP_SESSION session,LPHSNMP_ENTITY srcEntity,LPHSNMP_ENTITY dstEntity,LPHSNMP_CONTEXT context,LPHSNMP_PDU PDU);
SNMPAPI_STATUS SNMPAPI_CALL SnmpRegister
				(HSNMP_SESSION session,HSNMP_ENTITY srcEntity,HSNMP_ENTITY dstEntity,HSNMP_CONTEXT context,smiLPCOID notification,smiUINT32 state);
HSNMP_SESSION SNMPAPI_CALL SnmpCreateSession
				(HWND hWnd,UINT wMsg,SNMPAPI_CALLBACK fCallBack,LPVOID lpClientData);
SNMPAPI_STATUS SNMPAPI_CALL SnmpListen
				(HSNMP_ENTITY hEntity,SNMPAPI_STATUS lStatus);
SNMPAPI_STATUS SNMPAPI_CALL SnmpCancelMsg
				(HSNMP_SESSION session,smiINT32 reqId);
SNMPAPI_STATUS SNMPAPI_CALL SnmpStartupEx 
				(OUT smiLPUINT32 nMajorVersion,smiLPUINT32 nMinorVersion,smiLPUINT32 nLevel,smiLPUINT32 nTranslateMode,smiLPUINT32 nRetransmitMode);
typedef SNMPAPI_STATUS (__stdcall * PFNSNMPSTARTUPEX)(smiLPUINT32,smiLPUINT32,smiLPUINT32,smiLPUINT32,smiLPUINT32);
...
HSNMP_ENTITY SNMPAPI_CALL SnmpStrToEntity
				(HSNMP_SESSION session,LPCSTR string);
SNMPAPI_STATUS SNMPAPI_CALL SnmpEntityToStr
				(HSNMP_ENTITY entity,smiUINT32 size,LPSTR string);
SNMPAPI_STATUS SNMPAPI_CALL SnmpFreeEntity
				(HSNMP_ENTITY entity);
HSNMP_CONTEXT SNMPAPI_CALL SnmpStrToContext
				(HSNMP_SESSION session,smiLPCOCTETS string);
SNMPAPI_STATUS SNMPAPI_CALL SnmpContextToStr
				(HSNMP_CONTEXT context,smiLPOCTETS string);
SNMPAPI_STATUS SNMPAPI_CALL SnmpFreeContext
				(HSNMP_CONTEXT context);
SNMPAPI_STATUS SNMPAPI_CALL SnmpSetPort
				(HSNMP_ENTITY hEntity,UINT nPort);
HSNMP_PDU SNMPAPI_CALL SnmpCreatePdu
				(HSNMP_SESSION session,smiINT PDU_type,smiINT32 request_id,smiINT error_status,smiINT error_index,HSNMP_VBL varbindlist);
SNMPAPI_STATUS SNMPAPI_CALL SnmpGetPduData
				(HSNMP_PDU PDU,smiLPINT PDU_type,smiLPINT32 request_id,smiLPINT error_status,smiLPINT error_index,LPHSNMP_VBL varbindlist);
SNMPAPI_STATUS SNMPAPI_CALL SnmpSetPduData
				(HSNMP_PDU PDU,const smiINT *PDU_type,const smiINT32 *request_id,const smiINT *non_repeaters,const smiINT *max_repetitions,const HSNMP_VBL *varbindlist);
HSNMP_PDU SNMPAPI_CALL SnmpDuplicatePdu
				(HSNMP_SESSION session,HSNMP_PDU PDU);
SNMPAPI_STATUS SNMPAPI_CALL SnmpFreePdu
				(HSNMP_PDU PDU);
HSNMP_VBL SNMPAPI_CALL SnmpCreateVbl
				(HSNMP_SESSION session,smiLPCOID name,smiLPCVALUE value);
HSNMP_VBL SNMPAPI_CALL SnmpDuplicateVbl
				(HSNMP_SESSION session,HSNMP_VBL vbl);
SNMPAPI_STATUS SNMPAPI_CALL SnmpFreeVbl
				(HSNMP_VBL vbl);
SNMPAPI_STATUS SNMPAPI_CALL SnmpCountVbl
				(HSNMP_VBL vbl);
SNMPAPI_STATUS SNMPAPI_CALL SnmpGetVb
				(HSNMP_VBL vbl,smiUINT32 index,smiLPOID name,smiLPVALUE value);
SNMPAPI_STATUS SNMPAPI_CALL SnmpSetVb
				(HSNMP_VBL vbl,smiUINT32 index,smiLPCOID name,smiLPCVALUE value);
SNMPAPI_STATUS SNMPAPI_CALL SnmpDeleteVb
				(HSNMP_VBL vbl,smiUINT32 index);
SNMPAPI_STATUS SNMPAPI_CALL SnmpGetLastError
				(HSNMP_SESSION session);
SNMPAPI_STATUS SNMPAPI_CALL SnmpStrToOid
				(LPCSTR string,smiLPOID dstOID);
SNMPAPI_STATUS SNMPAPI_CALL SnmpOidToStr
				(smiLPCOID srcOID,smiUINT32 size,LPSTR string);
SNMPAPI_STATUS SNMPAPI_CALL SnmpOidCopy
				(smiLPCOID srcOID,smiLPOID dstOID);
SNMPAPI_STATUS SNMPAPI_CALL SnmpOidCompare
				(smiLPCOID xOID,smiLPCOID yOID,smiUINT32 maxlen,smiLPINT result);
SNMPAPI_STATUS SNMPAPI_CALL SnmpEncodeMsg
				(HSNMP_SESSION session,HSNMP_ENTITY srcEntity,HSNMP_ENTITY dstEntity,HSNMP_CONTEXT context,HSNMP_PDU pdu,smiLPOCTETS msgBufDesc);
SNMPAPI_STATUS SNMPAPI_CALL SnmpDecodeMsg
				(HSNMP_SESSION session,LPHSNMP_ENTITY srcEntity,LPHSNMP_ENTITY dstEntity,LPHSNMP_CONTEXT context,LPHSNMP_PDU pdu,smiLPCOCTETS msgBufDesc);
SNMPAPI_STATUS SNMPAPI_CALL SnmpFreeDescriptor
				(smiUINT32 syntax,smiLPOPAQUE descriptor);
#endif 
