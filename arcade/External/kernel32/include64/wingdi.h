...
#define NTM_BOLD 32
#define NTM_ITALIC 1
#define NTM_NONNEGATIVE_AC 0x10000
#define NTM_PS_OPENTYPE 0x20000
#define NTM_TT_OPENTYPE 0x40000
#define NTM_MULTIPLEMASTER 0x80000
#define NTM_TYPE1 0x100000
#define NTM_DSIG 0x200000
#include <pshpack4.h>
...
#define DISPLAY_DEVICE_REMOTE 0x4000000
#define DISPLAY_DEVICE_DISCONNECT 0x2000000
...
#endif
WINGDIAPI BOOL	WINAPI AnimatePalette(HPALETTE hPal,UINT iStartIndex,	UINT cEntries,CONST PALETTEENTRY * ppe);
WINGDIAPI BOOL	WINAPI Arc(HDC hdc,int x1,int y1,int x2,int y2,int x3,int y3,int x4,int y4);
...
WINGDIAPI BOOL WINAPI Chord(HDC hdc,int x1,int y1,int x2,int y2,int x3,int y3,int x4,int y4);
...
WINGDIAPI BOOL WINAPI CreateScalableFontResourceA(DWORD fdwHidden,LPCSTR lpszFont,LPCSTR lpszFile,LPCSTR lpszPath);
WINGDIAPI BOOL WINAPI CreateScalableFontResourceW(DWORD fdwHidden,LPCWSTR lpszFont,LPCWSTR lpszFile,LPCWSTR lpszPath);
#ifdef UNICODE
...
WINGDIAPI BOOL WINAPI Ellipse(HDC hdc,int left,int top,int right,int bottom);
#if(WINVER >=0x0400)
...
#else
WINGDIAPI int WINAPI EnumObjects(HDC hdc,int nType,GOBJENUMPROC lpFunc,LPVOID lParam);
#endif
...
WINGDIAPI BOOL WINAPI ExtFloodFill(HDC hdc,int x,int y,COLORREF color,UINT type);
WINGDIAPI BOOL WINAPI FillRgn(HDC hdc,HRGN hrgn,HBRUSH hbr);
WINGDIAPI BOOL WINAPI FloodFill(HDC hdc,int x,int y,COLORREF color);
WINGDIAPI BOOL WINAPI FrameRgn(HDC hdc,HRGN hrgn,HBRUSH hbr,int w,int h);
WINGDIAPI int WINAPI GetROP2(HDC hdc);
WINGDIAPI BOOL WINAPI GetAspectRatioFilterEx(HDC hdc,LPSIZE lpsize);
...
WINGDIAPI BOOL WINAPI GetBitmapDimensionEx(HBITMAP hbit,LPSIZE lpsize);
WINGDIAPI UINT WINAPI GetBoundsRect(HDC hdc,LPRECT lprect,UINT flags);
WINGDIAPI BOOL WINAPI GetBrushOrgEx(HDC hdc,LPPOINT lppt);
WINGDIAPI BOOL WINAPI GetCharWidthA(HDC hdc,UINT iFirst,UINT iLast,LPINT lpBuffer);
WINGDIAPI BOOL WINAPI GetCharWidthW(HDC hdc,UINT iFirst,UINT iLast,LPINT lpBuffer);
#ifdef UNICODE
#define GetCharWidth GetCharWidthW
#else
#define GetCharWidth GetCharWidthA
#endif
WINGDIAPI BOOL WINAPI GetCharWidth32A(HDC hdc,UINT iFirst,UINT iLast,LPINT lpBuffer);
WINGDIAPI BOOL WINAPI GetCharWidth32W(HDC hdc,UINT iFirst,UINT iLast,LPINT lpBuffer);
#ifdef UNICODE
#define GetCharWidth32 GetCharWidth32W
#else
#define GetCharWidth32 GetCharWidth32A
#endif
WINGDIAPI BOOL APIENTRY GetCharWidthFloatA(HDC hdc,UINT iFirst,UINT iLast,PFLOAT lpBuffer);
WINGDIAPI BOOL APIENTRY GetCharWidthFloatW(HDC hdc,UINT iFirst,UINT iLast,PFLOAT lpBuffer);
#ifdef UNICODE
#define GetCharWidthFloat GetCharWidthFloatW
#else
#define GetCharWidthFloat GetCharWidthFloatA
#endif
WINGDIAPI BOOL APIENTRY GetCharABCWidthsA(HDC hdc,UINT wFirst,UINT wLast,LPABC lpABC);
WINGDIAPI BOOL APIENTRY GetCharABCWidthsW(HDC hdc,UINT wFirst,UINT wLast,LPABC lpABC);
#ifdef UNICODE
#define GetCharABCWidths GetCharABCWidthsW
#else
#define GetCharABCWidths GetCharABCWidthsA
#endif
WINGDIAPI BOOL APIENTRY GetCharABCWidthsFloatA(HDC hdc,UINT iFirst,UINT iLast,LPABCFLOAT lpABC);
WINGDIAPI BOOL APIENTRY GetCharABCWidthsFloatW(HDC hdc,UINT iFirst,UINT iLast,LPABCFLOAT lpABC);
#ifdef UNICODE
...
WINGDIAPI BOOL WINAPI GetCurrentPositionEx(HDC hdc,LPPOINT lppt);
...
#ifndef NOTEXTMETRIC
WINGDIAPI UINT APIENTRY GetOutlineTextMetricsA(HDC hdc,UINT cjCopy,LPOUTLINETEXTMETRICA potm);
WINGDIAPI UINT APIENTRY GetOutlineTextMetricsW(HDC hdc,UINT cjCopy,LPOUTLINETEXTMETRICW potm);
#ifdef UNICODE
...
WINGDIAPI BOOL WINAPI GetRasterizerCaps(LPRASTERIZER_STATUS lpraststat,UINT cjBytes);
...
WINGDIAPI BOOL APIENTRY GetTextExtentPointA(HDC hdc,LPCSTR lpString,int c,LPSIZE lpsz);
WINGDIAPI BOOL APIENTRY GetTextExtentPointW(HDC hdc,LPCWSTR lpString,int c,LPSIZE lpsz);
#ifdef UNICODE
#define GetTextExtentPoint GetTextExtentPointW
#else
#define GetTextExtentPoint GetTextExtentPointA
#endif
WINGDIAPI BOOL APIENTRY GetTextExtentPoint32A(HDC hdc,LPCSTR lpString,int c,LPSIZE psizl);
WINGDIAPI BOOL APIENTRY GetTextExtentPoint32W(HDC hdc,LPCWSTR lpString,int c,LPSIZE psizl);
#ifdef UNICODE
#define GetTextExtentPoint32 GetTextExtentPoint32W
#else
#define GetTextExtentPoint32 GetTextExtentPoint32A
#endif
WINGDIAPI BOOL APIENTRY GetTextExtentExPointA(HDC hdc,LPCSTR lpszString,int cchString,int nMaxExtent,LPINT lpnFit,LPINT lpnDx,LPSIZE lpSize);
WINGDIAPI BOOL APIENTRY GetTextExtentExPointW(HDC hdc,LPCWSTR lpszString,int cchString,int nMaxExtent,LPINT lpnFit,LPINT lpnDx,LPSIZE lpSize);
#ifdef UNICODE
...
WINGDIAPI BOOL WINAPI TranslateCharsetInfo(DWORD *lpSrc,LPCHARSETINFO lpCs,DWORD dwFlags);
...
#endif
WINGDIAPI BOOL WINAPI GetTextExtentPointI(HDC hdc,LPWORD pgiIn,int cgi,LPSIZE psize);
WINGDIAPI BOOL	WINAPI GetTextExtentExPointI (HDC hdc,LPWORD lpwszString,int cwchString,int nMaxExtent,LPINT lpnFit,LPINT lpnDx,LPSIZE lpSize);
WINGDIAPI BOOL WINAPI GetCharWidthI(HDC hdc,UINT giFirst,UINT cgi,LPWORD pgi,LPINT piWidths);
WINGDIAPI BOOL WINAPI GetCharABCWidthsI(HDC hdc,UINT giFirst,UINT cgi,LPWORD pgi,LPABC pabc);
...
#endif
WINGDIAPI BOOL WINAPI RemoveFontResourceExA(LPCSTR name,DWORD fl,PVOID pdv);
WINGDIAPI BOOL WINAPI RemoveFontResourceExW(LPCWSTR name,DWORD fl,PVOID pdv);
#ifdef UNICODE
...
WINGDIAPI BOOL WINAPI RemoveFontMemResourceEx(HANDLE h);
...
#endif
#endif
WINGDIAPI BOOL WINAPI GetViewportExtEx(HDC hdc,LPSIZE lpsize);
WINGDIAPI BOOL WINAPI GetViewportOrgEx(HDC hdc,LPPOINT lppoint);
WINGDIAPI BOOL WINAPI GetWindowExtEx(HDC hdc,LPSIZE lpsize);
WINGDIAPI BOOL WINAPI GetWindowOrgEx(HDC hdc,LPPOINT lppoint);
...
WINGDIAPI BOOL WINAPI LineDDA(int xStart,int yStart,int xEnd,int yEnd,LINEDDAPROC lpProc,LPARAM data);
WINGDIAPI BOOL WINAPI LineTo(HDC hdc,int x,int y);
WINGDIAPI BOOL WINAPI MaskBlt(HDC hdcDest,int xDest,int yDest,int width,int height,HDC hdcSrc,int xSrc,int ySrc,HBITMAP hbmMask,int xMask,int yMask,DWORD rop);
WINGDIAPI BOOL WINAPI PlgBlt(HDC hdcDest,CONST POINT * lpPoint,HDC hdcSrc,int xSrc,int ySrc,int width,int height,HBITMAP hbmMask,int xMask,int yMask);
...
WINGDIAPI BOOL WINAPI Pie(HDC hdc,int left,int top,int right,int bottom,int xr1,int yr1,int xr2,int yr2);
WINGDIAPI BOOL WINAPI PlayMetaFile(HDC hdc,HMETAFILE hmf);
WINGDIAPI BOOL WINAPI PaintRgn(HDC hdc,HRGN hrgn);
WINGDIAPI BOOL WINAPI PolyPolygon(HDC hdc,CONST POINT *apt,CONST INT *asz,int csz);
WINGDIAPI BOOL WINAPI PtInRegion(HRGN hrgn,int x,int y);
WINGDIAPI BOOL WINAPI PtVisible(HDC hdc,int x,int y);
WINGDIAPI BOOL WINAPI RectInRegion(HRGN hrgn,CONST RECT * lprect);
WINGDIAPI BOOL WINAPI RectVisible(HDC hdc,CONST RECT * lprect);
WINGDIAPI BOOL WINAPI Rectangle(HDC hdc,int left,int top,int right,int bottom);
...
WINGDIAPI BOOL WINAPI RemoveFontResourceA(LPCSTR lpFileName);
...
#endif
WINGDIAPI BOOL WINAPI RoundRect(HDC hdc,int left,int top,int right,int bottom,int width,int height);
WINGDIAPI BOOL WINAPI ResizePalette(HPALETTE hpal,UINT n);
...
WINGDIAPI HPALETTE WINAPI SelectPalette(HDC hdc,HPALETTE hPal,BOOL bForceBkgd);
...
WINGDIAPI BOOL WINAPI SetPixelV(HDC hdc,int x,int y,COLORREF color);
...
WINGDIAPI BOOL WINAPI SetRectRgn(HRGN hrgn,int left,int top,int right,int bottom);
...
WINGDIAPI BOOL WINAPI SetTextJustification(HDC hdc,int extra,int count);
...
#endif
#ifndef NOMETAFILE
WINGDIAPI BOOL WINAPI PlayMetaFileRecord(HDC hdc,LPHANDLETABLE lpHandleTable,LPMETARECORD lpMR,UINT noObjs);
typedef int (CALLBACK* MFENUMPROC)(HDC hdc,HANDLETABLE FAR* lpht,METARECORD FAR* lpMR,int nObj,LPARAM param);
WINGDIAPI BOOL	WINAPI EnumMetaFile(HDC hdc,HMETAFILE hmf,MFENUMPROC proc,LPARAM param);
typedef int (CALLBACK* ENHMFENUMPROC)(HDC hdc,HANDLETABLE FAR* lpht,CONST ENHMETARECORD * lpmr,int hHandles,LPARAM data);
...
WINGDIAPI BOOL WINAPI EnumEnhMetaFile(HDC hdc,HENHMETAFILE hmf,ENHMFENUMPROC proc,LPVOID param,CONST RECT * lpRect);
...
WINGDIAPI BOOL WINAPI PlayEnhMetaFileRecord(HDC hdc,LPHANDLETABLE pht,CONST ENHMETARECORD *pmr,UINT cht);
...
WINGDIAPI BOOL WINAPI GdiComment(HDC hdc,UINT nSize,CONST BYTE *lpData);
#endif
#ifndef NOTEXTMETRIC
WINGDIAPI BOOL WINAPI GetTextMetricsA(HDC hdc,LPTEXTMETRICA lptm);
...
WINGDIAPI BOOL WINAPI AngleArc(HDC hdc,int x,int y,DWORD r,FLOAT StartAngle,FLOAT SweepAngle);
WINGDIAPI BOOL WINAPI PolyPolyline(HDC hdc,CONST POINT *apt,CONST DWORD *asz,DWORD csz);
WINGDIAPI BOOL WINAPI GetWorldTransform(HDC hdc,LPXFORM lpxf);
WINGDIAPI BOOL WINAPI SetWorldTransform(HDC hdc,CONST XFORM * lpxf);
WINGDIAPI BOOL WINAPI ModifyWorldTransform(HDC hdc,CONST XFORM * lpxf,DWORD mode);
WINGDIAPI BOOL WINAPI CombineTransform(LPXFORM lpxfOut,CONST XFORM *lpxf1,CONST XFORM *lpxf2);
...
WINGDIAPI BOOL WINAPI ArcTo(HDC hdc,int left,int top,int right,int bottom,int xr1,int yr1,int xr2,int yr2);
...
WINGDIAPI BOOL WINAPI PolyDraw(HDC hdc,CONST POINT * apt,CONST BYTE * aj,int cpt);
WINGDIAPI BOOL WINAPI SelectClipPath(HDC hdc,int mode);
WINGDIAPI int WINAPI SetArcDirection(HDC hdc,int dir);
WINGDIAPI BOOL WINAPI SetMiterLimit(HDC hdc,FLOAT limit,PFLOAT old);
...
WINGDIAPI BOOL WINAPI GetMiterLimit(HDC hdc,PFLOAT plimit);
...
WINGDIAPI BOOL WINAPI TextOutA(HDC hdc,int x,int y,LPCSTR lpString,int c);
WINGDIAPI BOOL WINAPI TextOutW(HDC hdc,int x,int y,LPCWSTR lpString,int c);
#ifdef UNICODE
#define TextOut TextOutW
#else
#define TextOut TextOutA
#endif
WINGDIAPI BOOL	WINAPI ExtTextOutA(HDC hdc,int x,int y,UINT options,CONST RECT * lprect,LPCSTR lpString,UINT c,CONST INT * lpDx);
WINGDIAPI BOOL	WINAPI ExtTextOutW(HDC hdc,int x,int y,UINT options,CONST RECT * lprect,LPCWSTR lpString,UINT c,CONST INT * lpDx);
#ifdef UNICODE
#define ExtTextOut ExtTextOutW
#else
#define ExtTextOut ExtTextOutA
#endif
WINGDIAPI BOOL WINAPI PolyTextOutA(HDC hdc,CONST POLYTEXTA * ppt,int nstrings);
WINGDIAPI BOOL WINAPI PolyTextOutW(HDC hdc,CONST POLYTEXTW * ppt,int nstrings);
#ifdef UNICODE
...
WINGDIAPI BOOL WINAPI DPtoLP(HDC hdc,LPPOINT lppt,int c);
WINGDIAPI BOOL WINAPI LPtoDP(HDC hdc,LPPOINT lppt,int c);
WINGDIAPI BOOL WINAPI Polygon(HDC hdc,CONST POINT *apt,int cpt);
WINGDIAPI BOOL WINAPI Polyline(HDC hdc,CONST POINT *apt,int cpt);
WINGDIAPI BOOL WINAPI PolyBezier(HDC hdc,CONST POINT * apt,DWORD cpt);
WINGDIAPI BOOL WINAPI PolyBezierTo(HDC hdc,CONST POINT * apt,DWORD cpt);
WINGDIAPI BOOL WINAPI PolylineTo(HDC hdc,CONST POINT * apt,DWORD cpt);
...
WINGDIAPI BOOL WINAPI SetWindowExtEx(HDC hdc,int x,int y,LPSIZE lpsz);
WINGDIAPI BOOL WINAPI SetWindowOrgEx(HDC hdc,int x,int y,LPPOINT lppt);
WINGDIAPI BOOL WINAPI OffsetViewportOrgEx(HDC hdc,int x,int y,LPPOINT lppt);
WINGDIAPI BOOL WINAPI OffsetWindowOrgEx(HDC hdc,int x,int y,LPPOINT lppt);
WINGDIAPI BOOL WINAPI ScaleViewportExtEx(HDC hdc,int xn,int dx,int yn,int yd,LPSIZE lpsz);
WINGDIAPI BOOL WINAPI ScaleWindowExtEx(HDC hdc,int xn,int xd,int yn,int yd,LPSIZE lpsz);
WINGDIAPI BOOL WINAPI SetBitmapDimensionEx(HBITMAP hbm,int w,int h,LPSIZE lpsz);
WINGDIAPI BOOL WINAPI SetBrushOrgEx(HDC hdc,int x,int y,LPPOINT lppt);
...
#endif
WINGDIAPI BOOL WINAPI GetDCOrgEx(HDC hdc,LPPOINT lppt);
WINGDIAPI BOOL WINAPI FixBrushOrgEx(HDC hdc,int x,int y,LPPOINT ptl);
WINGDIAPI BOOL WINAPI UnrealizeObject(HGDIOBJ h);
...
WINGDIAPI BOOL WINAPI CheckColorsInGamut(HDC hdc,LPVOID lpRGBTriple,LPVOID dlpBuffer,DWORD nCount);
WINGDIAPI HCOLORSPACE WINAPI GetColorSpace(HDC hdc);
WINGDIAPI BOOL WINAPI GetLogColorSpaceA(HCOLORSPACE hColorSpace,LPLOGCOLORSPACEA lpBuffer,DWORD nSize);
WINGDIAPI BOOL WINAPI GetLogColorSpaceW(HCOLORSPACE hColorSpace,LPLOGCOLORSPACEW lpBuffer,DWORD nSize);
#ifdef UNICODE
...
WINGDIAPI BOOL WINAPI DeleteColorSpace(HCOLORSPACE hcs);
WINGDIAPI BOOL	 WINAPI GetICMProfileA(HDC hdc,LPDWORD pBufSize,LPSTR pszFilename);
WINGDIAPI BOOL	 WINAPI GetICMProfileW(HDC hdc,LPDWORD pBufSize,LPWSTR pszFilename);
#ifdef UNICODE
#define GetICMProfile GetICMProfileW
#else
#define GetICMProfile GetICMProfileA
#endif
WINGDIAPI BOOL WINAPI SetICMProfileA(HDC hdc,LPSTR lpFileName);
WINGDIAPI BOOL WINAPI SetICMProfileW(HDC hdc,LPWSTR lpFileName);
#ifdef UNICODE
#define SetICMProfile SetICMProfileW
#else
#define SetICMProfile SetICMProfileA
#endif
WINGDIAPI BOOL WINAPI GetDeviceGammaRamp(HDC hdc,LPVOID lpRamp);
WINGDIAPI BOOL WINAPI SetDeviceGammaRamp(HDC hdc,LPVOID lpRamp);
WINGDIAPI BOOL WINAPI ColorMatchToTarget(HDC hdc,HDC hdcTarget,DWORD action);
...
#endif
WINGDIAPI BOOL	 WINAPI UpdateICMRegKeyA(DWORD reserved,LPSTR lpszCMID,LPSTR lpszFileName,UINT command);
WINGDIAPI BOOL	 WINAPI UpdateICMRegKeyW(DWORD reserved,LPWSTR lpszCMID,LPWSTR lpszFileName,UINT command);
#ifdef UNICODE
...
#endif
#if (WINVER >=0x0500)
WINGDIAPI BOOL WINAPI ColorCorrectPalette(HDC hdc,HPALETTE hPal,DWORD deFirst,DWORD num);
#endif
#ifndef NOMETAFILE
#ifndef _MAC
...
typedef struct tagABORTPATH {
	EMR emr;
} EMRABORTPATH,*PEMRABORTPATH,EMRBEGINPATH,*PEMRBEGINPATH,EMRENDPATH,*PEMRENDPATH,EMRCLOSEFIGURE,*PEMRCLOSEFIGURE,EMRFLATTENPATH,*PEMRFLATTENPATH,EMRWIDENPATH,*PEMRWIDENPATH,EMRSETMETARGN,*PEMRSETMETARGN,
...
typedef struct tagEMRSETMITERLIMIT { EMR emr; FLOAT eMiterLimit; } EMRSETMITERLIMIT,*PEMRSETMITERLIMIT;
typedef struct tagEMRRESTOREDC { EMR emr; LONG iRelative; } EMRRESTOREDC,*PEMRRESTOREDC;
typedef struct tagEMRSETARCDIRECTION { EMR emr; DWORD iArcDirection; } EMRSETARCDIRECTION,*PEMRSETARCDIRECTION;
typedef struct tagEMRSETMAPPERFLAGS { EMR emr; DWORD dwFlags; } EMRSETMAPPERFLAGS,*PEMRSETMAPPERFLAGS;
typedef struct tagEMRSETTEXTCOLOR { EMR emr; COLORREF crColor; } EMRSETBKCOLOR,*PEMRSETBKCOLOR,EMRSETTEXTCOLOR,*PEMRSETTEXTCOLOR;
typedef struct tagEMRSELECTOBJECT { EMR emr; DWORD ihObject; } EMRSELECTOBJECT,*PEMRSELECTOBJECT,EMRDELETEOBJECT,*PEMRDELETEOBJECT;
typedef struct tagEMRSELECTPALETTE { EMR emr; DWORD ihPal; } EMRSELECTPALETTE,*PEMRSELECTPALETTE;
typedef struct tagEMRRESIZEPALETTE { EMR emr; DWORD ihPal; DWORD cEntries; } EMRRESIZEPALETTE,*PEMRRESIZEPALETTE;
typedef struct tagEMRSETPALETTEENTRIES { EMR emr; DWORD ihPal; DWORD iStart; DWORD cEntries; PALETTEENTRY aPalEntries[1]; } EMRSETPALETTEENTRIES,*PEMRSETPALETTEENTRIES;
typedef struct tagEMRSETCOLORADJUSTMENT { EMR emr; COLORADJUSTMENT ColorAdjustment; } EMRSETCOLORADJUSTMENT,*PEMRSETCOLORADJUSTMENT;
