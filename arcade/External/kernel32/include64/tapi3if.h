...
typedef 
enum ADDRESS_EVENT
	{	AE_STATE	=0,AE_CAPSCHANGE	=AE_STATE + 1,AE_RINGING	=AE_CAPSCHANGE + 1,AE_CONFIGCHANGE	=AE_RINGING + 1,AE_FORWARD	=AE_CONFIGCHANGE + 1,AE_NEWTERMINAL	=AE_FORWARD + 1,AE_REMOVETERMINAL	=AE_NEWTERMINAL + 1,AE_MSGWAITON	=AE_REMOVETERMINAL + 1,
	AE_MSGWAITOFF	=AE_MSGWAITON + 1,AE_LASTITEM	=AE_MSGWAITOFF
	} 	ADDRESS_EVENT;
typedef 
enum ADDRESS_STATE
	{	AS_INSERVICE	=0,AS_OUTOFSERVICE	=AS_INSERVICE + 1
	} 	ADDRESS_STATE;
typedef 
enum CALL_STATE
	{	CS_IDLE	=0,CS_INPROGRESS	=CS_IDLE + 1,CS_CONNECTED	=CS_INPROGRESS + 1,CS_DISCONNECTED	=CS_CONNECTED + 1,CS_OFFERING	=CS_DISCONNECTED + 1,CS_HOLD	=CS_OFFERING + 1,CS_QUEUED	=CS_HOLD + 1,CS_LASTITEM	=CS_QUEUED
	} 	CALL_STATE;
typedef 
enum CALL_STATE_EVENT_CAUSE
	{	CEC_NONE	=0,CEC_DISCONNECT_NORMAL	=CEC_NONE + 1,CEC_DISCONNECT_BUSY	=CEC_DISCONNECT_NORMAL + 1,CEC_DISCONNECT_BADADDRESS	=CEC_DISCONNECT_BUSY + 1,CEC_DISCONNECT_NOANSWER	=CEC_DISCONNECT_BADADDRESS + 1,CEC_DISCONNECT_CANCELLED	=CEC_DISCONNECT_NOANSWER + 1,
	CEC_DISCONNECT_REJECTED	=CEC_DISCONNECT_CANCELLED + 1,CEC_DISCONNECT_FAILED	=CEC_DISCONNECT_REJECTED + 1,CEC_DISCONNECT_BLOCKED	=CEC_DISCONNECT_FAILED + 1
	} 	CALL_STATE_EVENT_CAUSE;
typedef 
enum CALL_MEDIA_EVENT
	{	CME_NEW_STREAM	=0,CME_STREAM_FAIL	=CME_NEW_STREAM + 1,CME_TERMINAL_FAIL	=CME_STREAM_FAIL + 1,CME_STREAM_NOT_USED	=CME_TERMINAL_FAIL + 1,CME_STREAM_ACTIVE	=CME_STREAM_NOT_USED + 1,CME_STREAM_INACTIVE	=CME_STREAM_ACTIVE + 1,CME_LASTITEM	=CME_STREAM_INACTIVE
	} 	CALL_MEDIA_EVENT;
typedef 
enum CALL_MEDIA_EVENT_CAUSE
	{	CMC_UNKNOWN	=0,CMC_BAD_DEVICE	=CMC_UNKNOWN + 1,CMC_CONNECT_FAIL	=CMC_BAD_DEVICE + 1,CMC_LOCAL_REQUEST	=CMC_CONNECT_FAIL + 1,CMC_REMOTE_REQUEST	=CMC_LOCAL_REQUEST + 1,CMC_MEDIA_TIMEOUT	=CMC_REMOTE_REQUEST + 1,CMC_MEDIA_RECOVERED	=CMC_MEDIA_TIMEOUT + 1,
	CMC_QUALITY_OF_SERVICE	=CMC_MEDIA_RECOVERED + 1
	} 	CALL_MEDIA_EVENT_CAUSE;
typedef 
enum DISCONNECT_CODE
	{	DC_NORMAL	=0,DC_NOANSWER	=DC_NORMAL + 1,DC_REJECTED	=DC_NOANSWER + 1
	} 	DISCONNECT_CODE;
typedef 
enum TERMINAL_STATE
	{	TS_INUSE	=0,TS_NOTINUSE	=TS_INUSE + 1
	} 	TERMINAL_STATE;
typedef 
enum TERMINAL_DIRECTION
	{	TD_CAPTURE	=0,TD_RENDER	=TD_CAPTURE + 1,TD_BIDIRECTIONAL	=TD_RENDER + 1,TD_MULTITRACK_MIXED	=TD_BIDIRECTIONAL + 1,TD_NONE	=TD_MULTITRACK_MIXED + 1
	} 	TERMINAL_DIRECTION;
typedef 
enum TERMINAL_TYPE
	{	TT_STATIC	=0,TT_DYNAMIC	=TT_STATIC + 1
	} 	TERMINAL_TYPE;
typedef 
enum CALL_PRIVILEGE
	{	CP_OWNER	=0,CP_MONITOR	=CP_OWNER + 1
	} 	CALL_PRIVILEGE;
typedef 
enum TAPI_EVENT
	{	TE_TAPIOBJECT	=0x1,TE_ADDRESS	=0x2,TE_CALLNOTIFICATION	=0x4,TE_CALLSTATE	=0x8,TE_CALLMEDIA	=0x10,TE_CALLHUB	=0x20,TE_CALLINFOCHANGE	=0x40,TE_PRIVATE	=0x80,TE_REQUEST	=0x100,TE_AGENT	=0x200,TE_AGENTSESSION	=0x400,TE_QOSEVENT	=0x800,
	TE_AGENTHANDLER	=0x1000,TE_ACDGROUP	=0x2000,TE_QUEUE	=0x4000,TE_DIGITEVENT	=0x8000,TE_GENERATEEVENT	=0x10000,TE_ASRTERMINAL	=0x20000,TE_TTSTERMINAL	=0x40000,TE_FILETERMINAL	=0x80000,TE_TONETERMINAL	=0x100000,TE_PHONEEVENT	=0x200000,
	TE_TONEEVENT	=0x400000,TE_GATHERDIGITS	=0x800000,TE_ADDRESSDEVSPECIFIC	=0x1000000,TE_PHONEDEVSPECIFIC	=0x2000000
	} 	TAPI_EVENT;
typedef 
enum CALL_NOTIFICATION_EVENT
	{	CNE_OWNER	=0,CNE_MONITOR	=CNE_OWNER + 1,CNE_LASTITEM	=CNE_MONITOR
	} 	CALL_NOTIFICATION_EVENT;
typedef 
enum CALLHUB_EVENT
	{	CHE_CALLJOIN	=0,CHE_CALLLEAVE	=CHE_CALLJOIN + 1,CHE_CALLHUBNEW	=CHE_CALLLEAVE + 1,CHE_CALLHUBIDLE	=CHE_CALLHUBNEW + 1,CHE_LASTITEM	=CHE_CALLHUBIDLE
	} 	CALLHUB_EVENT;
typedef 
enum CALLHUB_STATE
	{	CHS_ACTIVE	=0,CHS_IDLE	=CHS_ACTIVE + 1
	} 	CALLHUB_STATE;
typedef 
enum TAPIOBJECT_EVENT
	{	TE_ADDRESSCREATE	=0,TE_ADDRESSREMOVE	=TE_ADDRESSCREATE + 1,TE_REINIT	=TE_ADDRESSREMOVE + 1,TE_TRANSLATECHANGE	=TE_REINIT + 1,TE_ADDRESSCLOSE	=TE_TRANSLATECHANGE + 1,TE_PHONECREATE	=TE_ADDRESSCLOSE + 1,TE_PHONEREMOVE	=TE_PHONECREATE + 1
	} 	TAPIOBJECT_EVENT;
typedef 
enum TAPI_OBJECT_TYPE
	{	TOT_NONE	=0,TOT_TAPI	=TOT_NONE + 1,TOT_ADDRESS	=TOT_TAPI + 1,TOT_TERMINAL	=TOT_ADDRESS + 1,TOT_CALL	=TOT_TERMINAL + 1,TOT_CALLHUB	=TOT_CALL + 1,TOT_PHONE	=TOT_CALLHUB + 1
	} 	TAPI_OBJECT_TYPE;
typedef 
enum QOS_SERVICE_LEVEL
	{	QSL_NEEDED	=1,QSL_IF_AVAILABLE	=2,QSL_BEST_EFFORT	=3
	} 	QOS_SERVICE_LEVEL;
typedef 
enum QOS_EVENT
	{	QE_NOQOS	=1,QE_ADMISSIONFAILURE	=2,QE_POLICYFAILURE	=3,QE_GENERICERROR	=4,QE_LASTITEM	=QE_GENERICERROR
	} 	QOS_EVENT;
typedef 
enum CALLINFOCHANGE_CAUSE
	{	CIC_OTHER	=0,CIC_DEVSPECIFIC	=CIC_OTHER + 1,CIC_BEARERMODE	=CIC_DEVSPECIFIC + 1,CIC_RATE	=CIC_BEARERMODE + 1,CIC_APPSPECIFIC	=CIC_RATE + 1,CIC_CALLID	=CIC_APPSPECIFIC + 1,CIC_RELATEDCALLID	=CIC_CALLID + 1,CIC_ORIGIN	=CIC_RELATEDCALLID + 1,
	CIC_REASON	=CIC_ORIGIN + 1,CIC_COMPLETIONID	=CIC_REASON + 1,CIC_NUMOWNERINCR	=CIC_COMPLETIONID + 1,CIC_NUMOWNERDECR	=CIC_NUMOWNERINCR + 1,CIC_NUMMONITORS	=CIC_NUMOWNERDECR + 1,CIC_TRUNK	=CIC_NUMMONITORS + 1,CIC_CALLERID	=CIC_TRUNK + 1,
	CIC_CALLEDID	=CIC_CALLERID + 1,CIC_CONNECTEDID	=CIC_CALLEDID + 1,CIC_REDIRECTIONID	=CIC_CONNECTEDID + 1,CIC_REDIRECTINGID	=CIC_REDIRECTIONID + 1,CIC_USERUSERINFO	=CIC_REDIRECTINGID + 1,CIC_HIGHLEVELCOMP	=CIC_USERUSERINFO + 1,CIC_LOWLEVELCOMP	=CIC_HIGHLEVELCOMP + 1,
	CIC_CHARGINGINFO	=CIC_LOWLEVELCOMP + 1,CIC_TREATMENT	=CIC_CHARGINGINFO + 1,CIC_CALLDATA	=CIC_TREATMENT + 1,CIC_PRIVILEGE	=CIC_CALLDATA + 1,CIC_MEDIATYPE	=CIC_PRIVILEGE + 1,CIC_LASTITEM	=CIC_MEDIATYPE
	} 	CALLINFOCHANGE_CAUSE;
typedef 
enum CALLINFO_LONG
	{	CIL_MEDIATYPESAVAILABLE	=0,CIL_BEARERMODE	=CIL_MEDIATYPESAVAILABLE + 1,CIL_CALLERIDADDRESSTYPE	=CIL_BEARERMODE + 1,CIL_CALLEDIDADDRESSTYPE	=CIL_CALLERIDADDRESSTYPE + 1,CIL_CONNECTEDIDADDRESSTYPE	=CIL_CALLEDIDADDRESSTYPE + 1,CIL_REDIRECTIONIDADDRESSTYPE	=CIL_CONNECTEDIDADDRESSTYPE + 1,
	CIL_REDIRECTINGIDADDRESSTYPE	=CIL_REDIRECTIONIDADDRESSTYPE + 1,CIL_ORIGIN	=CIL_REDIRECTINGIDADDRESSTYPE + 1,CIL_REASON	=CIL_ORIGIN + 1,CIL_APPSPECIFIC	=CIL_REASON + 1,CIL_CALLPARAMSFLAGS	=CIL_APPSPECIFIC + 1,CIL_CALLTREATMENT	=CIL_CALLPARAMSFLAGS + 1,
	CIL_MINRATE	=CIL_CALLTREATMENT + 1,CIL_MAXRATE	=CIL_MINRATE + 1,CIL_COUNTRYCODE	=CIL_MAXRATE + 1,CIL_CALLID	=CIL_COUNTRYCODE + 1,CIL_RELATEDCALLID	=CIL_CALLID + 1,CIL_COMPLETIONID	=CIL_RELATEDCALLID + 1,CIL_NUMBEROFOWNERS	=CIL_COMPLETIONID + 1,
	CIL_NUMBEROFMONITORS	=CIL_NUMBEROFOWNERS + 1,CIL_TRUNK	=CIL_NUMBEROFMONITORS + 1,CIL_RATE	=CIL_TRUNK + 1,CIL_GENERATEDIGITDURATION	=CIL_RATE + 1,CIL_MONITORDIGITMODES	=CIL_GENERATEDIGITDURATION + 1,CIL_MONITORMEDIAMODES	=CIL_MONITORDIGITMODES + 1
	} 	CALLINFO_LONG;
typedef 
enum CALLINFO_STRING
	{	CIS_CALLERIDNAME	=0,CIS_CALLERIDNUMBER	=CIS_CALLERIDNAME + 1,CIS_CALLEDIDNAME	=CIS_CALLERIDNUMBER + 1,CIS_CALLEDIDNUMBER	=CIS_CALLEDIDNAME + 1,CIS_CONNECTEDIDNAME	=CIS_CALLEDIDNUMBER + 1,CIS_CONNECTEDIDNUMBER	=CIS_CONNECTEDIDNAME + 1,
	CIS_REDIRECTIONIDNAME	=CIS_CONNECTEDIDNUMBER + 1,CIS_REDIRECTIONIDNUMBER	=CIS_REDIRECTIONIDNAME + 1,CIS_REDIRECTINGIDNAME	=CIS_REDIRECTIONIDNUMBER + 1,CIS_REDIRECTINGIDNUMBER	=CIS_REDIRECTINGIDNAME + 1,CIS_CALLEDPARTYFRIENDLYNAME	=CIS_REDIRECTINGIDNUMBER + 1,
	CIS_COMMENT	=CIS_CALLEDPARTYFRIENDLYNAME + 1,CIS_DISPLAYABLEADDRESS	=CIS_COMMENT + 1,CIS_CALLINGPARTYID	=CIS_DISPLAYABLEADDRESS + 1
	} 	CALLINFO_STRING;
typedef 
enum CALLINFO_BUFFER
	{	CIB_USERUSERINFO	=0,CIB_DEVSPECIFICBUFFER	=CIB_USERUSERINFO + 1,CIB_CALLDATABUFFER	=CIB_DEVSPECIFICBUFFER + 1,CIB_CHARGINGINFOBUFFER	=CIB_CALLDATABUFFER + 1,CIB_HIGHLEVELCOMPATIBILITYBUFFER	=CIB_CHARGINGINFOBUFFER + 1,CIB_LOWLEVELCOMPATIBILITYBUFFER	=CIB_HIGHLEVELCOMPATIBILITYBUFFER + 1
	} 	CALLINFO_BUFFER;
typedef 
enum ADDRESS_CAPABILITY
	{	AC_ADDRESSTYPES	=0,AC_BEARERMODES	=AC_ADDRESSTYPES + 1,AC_MAXACTIVECALLS	=AC_BEARERMODES + 1,AC_MAXONHOLDCALLS	=AC_MAXACTIVECALLS + 1,AC_MAXONHOLDPENDINGCALLS	=AC_MAXONHOLDCALLS + 1,AC_MAXNUMCONFERENCE	=AC_MAXONHOLDPENDINGCALLS + 1,
	AC_MAXNUMTRANSCONF	=AC_MAXNUMCONFERENCE + 1,AC_MONITORDIGITSUPPORT	=AC_MAXNUMTRANSCONF + 1,AC_GENERATEDIGITSUPPORT	=AC_MONITORDIGITSUPPORT + 1,AC_GENERATETONEMODES	=AC_GENERATEDIGITSUPPORT + 1,AC_GENERATETONEMAXNUMFREQ	=AC_GENERATETONEMODES + 1,
	AC_MONITORTONEMAXNUMFREQ	=AC_GENERATETONEMAXNUMFREQ + 1,AC_MONITORTONEMAXNUMENTRIES	=AC_MONITORTONEMAXNUMFREQ + 1,AC_DEVCAPFLAGS	=AC_MONITORTONEMAXNUMENTRIES + 1,AC_ANSWERMODES	=AC_DEVCAPFLAGS + 1,AC_LINEFEATURES	=AC_ANSWERMODES + 1,AC_SETTABLEDEVSTATUS	=AC_LINEFEATURES + 1,
	AC_PARKSUPPORT	=AC_SETTABLEDEVSTATUS + 1,AC_CALLERIDSUPPORT	=AC_PARKSUPPORT + 1,AC_CALLEDIDSUPPORT	=AC_CALLERIDSUPPORT + 1,AC_CONNECTEDIDSUPPORT	=AC_CALLEDIDSUPPORT + 1,AC_REDIRECTIONIDSUPPORT	=AC_CONNECTEDIDSUPPORT + 1,AC_REDIRECTINGIDSUPPORT	=AC_REDIRECTIONIDSUPPORT + 1,
	AC_ADDRESSCAPFLAGS	=AC_REDIRECTINGIDSUPPORT + 1,AC_CALLFEATURES1	=AC_ADDRESSCAPFLAGS + 1,AC_CALLFEATURES2	=AC_CALLFEATURES1 + 1,AC_REMOVEFROMCONFCAPS	=AC_CALLFEATURES2 + 1,AC_REMOVEFROMCONFSTATE	=AC_REMOVEFROMCONFCAPS + 1,AC_TRANSFERMODES	=AC_REMOVEFROMCONFSTATE + 1,
	AC_ADDRESSFEATURES	=AC_TRANSFERMODES + 1,AC_PREDICTIVEAUTOTRANSFERSTATES	=AC_ADDRESSFEATURES + 1,AC_MAXCALLDATASIZE	=AC_PREDICTIVEAUTOTRANSFERSTATES + 1,AC_LINEID	=AC_MAXCALLDATASIZE + 1,AC_ADDRESSID	=AC_LINEID + 1,AC_FORWARDMODES	=AC_ADDRESSID + 1,
	AC_MAXFORWARDENTRIES	=AC_FORWARDMODES + 1,AC_MAXSPECIFICENTRIES	=AC_MAXFORWARDENTRIES + 1,AC_MINFWDNUMRINGS	=AC_MAXSPECIFICENTRIES + 1,AC_MAXFWDNUMRINGS	=AC_MINFWDNUMRINGS + 1,AC_MAXCALLCOMPLETIONS	=AC_MAXFWDNUMRINGS + 1,AC_CALLCOMPLETIONCONDITIONS	=AC_MAXCALLCOMPLETIONS + 1,
	AC_CALLCOMPLETIONMODES	=AC_CALLCOMPLETIONCONDITIONS + 1,AC_PERMANENTDEVICEID	=AC_CALLCOMPLETIONMODES + 1,AC_GATHERDIGITSMINTIMEOUT	=AC_PERMANENTDEVICEID + 1,AC_GATHERDIGITSMAXTIMEOUT	=AC_GATHERDIGITSMINTIMEOUT + 1,AC_GENERATEDIGITMINDURATION	=AC_GATHERDIGITSMAXTIMEOUT + 1,
	AC_GENERATEDIGITMAXDURATION	=AC_GENERATEDIGITMINDURATION + 1,AC_GENERATEDIGITDEFAULTDURATION	=AC_GENERATEDIGITMAXDURATION + 1
	} 	ADDRESS_CAPABILITY;
typedef 
enum ADDRESS_CAPABILITY_STRING
	{	ACS_PROTOCOL	=0,ACS_ADDRESSDEVICESPECIFIC	=ACS_PROTOCOL + 1,ACS_LINEDEVICESPECIFIC	=ACS_ADDRESSDEVICESPECIFIC + 1,ACS_PROVIDERSPECIFIC	=ACS_LINEDEVICESPECIFIC + 1,ACS_SWITCHSPECIFIC	=ACS_PROVIDERSPECIFIC + 1,ACS_PERMANENTDEVICEGUID	=ACS_SWITCHSPECIFIC + 1
	} 	ADDRESS_CAPABILITY_STRING;
typedef 
enum FULLDUPLEX_SUPPORT
	{	FDS_SUPPORTED	=0,FDS_NOTSUPPORTED	=FDS_SUPPORTED + 1,FDS_UNKNOWN	=FDS_NOTSUPPORTED + 1
	} 	FULLDUPLEX_SUPPORT;
typedef 
enum FINISH_MODE
	{	FM_ASTRANSFER	=0,FM_ASCONFERENCE	=FM_ASTRANSFER + 1
	} 	FINISH_MODE;
typedef 
enum PHONE_PRIVILEGE
	{	PP_OWNER	=0,PP_MONITOR	=PP_OWNER + 1
	} 	PHONE_PRIVILEGE;
typedef 
...
enum PHONE_LAMP_MODE
	{	LM_DUMMY	=0x1,LM_OFF	=0x2,LM_STEADY	=0x4,LM_WINK	=0x8,LM_FLASH	=0x10,LM_FLUTTER	=0x20,LM_BROKENFLUTTER	=0x40,LM_UNKNOWN	=0x80
	} 	PHONE_LAMP_MODE;
typedef 
enum PHONECAPS_LONG
	{	PCL_HOOKSWITCHES	=0,PCL_HANDSETHOOKSWITCHMODES	=PCL_HOOKSWITCHES + 1,PCL_HEADSETHOOKSWITCHMODES	=PCL_HANDSETHOOKSWITCHMODES + 1,PCL_SPEAKERPHONEHOOKSWITCHMODES	=PCL_HEADSETHOOKSWITCHMODES + 1,PCL_DISPLAYNUMROWS	=PCL_SPEAKERPHONEHOOKSWITCHMODES + 1,
	PCL_DISPLAYNUMCOLUMNS	=PCL_DISPLAYNUMROWS + 1,PCL_NUMRINGMODES	=PCL_DISPLAYNUMCOLUMNS + 1,PCL_NUMBUTTONLAMPS	=PCL_NUMRINGMODES + 1,PCL_GENERICPHONE	=PCL_NUMBUTTONLAMPS + 1
	} 	PHONECAPS_LONG;
typedef 
enum PHONECAPS_STRING
	{	PCS_PHONENAME	=0,PCS_PHONEINFO	=PCS_PHONENAME + 1,PCS_PROVIDERINFO	=PCS_PHONEINFO + 1
	} 	PHONECAPS_STRING;
typedef 
...
enum PHONE_BUTTON_MODE
	{	PBM_DUMMY	=0,PBM_CALL	=PBM_DUMMY + 1,PBM_FEATURE	=PBM_CALL + 1,PBM_KEYPAD	=PBM_FEATURE + 1,PBM_LOCAL	=PBM_KEYPAD + 1,PBM_DISPLAY	=PBM_LOCAL + 1
	} 	PHONE_BUTTON_MODE;
typedef 
enum PHONE_BUTTON_FUNCTION
	{	PBF_UNKNOWN	=0,PBF_CONFERENCE	=PBF_UNKNOWN + 1,PBF_TRANSFER	=PBF_CONFERENCE + 1,PBF_DROP	=PBF_TRANSFER + 1,PBF_HOLD	=PBF_DROP + 1,PBF_RECALL	=PBF_HOLD + 1,PBF_DISCONNECT	=PBF_RECALL + 1,PBF_CONNECT	=PBF_DISCONNECT + 1,PBF_MSGWAITON	=PBF_CONNECT + 1,
	PBF_MSGWAITOFF	=PBF_MSGWAITON + 1,PBF_SELECTRING	=PBF_MSGWAITOFF + 1,PBF_ABBREVDIAL	=PBF_SELECTRING + 1,PBF_FORWARD	=PBF_ABBREVDIAL + 1,PBF_PICKUP	=PBF_FORWARD + 1,PBF_RINGAGAIN	=PBF_PICKUP + 1,PBF_PARK	=PBF_RINGAGAIN + 1,PBF_REJECT	=PBF_PARK + 1,
	PBF_REDIRECT	=PBF_REJECT + 1,PBF_MUTE	=PBF_REDIRECT + 1,PBF_VOLUMEUP	=PBF_MUTE + 1,PBF_VOLUMEDOWN	=PBF_VOLUMEUP + 1,PBF_SPEAKERON	=PBF_VOLUMEDOWN + 1,PBF_SPEAKEROFF	=PBF_SPEAKERON + 1,PBF_FLASH	=PBF_SPEAKEROFF + 1,PBF_DATAON	=PBF_FLASH + 1,
	PBF_DATAOFF	=PBF_DATAON + 1,PBF_DONOTDISTURB	=PBF_DATAOFF + 1,PBF_INTERCOM	=PBF_DONOTDISTURB + 1,PBF_BRIDGEDAPP	=PBF_INTERCOM + 1,PBF_BUSY	=PBF_BRIDGEDAPP + 1,PBF_CALLAPP	=PBF_BUSY + 1,PBF_DATETIME	=PBF_CALLAPP + 1,PBF_DIRECTORY	=PBF_DATETIME + 1,
	PBF_COVER	=PBF_DIRECTORY + 1,PBF_CALLID	=PBF_COVER + 1,PBF_LASTNUM	=PBF_CALLID + 1,PBF_NIGHTSRV	=PBF_LASTNUM + 1,PBF_SENDCALLS	=PBF_NIGHTSRV + 1,PBF_MSGINDICATOR	=PBF_SENDCALLS + 1,PBF_REPDIAL	=PBF_MSGINDICATOR + 1,PBF_SETREPDIAL	=PBF_REPDIAL + 1,
	PBF_SYSTEMSPEED	=PBF_SETREPDIAL + 1,PBF_STATIONSPEED	=PBF_SYSTEMSPEED + 1,PBF_CAMPON	=PBF_STATIONSPEED + 1,PBF_SAVEREPEAT	=PBF_CAMPON + 1,PBF_QUEUECALL	=PBF_SAVEREPEAT + 1,PBF_NONE	=PBF_QUEUECALL + 1,PBF_SEND	=PBF_NONE + 1
	} 	PHONE_BUTTON_FUNCTION;
typedef 
enum PHONE_TONE
	{	PT_KEYPADZERO	=0,PT_KEYPADONE	=PT_KEYPADZERO + 1,PT_KEYPADTWO	=PT_KEYPADONE + 1,PT_KEYPADTHREE	=PT_KEYPADTWO + 1,PT_KEYPADFOUR	=PT_KEYPADTHREE + 1,PT_KEYPADFIVE	=PT_KEYPADFOUR + 1,PT_KEYPADSIX	=PT_KEYPADFIVE + 1,PT_KEYPADSEVEN	=PT_KEYPADSIX + 1,
	PT_KEYPADEIGHT	=PT_KEYPADSEVEN + 1,PT_KEYPADNINE	=PT_KEYPADEIGHT + 1,PT_KEYPADSTAR	=PT_KEYPADNINE + 1,PT_KEYPADPOUND	=PT_KEYPADSTAR + 1,PT_KEYPADA	=PT_KEYPADPOUND + 1,PT_KEYPADB	=PT_KEYPADA + 1,PT_KEYPADC	=PT_KEYPADB + 1,PT_KEYPADD	=PT_KEYPADC + 1,
	PT_NORMALDIALTONE	=PT_KEYPADD + 1,PT_EXTERNALDIALTONE	=PT_NORMALDIALTONE + 1,PT_BUSY	=PT_EXTERNALDIALTONE + 1,PT_RINGBACK	=PT_BUSY + 1,PT_ERRORTONE	=PT_RINGBACK + 1,PT_SILENCE	=PT_ERRORTONE + 1
	} 	PHONE_TONE;
typedef 
enum PHONE_EVENT
	{	PE_DISPLAY	=0,PE_LAMPMODE	=PE_DISPLAY + 1,PE_RINGMODE	=PE_LAMPMODE + 1,PE_RINGVOLUME	=PE_RINGMODE + 1,PE_HOOKSWITCH	=PE_RINGVOLUME + 1,PE_CAPSCHANGE	=PE_HOOKSWITCH + 1,PE_BUTTON	=PE_CAPSCHANGE + 1,PE_CLOSE	=PE_BUTTON + 1,PE_NUMBERGATHERED	=PE_CLOSE + 1,
	PE_DIALING	=PE_NUMBERGATHERED + 1,PE_ANSWER	=PE_DIALING + 1,PE_DISCONNECT	=PE_ANSWER + 1,PE_LASTITEM	=PE_DISCONNECT
	} 	PHONE_EVENT;
...
EXTERN_C const IID IID_ITTAPI;
	...
	public:
		...
		virtual HRESULT STDMETHODCALLTYPE get_Addresses(VARIANT *pVariant)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateAddresses(IEnumAddress **ppEnumAddress)=0;
		virtual HRESULT STDMETHODCALLTYPE RegisterCallNotifications(ITAddress *pAddress,VARIANT_BOOL fMonitor,VARIANT_BOOL fOwner,long lMediaTypes,long lCallbackInstance,long *plRegister)=0;
		virtual HRESULT STDMETHODCALLTYPE UnregisterNotifications(long lRegister)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CallHubs(VARIANT *pVariant)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateCallHubs(IEnumCallHub **ppEnumCallHub)=0;
		virtual HRESULT STDMETHODCALLTYPE SetCallHubTracking(VARIANT pAddresses,VARIANT_BOOL bTracking)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumeratePrivateTAPIObjects(IEnumUnknown **ppEnumUnknown)=0;
		virtual HRESULT STDMETHODCALLTYPE get_PrivateTAPIObjects(VARIANT *pVariant)=0;
		virtual HRESULT STDMETHODCALLTYPE RegisterRequestRecipient(long lRegistrationInstance,long lRequestMode,VARIANT_BOOL fEnable)=0;
		virtual HRESULT STDMETHODCALLTYPE SetAssistedTelephonyPriority(BSTR pAppFilename,VARIANT_BOOL fPriority)=0;
		virtual HRESULT STDMETHODCALLTYPE SetApplicationPriority(BSTR pAppFilename,long lMediaType,VARIANT_BOOL fPriority)=0;
		virtual HRESULT STDMETHODCALLTYPE put_EventFilter(long lFilterMask)=0;
		virtual HRESULT STDMETHODCALLTYPE get_EventFilter(long *plFilterMask)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITTAPI_Initialize_Proxy(ITTAPI * This);
void __RPC_STUB ITTAPI_Initialize_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPI_Shutdown_Proxy(ITTAPI * This);
void __RPC_STUB ITTAPI_Shutdown_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPI_get_Addresses_Proxy(ITTAPI * This,VARIANT *pVariant);
void __RPC_STUB ITTAPI_get_Addresses_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPI_EnumerateAddresses_Proxy(ITTAPI * This,IEnumAddress **ppEnumAddress);
void __RPC_STUB ITTAPI_EnumerateAddresses_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPI_RegisterCallNotifications_Proxy(ITTAPI * This,ITAddress *pAddress,VARIANT_BOOL fMonitor,VARIANT_BOOL fOwner,long lMediaTypes,long lCallbackInstance,long *plRegister);
void __RPC_STUB ITTAPI_RegisterCallNotifications_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPI_UnregisterNotifications_Proxy(ITTAPI * This,long lRegister);
void __RPC_STUB ITTAPI_UnregisterNotifications_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPI_get_CallHubs_Proxy(ITTAPI * This,VARIANT *pVariant);
void __RPC_STUB ITTAPI_get_CallHubs_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPI_EnumerateCallHubs_Proxy(ITTAPI * This,IEnumCallHub **ppEnumCallHub);
void __RPC_STUB ITTAPI_EnumerateCallHubs_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPI_SetCallHubTracking_Proxy(ITTAPI * This,VARIANT pAddresses,VARIANT_BOOL bTracking);
void __RPC_STUB ITTAPI_SetCallHubTracking_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPI_EnumeratePrivateTAPIObjects_Proxy(ITTAPI * This,IEnumUnknown **ppEnumUnknown);
void __RPC_STUB ITTAPI_EnumeratePrivateTAPIObjects_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPI_get_PrivateTAPIObjects_Proxy(ITTAPI * This,VARIANT *pVariant);
void __RPC_STUB ITTAPI_get_PrivateTAPIObjects_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPI_RegisterRequestRecipient_Proxy(ITTAPI * This,long lRegistrationInstance,long lRequestMode,VARIANT_BOOL fEnable);
void __RPC_STUB ITTAPI_RegisterRequestRecipient_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPI_SetAssistedTelephonyPriority_Proxy(ITTAPI * This,BSTR pAppFilename,VARIANT_BOOL fPriority);
void __RPC_STUB ITTAPI_SetAssistedTelephonyPriority_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPI_SetApplicationPriority_Proxy(ITTAPI * This,BSTR pAppFilename,long lMediaType,VARIANT_BOOL fPriority);
void __RPC_STUB ITTAPI_SetApplicationPriority_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPI_put_EventFilter_Proxy(ITTAPI * This,long lFilterMask);
void __RPC_STUB ITTAPI_put_EventFilter_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPI_get_EventFilter_Proxy(ITTAPI * This,long *plFilterMask);
...
EXTERN_C const IID IID_ITTAPI2;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Phones(VARIANT *pPhones)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumeratePhones(IEnumPhone **ppEnumPhone)=0;
		virtual HRESULT STDMETHODCALLTYPE CreateEmptyCollectionObject(ITCollection2 **ppCollection)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITTAPI2_get_Phones_Proxy(ITTAPI2 * This,VARIANT *pPhones);
void __RPC_STUB ITTAPI2_get_Phones_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPI2_EnumeratePhones_Proxy(ITTAPI2 * This,IEnumPhone **ppEnumPhone);
void __RPC_STUB ITTAPI2_EnumeratePhones_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPI2_CreateEmptyCollectionObject_Proxy(ITTAPI2 * This,ITCollection2 **ppCollection);
...
EXTERN_C const IID IID_ITMediaSupport;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_MediaTypes(long *plMediaTypes)=0;
		virtual HRESULT STDMETHODCALLTYPE QueryMediaType(long lMediaType,VARIANT_BOOL *pfSupport)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITMediaSupport_get_MediaTypes_Proxy(ITMediaSupport * This,long *plMediaTypes);
void __RPC_STUB ITMediaSupport_get_MediaTypes_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITMediaSupport_QueryMediaType_Proxy(ITMediaSupport * This,long lMediaType,VARIANT_BOOL *pfSupport);
...
EXTERN_C const IID IID_ITPluggableTerminalClassInfo;
	...
	public:
		...
		virtual HRESULT STDMETHODCALLTYPE get_Company(BSTR *pCompany)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Version(BSTR *pVersion)=0;
		virtual HRESULT STDMETHODCALLTYPE get_TerminalClass(BSTR *pTerminalClass)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CLSID(BSTR *pCLSID)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Direction(TERMINAL_DIRECTION *pDirection)=0;
		virtual HRESULT STDMETHODCALLTYPE get_MediaTypes(long *pMediaTypes)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITPluggableTerminalClassInfo_get_Name_Proxy(ITPluggableTerminalClassInfo * This,BSTR *pName);
void __RPC_STUB ITPluggableTerminalClassInfo_get_Name_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPluggableTerminalClassInfo_get_Company_Proxy(ITPluggableTerminalClassInfo * This,BSTR *pCompany);
void __RPC_STUB ITPluggableTerminalClassInfo_get_Company_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPluggableTerminalClassInfo_get_Version_Proxy(ITPluggableTerminalClassInfo * This,BSTR *pVersion);
void __RPC_STUB ITPluggableTerminalClassInfo_get_Version_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPluggableTerminalClassInfo_get_TerminalClass_Proxy(ITPluggableTerminalClassInfo * This,BSTR *pTerminalClass);
void __RPC_STUB ITPluggableTerminalClassInfo_get_TerminalClass_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPluggableTerminalClassInfo_get_CLSID_Proxy(ITPluggableTerminalClassInfo * This,BSTR *pCLSID);
void __RPC_STUB ITPluggableTerminalClassInfo_get_CLSID_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPluggableTerminalClassInfo_get_Direction_Proxy(ITPluggableTerminalClassInfo * This,TERMINAL_DIRECTION *pDirection);
void __RPC_STUB ITPluggableTerminalClassInfo_get_Direction_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPluggableTerminalClassInfo_get_MediaTypes_Proxy(ITPluggableTerminalClassInfo * This,long *pMediaTypes);
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITPluggableTerminalSuperclassInfo_get_Name_Proxy(ITPluggableTerminalSuperclassInfo * This,BSTR *pName);
void __RPC_STUB ITPluggableTerminalSuperclassInfo_get_Name_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPluggableTerminalSuperclassInfo_get_CLSID_Proxy(ITPluggableTerminalSuperclassInfo * This,BSTR *pCLSID);
...
EXTERN_C const IID IID_ITTerminalSupport;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_StaticTerminals(VARIANT *pVariant)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateStaticTerminals(IEnumTerminal **ppTerminalEnumerator)=0;
		virtual HRESULT STDMETHODCALLTYPE get_DynamicTerminalClasses(VARIANT *pVariant)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateDynamicTerminalClasses(IEnumTerminalClass **ppTerminalClassEnumerator)=0;
		virtual HRESULT STDMETHODCALLTYPE CreateTerminal(BSTR pTerminalClass,long lMediaType,TERMINAL_DIRECTION Direction,ITTerminal **ppTerminal)=0;
		virtual HRESULT STDMETHODCALLTYPE GetDefaultStaticTerminal(long lMediaType,TERMINAL_DIRECTION Direction,ITTerminal **ppTerminal)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITTerminalSupport_get_StaticTerminals_Proxy(ITTerminalSupport * This,VARIANT *pVariant);
void __RPC_STUB ITTerminalSupport_get_StaticTerminals_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTerminalSupport_EnumerateStaticTerminals_Proxy(ITTerminalSupport * This,IEnumTerminal **ppTerminalEnumerator);
void __RPC_STUB ITTerminalSupport_EnumerateStaticTerminals_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTerminalSupport_get_DynamicTerminalClasses_Proxy(ITTerminalSupport * This,VARIANT *pVariant);
void __RPC_STUB ITTerminalSupport_get_DynamicTerminalClasses_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTerminalSupport_EnumerateDynamicTerminalClasses_Proxy(ITTerminalSupport * This,IEnumTerminalClass **ppTerminalClassEnumerator);
void __RPC_STUB ITTerminalSupport_EnumerateDynamicTerminalClasses_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTerminalSupport_CreateTerminal_Proxy(ITTerminalSupport * This,BSTR pTerminalClass,long lMediaType,TERMINAL_DIRECTION Direction,ITTerminal **ppTerminal);
void __RPC_STUB ITTerminalSupport_CreateTerminal_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTerminalSupport_GetDefaultStaticTerminal_Proxy(ITTerminalSupport * This,long lMediaType,TERMINAL_DIRECTION Direction,ITTerminal **ppTerminal);
...
EXTERN_C const IID IID_ITTerminalSupport2;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_PluggableSuperclasses(VARIANT *pVariant)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumeratePluggableSuperclasses(IEnumPluggableSuperclassInfo **ppSuperclassEnumerator)=0;
		virtual HRESULT STDMETHODCALLTYPE get_PluggableTerminalClasses(BSTR bstrTerminalSuperclass,long lMediaType,VARIANT *pVariant)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumeratePluggableTerminalClasses(CLSID iidTerminalSuperclass,long lMediaType,IEnumPluggableTerminalClassInfo **ppClassEnumerator)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITTerminalSupport2_get_PluggableSuperclasses_Proxy(ITTerminalSupport2 * This,VARIANT *pVariant);
void __RPC_STUB ITTerminalSupport2_get_PluggableSuperclasses_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTerminalSupport2_EnumeratePluggableSuperclasses_Proxy(ITTerminalSupport2 * This,IEnumPluggableSuperclassInfo **ppSuperclassEnumerator);
void __RPC_STUB ITTerminalSupport2_EnumeratePluggableSuperclasses_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTerminalSupport2_get_PluggableTerminalClasses_Proxy(ITTerminalSupport2 * This,BSTR bstrTerminalSuperclass,long lMediaType,VARIANT *pVariant);
void __RPC_STUB ITTerminalSupport2_get_PluggableTerminalClasses_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTerminalSupport2_EnumeratePluggableTerminalClasses_Proxy(ITTerminalSupport2 * This,CLSID iidTerminalSuperclass,long lMediaType,IEnumPluggableTerminalClassInfo **ppClassEnumerator);
...
EXTERN_C const IID IID_ITAddress;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_State(ADDRESS_STATE *pAddressState)=0;
		virtual HRESULT STDMETHODCALLTYPE get_AddressName(BSTR *ppName)=0;
		virtual HRESULT STDMETHODCALLTYPE get_ServiceProviderName(BSTR *ppName)=0;
		virtual HRESULT STDMETHODCALLTYPE get_TAPIObject(ITTAPI **ppTapiObject)=0;
		virtual HRESULT STDMETHODCALLTYPE CreateCall(BSTR pDestAddress,long lAddressType,long lMediaTypes,ITBasicCallControl **ppCall)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Calls(VARIANT *pVariant)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateCalls(IEnumCall **ppCallEnum)=0;
		virtual HRESULT STDMETHODCALLTYPE get_DialableAddress(BSTR *pDialableAddress)=0;
		virtual HRESULT STDMETHODCALLTYPE CreateForwardInfoObject(ITForwardInformation **ppForwardInfo)=0;
		virtual HRESULT STDMETHODCALLTYPE Forward(ITForwardInformation *pForwardInfo,ITBasicCallControl *pCall)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CurrentForwardInfo(ITForwardInformation **ppForwardInfo)=0;
		virtual HRESULT STDMETHODCALLTYPE put_MessageWaiting(VARIANT_BOOL fMessageWaiting)=0;
		virtual HRESULT STDMETHODCALLTYPE get_MessageWaiting(VARIANT_BOOL *pfMessageWaiting)=0;
		virtual HRESULT STDMETHODCALLTYPE put_DoNotDisturb(VARIANT_BOOL fDoNotDisturb)=0;
		virtual HRESULT STDMETHODCALLTYPE get_DoNotDisturb(VARIANT_BOOL *pfDoNotDisturb)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITAddress_get_State_Proxy(ITAddress * This,ADDRESS_STATE *pAddressState);
void __RPC_STUB ITAddress_get_State_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress_get_AddressName_Proxy(ITAddress * This,BSTR *ppName);
void __RPC_STUB ITAddress_get_AddressName_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress_get_ServiceProviderName_Proxy(ITAddress * This,BSTR *ppName);
void __RPC_STUB ITAddress_get_ServiceProviderName_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress_get_TAPIObject_Proxy(ITAddress * This,ITTAPI **ppTapiObject);
void __RPC_STUB ITAddress_get_TAPIObject_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress_CreateCall_Proxy(ITAddress * This,BSTR pDestAddress,long lAddressType,long lMediaTypes,ITBasicCallControl **ppCall);
void __RPC_STUB ITAddress_CreateCall_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress_get_Calls_Proxy(ITAddress * This,VARIANT *pVariant);
void __RPC_STUB ITAddress_get_Calls_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress_EnumerateCalls_Proxy(ITAddress * This,IEnumCall **ppCallEnum);
void __RPC_STUB ITAddress_EnumerateCalls_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress_get_DialableAddress_Proxy(ITAddress * This,BSTR *pDialableAddress);
void __RPC_STUB ITAddress_get_DialableAddress_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress_CreateForwardInfoObject_Proxy(ITAddress * This,ITForwardInformation **ppForwardInfo);
void __RPC_STUB ITAddress_CreateForwardInfoObject_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress_Forward_Proxy(ITAddress * This,ITForwardInformation *pForwardInfo,ITBasicCallControl *pCall);
void __RPC_STUB ITAddress_Forward_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress_get_CurrentForwardInfo_Proxy(ITAddress * This,ITForwardInformation **ppForwardInfo);
void __RPC_STUB ITAddress_get_CurrentForwardInfo_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress_put_MessageWaiting_Proxy(ITAddress * This,VARIANT_BOOL fMessageWaiting);
void __RPC_STUB ITAddress_put_MessageWaiting_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress_get_MessageWaiting_Proxy(ITAddress * This,VARIANT_BOOL *pfMessageWaiting);
void __RPC_STUB ITAddress_get_MessageWaiting_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress_put_DoNotDisturb_Proxy(ITAddress * This,VARIANT_BOOL fDoNotDisturb);
void __RPC_STUB ITAddress_put_DoNotDisturb_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress_get_DoNotDisturb_Proxy(ITAddress * This,VARIANT_BOOL *pfDoNotDisturb);
...
EXTERN_C const IID IID_ITAddress2;
	...
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Phones(VARIANT *pPhones)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumeratePhones(IEnumPhone **ppEnumPhone)=0;
		virtual HRESULT STDMETHODCALLTYPE GetPhoneFromTerminal(ITTerminal *pTerminal,ITPhone **ppPhone)=0;
		virtual HRESULT STDMETHODCALLTYPE get_PreferredPhones(VARIANT *pPhones)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumeratePreferredPhones(IEnumPhone **ppEnumPhone)=0;
		virtual HRESULT STDMETHODCALLTYPE get_EventFilter(TAPI_EVENT TapiEvent,long lSubEvent,VARIANT_BOOL *pEnable)=0;
		virtual HRESULT STDMETHODCALLTYPE put_EventFilter(TAPI_EVENT TapiEvent,long lSubEvent,VARIANT_BOOL bEnable)=0;
		virtual HRESULT STDMETHODCALLTYPE DeviceSpecific(ITCallInfo *pCall,BYTE *pParams,DWORD dwSize)=0;
		virtual HRESULT STDMETHODCALLTYPE DeviceSpecificVariant(ITCallInfo *pCall,VARIANT varDevSpecificByteArray)=0;
		virtual HRESULT STDMETHODCALLTYPE NegotiateExtVersion(long lLowVersion,long lHighVersion,long *plExtVersion)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITAddress2_get_Phones_Proxy(ITAddress2 * This,VARIANT *pPhones);
void __RPC_STUB ITAddress2_get_Phones_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress2_EnumeratePhones_Proxy(ITAddress2 * This,IEnumPhone **ppEnumPhone);
void __RPC_STUB ITAddress2_EnumeratePhones_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress2_GetPhoneFromTerminal_Proxy(ITAddress2 * This,ITTerminal *pTerminal,ITPhone **ppPhone);
void __RPC_STUB ITAddress2_GetPhoneFromTerminal_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress2_get_PreferredPhones_Proxy(ITAddress2 * This,VARIANT *pPhones);
void __RPC_STUB ITAddress2_get_PreferredPhones_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress2_EnumeratePreferredPhones_Proxy(ITAddress2 * This,IEnumPhone **ppEnumPhone);
void __RPC_STUB ITAddress2_EnumeratePreferredPhones_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress2_get_EventFilter_Proxy(ITAddress2 * This,TAPI_EVENT TapiEvent,long lSubEvent,VARIANT_BOOL *pEnable);
void __RPC_STUB ITAddress2_get_EventFilter_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress2_put_EventFilter_Proxy(ITAddress2 * This,TAPI_EVENT TapiEvent,long lSubEvent,VARIANT_BOOL bEnable);
void __RPC_STUB ITAddress2_put_EventFilter_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress2_DeviceSpecific_Proxy(ITAddress2 * This,ITCallInfo *pCall,BYTE *pParams,DWORD dwSize);
void __RPC_STUB ITAddress2_DeviceSpecific_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress2_DeviceSpecificVariant_Proxy(ITAddress2 * This,ITCallInfo *pCall,VARIANT varDevSpecificByteArray);
void __RPC_STUB ITAddress2_DeviceSpecificVariant_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddress2_NegotiateExtVersion_Proxy(ITAddress2 * This,long lLowVersion,long lHighVersion,long *plExtVersion);
...
EXTERN_C const IID IID_ITAddressCapabilities;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_AddressCapability(ADDRESS_CAPABILITY AddressCap,long *plCapability)=0;
		virtual HRESULT STDMETHODCALLTYPE get_AddressCapabilityString(ADDRESS_CAPABILITY_STRING AddressCapString,BSTR *ppCapabilityString)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CallTreatments(VARIANT *pVariant)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateCallTreatments(IEnumBstr **ppEnumCallTreatment)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CompletionMessages(VARIANT *pVariant)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateCompletionMessages(IEnumBstr **ppEnumCompletionMessage)=0;
		virtual HRESULT STDMETHODCALLTYPE get_DeviceClasses(VARIANT *pVariant)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateDeviceClasses(IEnumBstr **ppEnumDeviceClass)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITAddressCapabilities_get_AddressCapability_Proxy(ITAddressCapabilities * This,ADDRESS_CAPABILITY AddressCap,long *plCapability);
void __RPC_STUB ITAddressCapabilities_get_AddressCapability_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressCapabilities_get_AddressCapabilityString_Proxy(ITAddressCapabilities * This,ADDRESS_CAPABILITY_STRING AddressCapString,BSTR *ppCapabilityString);
void __RPC_STUB ITAddressCapabilities_get_AddressCapabilityString_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressCapabilities_get_CallTreatments_Proxy(ITAddressCapabilities * This,VARIANT *pVariant);
void __RPC_STUB ITAddressCapabilities_get_CallTreatments_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressCapabilities_EnumerateCallTreatments_Proxy(ITAddressCapabilities * This,IEnumBstr **ppEnumCallTreatment);
void __RPC_STUB ITAddressCapabilities_EnumerateCallTreatments_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressCapabilities_get_CompletionMessages_Proxy(ITAddressCapabilities * This,VARIANT *pVariant);
void __RPC_STUB ITAddressCapabilities_get_CompletionMessages_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressCapabilities_EnumerateCompletionMessages_Proxy(ITAddressCapabilities * This,IEnumBstr **ppEnumCompletionMessage);
void __RPC_STUB ITAddressCapabilities_EnumerateCompletionMessages_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressCapabilities_get_DeviceClasses_Proxy(ITAddressCapabilities * This,VARIANT *pVariant);
void __RPC_STUB ITAddressCapabilities_get_DeviceClasses_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressCapabilities_EnumerateDeviceClasses_Proxy(ITAddressCapabilities * This,IEnumBstr **ppEnumDeviceClass);
...
EXTERN_C const IID IID_ITPhone;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE Open(PHONE_PRIVILEGE Privilege)=0;
		virtual HRESULT STDMETHODCALLTYPE Close(void)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Addresses(VARIANT *pAddresses)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateAddresses(IEnumAddress **ppEnumAddress)=0;
		virtual HRESULT STDMETHODCALLTYPE get_PhoneCapsLong(PHONECAPS_LONG pclCap,long *plCapability)=0;
		virtual HRESULT STDMETHODCALLTYPE get_PhoneCapsString(PHONECAPS_STRING pcsCap,BSTR *ppCapability)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Terminals(ITAddress *pAddress,VARIANT *pTerminals)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateTerminals(ITAddress *pAddress,IEnumTerminal **ppEnumTerminal)=0;
		virtual HRESULT STDMETHODCALLTYPE get_ButtonMode(long lButtonID,PHONE_BUTTON_MODE *pButtonMode)=0;
		virtual HRESULT STDMETHODCALLTYPE put_ButtonMode(long lButtonID,PHONE_BUTTON_MODE ButtonMode)=0;
		virtual HRESULT STDMETHODCALLTYPE get_ButtonFunction(long lButtonID,PHONE_BUTTON_FUNCTION *pButtonFunction)=0;
		virtual HRESULT STDMETHODCALLTYPE put_ButtonFunction(long lButtonID,PHONE_BUTTON_FUNCTION ButtonFunction)=0;
		virtual HRESULT STDMETHODCALLTYPE get_ButtonText(long lButtonID,BSTR *ppButtonText)=0;
		virtual HRESULT STDMETHODCALLTYPE put_ButtonText(long lButtonID,BSTR bstrButtonText)=0;
		virtual HRESULT STDMETHODCALLTYPE get_ButtonState(long lButtonID,PHONE_BUTTON_STATE *pButtonState)=0;
		virtual HRESULT STDMETHODCALLTYPE get_HookSwitchState(PHONE_HOOK_SWITCH_DEVICE HookSwitchDevice,PHONE_HOOK_SWITCH_STATE *pHookSwitchState)=0;
		virtual HRESULT STDMETHODCALLTYPE put_HookSwitchState(PHONE_HOOK_SWITCH_DEVICE HookSwitchDevice,PHONE_HOOK_SWITCH_STATE HookSwitchState)=0;
		virtual HRESULT STDMETHODCALLTYPE put_RingMode(long lRingMode)=0;
		virtual HRESULT STDMETHODCALLTYPE get_RingMode(long *plRingMode)=0;
		virtual HRESULT STDMETHODCALLTYPE put_RingVolume(long lRingVolume)=0;
		virtual HRESULT STDMETHODCALLTYPE get_RingVolume(long *plRingVolume)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Privilege(PHONE_PRIVILEGE *pPrivilege)=0;
		virtual HRESULT STDMETHODCALLTYPE GetPhoneCapsBuffer(PHONECAPS_BUFFER pcbCaps,DWORD *pdwSize,BYTE **ppPhoneCapsBuffer)=0;
		virtual HRESULT STDMETHODCALLTYPE get_PhoneCapsBuffer(PHONECAPS_BUFFER pcbCaps,VARIANT *pVarBuffer)=0;
		virtual HRESULT STDMETHODCALLTYPE get_LampMode(long lLampID,PHONE_LAMP_MODE *pLampMode)=0;
		virtual HRESULT STDMETHODCALLTYPE put_LampMode(long lLampID,PHONE_LAMP_MODE LampMode)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Display(BSTR *pbstrDisplay)=0;
		virtual HRESULT STDMETHODCALLTYPE SetDisplay(long lRow,long lColumn,BSTR bstrDisplay)=0;
		virtual HRESULT STDMETHODCALLTYPE get_PreferredAddresses(VARIANT *pAddresses)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumeratePreferredAddresses(IEnumAddress **ppEnumAddress)=0;
		virtual HRESULT STDMETHODCALLTYPE DeviceSpecific(BYTE *pParams,DWORD dwSize)=0;
		virtual HRESULT STDMETHODCALLTYPE DeviceSpecificVariant(VARIANT varDevSpecificByteArray)=0;
		virtual HRESULT STDMETHODCALLTYPE NegotiateExtVersion(long lLowVersion,long lHighVersion,long *plExtVersion)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITPhone_Open_Proxy(ITPhone * This,PHONE_PRIVILEGE Privilege);
void __RPC_STUB ITPhone_Open_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_Close_Proxy(ITPhone * This);
void __RPC_STUB ITPhone_Close_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_get_Addresses_Proxy(ITPhone * This,VARIANT *pAddresses);
void __RPC_STUB ITPhone_get_Addresses_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_EnumerateAddresses_Proxy(ITPhone * This,IEnumAddress **ppEnumAddress);
void __RPC_STUB ITPhone_EnumerateAddresses_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_get_PhoneCapsLong_Proxy(ITPhone * This,PHONECAPS_LONG pclCap,long *plCapability);
void __RPC_STUB ITPhone_get_PhoneCapsLong_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_get_PhoneCapsString_Proxy(ITPhone * This,PHONECAPS_STRING pcsCap,BSTR *ppCapability);
void __RPC_STUB ITPhone_get_PhoneCapsString_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_get_Terminals_Proxy(ITPhone * This,ITAddress *pAddress,VARIANT *pTerminals);
void __RPC_STUB ITPhone_get_Terminals_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_EnumerateTerminals_Proxy(ITPhone * This,ITAddress *pAddress,IEnumTerminal **ppEnumTerminal);
void __RPC_STUB ITPhone_EnumerateTerminals_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_get_ButtonMode_Proxy(ITPhone * This,long lButtonID,PHONE_BUTTON_MODE *pButtonMode);
void __RPC_STUB ITPhone_get_ButtonMode_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_put_ButtonMode_Proxy(ITPhone * This,long lButtonID,PHONE_BUTTON_MODE ButtonMode);
void __RPC_STUB ITPhone_put_ButtonMode_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_get_ButtonFunction_Proxy(ITPhone * This,long lButtonID,PHONE_BUTTON_FUNCTION *pButtonFunction);
void __RPC_STUB ITPhone_get_ButtonFunction_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_put_ButtonFunction_Proxy(ITPhone * This,long lButtonID,PHONE_BUTTON_FUNCTION ButtonFunction);
void __RPC_STUB ITPhone_put_ButtonFunction_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_get_ButtonText_Proxy(ITPhone * This,long lButtonID,BSTR *ppButtonText);
void __RPC_STUB ITPhone_get_ButtonText_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_put_ButtonText_Proxy(ITPhone * This,long lButtonID,BSTR bstrButtonText);
void __RPC_STUB ITPhone_put_ButtonText_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_get_ButtonState_Proxy(ITPhone * This,long lButtonID,PHONE_BUTTON_STATE *pButtonState);
void __RPC_STUB ITPhone_get_ButtonState_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_get_HookSwitchState_Proxy(ITPhone * This,PHONE_HOOK_SWITCH_DEVICE HookSwitchDevice,PHONE_HOOK_SWITCH_STATE *pHookSwitchState);
void __RPC_STUB ITPhone_get_HookSwitchState_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_put_HookSwitchState_Proxy(ITPhone * This,PHONE_HOOK_SWITCH_DEVICE HookSwitchDevice,PHONE_HOOK_SWITCH_STATE HookSwitchState);
void __RPC_STUB ITPhone_put_HookSwitchState_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_put_RingMode_Proxy(ITPhone * This,long lRingMode);
void __RPC_STUB ITPhone_put_RingMode_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_get_RingMode_Proxy(ITPhone * This,long *plRingMode);
void __RPC_STUB ITPhone_get_RingMode_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_put_RingVolume_Proxy(ITPhone * This,long lRingVolume);
void __RPC_STUB ITPhone_put_RingVolume_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_get_RingVolume_Proxy(ITPhone * This,long *plRingVolume);
void __RPC_STUB ITPhone_get_RingVolume_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_get_Privilege_Proxy(ITPhone * This,PHONE_PRIVILEGE *pPrivilege);
void __RPC_STUB ITPhone_get_Privilege_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_GetPhoneCapsBuffer_Proxy(ITPhone * This,PHONECAPS_BUFFER pcbCaps,DWORD *pdwSize,BYTE **ppPhoneCapsBuffer);
void __RPC_STUB ITPhone_GetPhoneCapsBuffer_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_get_PhoneCapsBuffer_Proxy(ITPhone * This,PHONECAPS_BUFFER pcbCaps,VARIANT *pVarBuffer);
void __RPC_STUB ITPhone_get_PhoneCapsBuffer_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_get_LampMode_Proxy(ITPhone * This,long lLampID,PHONE_LAMP_MODE *pLampMode);
void __RPC_STUB ITPhone_get_LampMode_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_put_LampMode_Proxy(ITPhone * This,long lLampID,PHONE_LAMP_MODE LampMode);
void __RPC_STUB ITPhone_put_LampMode_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_get_Display_Proxy(ITPhone * This,BSTR *pbstrDisplay);
void __RPC_STUB ITPhone_get_Display_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_SetDisplay_Proxy(ITPhone * This,long lRow,long lColumn,BSTR bstrDisplay);
void __RPC_STUB ITPhone_SetDisplay_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_get_PreferredAddresses_Proxy(ITPhone * This,VARIANT *pAddresses);
void __RPC_STUB ITPhone_get_PreferredAddresses_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_EnumeratePreferredAddresses_Proxy(ITPhone * This,IEnumAddress **ppEnumAddress);
void __RPC_STUB ITPhone_EnumeratePreferredAddresses_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_DeviceSpecific_Proxy(ITPhone * This,BYTE *pParams,DWORD dwSize);
void __RPC_STUB ITPhone_DeviceSpecific_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_DeviceSpecificVariant_Proxy(ITPhone * This,VARIANT varDevSpecificByteArray);
void __RPC_STUB ITPhone_DeviceSpecificVariant_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhone_NegotiateExtVersion_Proxy(ITPhone * This,long lLowVersion,long lHighVersion,long *plExtVersion);
...
EXTERN_C const IID IID_ITAutomatedPhoneControl;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE StartTone(PHONE_TONE Tone,long lDuration)=0;
		virtual HRESULT STDMETHODCALLTYPE StopTone(void)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Tone(PHONE_TONE *pTone)=0;
		virtual HRESULT STDMETHODCALLTYPE StartRinger(long lRingMode,long lDuration)=0;
		virtual HRESULT STDMETHODCALLTYPE StopRinger(void)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Ringer(VARIANT_BOOL *pfRinging)=0;
		virtual HRESULT STDMETHODCALLTYPE put_PhoneHandlingEnabled(VARIANT_BOOL fEnabled)=0;
		virtual HRESULT STDMETHODCALLTYPE get_PhoneHandlingEnabled(VARIANT_BOOL *pfEnabled)=0;
		virtual HRESULT STDMETHODCALLTYPE put_AutoEndOfNumberTimeout(long lTimeout)=0;
		virtual HRESULT STDMETHODCALLTYPE get_AutoEndOfNumberTimeout(long *plTimeout)=0;
		virtual HRESULT STDMETHODCALLTYPE put_AutoDialtone(VARIANT_BOOL fEnabled)=0;
		virtual HRESULT STDMETHODCALLTYPE get_AutoDialtone(VARIANT_BOOL *pfEnabled)=0;
		virtual HRESULT STDMETHODCALLTYPE put_AutoStopTonesOnOnHook(VARIANT_BOOL fEnabled)=0;
		virtual HRESULT STDMETHODCALLTYPE get_AutoStopTonesOnOnHook(VARIANT_BOOL *pfEnabled)=0;
		virtual HRESULT STDMETHODCALLTYPE put_AutoStopRingOnOffHook(VARIANT_BOOL fEnabled)=0;
		virtual HRESULT STDMETHODCALLTYPE get_AutoStopRingOnOffHook(VARIANT_BOOL *pfEnabled)=0;
		virtual HRESULT STDMETHODCALLTYPE put_AutoKeypadTones(VARIANT_BOOL fEnabled)=0;
		virtual HRESULT STDMETHODCALLTYPE get_AutoKeypadTones(VARIANT_BOOL *pfEnabled)=0;
		virtual HRESULT STDMETHODCALLTYPE put_AutoKeypadTonesMinimumDuration(long lDuration)=0;
		virtual HRESULT STDMETHODCALLTYPE get_AutoKeypadTonesMinimumDuration(long *plDuration)=0;
		virtual HRESULT STDMETHODCALLTYPE put_AutoVolumeControl(VARIANT_BOOL fEnabled)=0;
		virtual HRESULT STDMETHODCALLTYPE get_AutoVolumeControl(VARIANT_BOOL *fEnabled)=0;
		virtual HRESULT STDMETHODCALLTYPE put_AutoVolumeControlStep(long lStepSize)=0;
		virtual HRESULT STDMETHODCALLTYPE get_AutoVolumeControlStep(long *plStepSize)=0;
		virtual HRESULT STDMETHODCALLTYPE put_AutoVolumeControlRepeatDelay(long lDelay)=0;
		virtual HRESULT STDMETHODCALLTYPE get_AutoVolumeControlRepeatDelay(long *plDelay)=0;
		virtual HRESULT STDMETHODCALLTYPE put_AutoVolumeControlRepeatPeriod(long lPeriod)=0;
		virtual HRESULT STDMETHODCALLTYPE get_AutoVolumeControlRepeatPeriod(long *plPeriod)=0;
		virtual HRESULT STDMETHODCALLTYPE SelectCall(ITCallInfo *pCall,VARIANT_BOOL fSelectDefaultTerminals)=0;
		virtual HRESULT STDMETHODCALLTYPE UnselectCall(ITCallInfo *pCall)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateSelectedCalls(IEnumCall **ppCallEnum)=0;
		virtual HRESULT STDMETHODCALLTYPE get_SelectedCalls(VARIANT *pVariant)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_StartTone_Proxy(ITAutomatedPhoneControl * This,PHONE_TONE Tone,long lDuration);
void __RPC_STUB ITAutomatedPhoneControl_StartTone_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_StopTone_Proxy(ITAutomatedPhoneControl * This);
void __RPC_STUB ITAutomatedPhoneControl_StopTone_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_get_Tone_Proxy(ITAutomatedPhoneControl * This,PHONE_TONE *pTone);
void __RPC_STUB ITAutomatedPhoneControl_get_Tone_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_StartRinger_Proxy(ITAutomatedPhoneControl * This,long lRingMode,long lDuration);
void __RPC_STUB ITAutomatedPhoneControl_StartRinger_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_StopRinger_Proxy(ITAutomatedPhoneControl * This);
void __RPC_STUB ITAutomatedPhoneControl_StopRinger_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_get_Ringer_Proxy(ITAutomatedPhoneControl * This,VARIANT_BOOL *pfRinging);
void __RPC_STUB ITAutomatedPhoneControl_get_Ringer_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_put_PhoneHandlingEnabled_Proxy(ITAutomatedPhoneControl * This,VARIANT_BOOL fEnabled);
void __RPC_STUB ITAutomatedPhoneControl_put_PhoneHandlingEnabled_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_get_PhoneHandlingEnabled_Proxy(ITAutomatedPhoneControl * This,VARIANT_BOOL *pfEnabled);
void __RPC_STUB ITAutomatedPhoneControl_get_PhoneHandlingEnabled_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_put_AutoEndOfNumberTimeout_Proxy(ITAutomatedPhoneControl * This,long lTimeout);
void __RPC_STUB ITAutomatedPhoneControl_put_AutoEndOfNumberTimeout_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_get_AutoEndOfNumberTimeout_Proxy(ITAutomatedPhoneControl * This,long *plTimeout);
void __RPC_STUB ITAutomatedPhoneControl_get_AutoEndOfNumberTimeout_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_put_AutoDialtone_Proxy(ITAutomatedPhoneControl * This,VARIANT_BOOL fEnabled);
void __RPC_STUB ITAutomatedPhoneControl_put_AutoDialtone_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_get_AutoDialtone_Proxy(ITAutomatedPhoneControl * This,VARIANT_BOOL *pfEnabled);
void __RPC_STUB ITAutomatedPhoneControl_get_AutoDialtone_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_put_AutoStopTonesOnOnHook_Proxy(ITAutomatedPhoneControl * This,VARIANT_BOOL fEnabled);
void __RPC_STUB ITAutomatedPhoneControl_put_AutoStopTonesOnOnHook_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_get_AutoStopTonesOnOnHook_Proxy(ITAutomatedPhoneControl * This,VARIANT_BOOL *pfEnabled);
void __RPC_STUB ITAutomatedPhoneControl_get_AutoStopTonesOnOnHook_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_put_AutoStopRingOnOffHook_Proxy(ITAutomatedPhoneControl * This,VARIANT_BOOL fEnabled);
void __RPC_STUB ITAutomatedPhoneControl_put_AutoStopRingOnOffHook_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_get_AutoStopRingOnOffHook_Proxy(ITAutomatedPhoneControl * This,VARIANT_BOOL *pfEnabled);
void __RPC_STUB ITAutomatedPhoneControl_get_AutoStopRingOnOffHook_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_put_AutoKeypadTones_Proxy(ITAutomatedPhoneControl * This,VARIANT_BOOL fEnabled);
void __RPC_STUB ITAutomatedPhoneControl_put_AutoKeypadTones_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_get_AutoKeypadTones_Proxy(ITAutomatedPhoneControl * This,VARIANT_BOOL *pfEnabled);
void __RPC_STUB ITAutomatedPhoneControl_get_AutoKeypadTones_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_put_AutoKeypadTonesMinimumDuration_Proxy(ITAutomatedPhoneControl * This,long lDuration);
void __RPC_STUB ITAutomatedPhoneControl_put_AutoKeypadTonesMinimumDuration_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_get_AutoKeypadTonesMinimumDuration_Proxy(ITAutomatedPhoneControl * This,long *plDuration);
void __RPC_STUB ITAutomatedPhoneControl_get_AutoKeypadTonesMinimumDuration_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_put_AutoVolumeControl_Proxy(ITAutomatedPhoneControl * This,VARIANT_BOOL fEnabled);
void __RPC_STUB ITAutomatedPhoneControl_put_AutoVolumeControl_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_get_AutoVolumeControl_Proxy(ITAutomatedPhoneControl * This,VARIANT_BOOL *fEnabled);
void __RPC_STUB ITAutomatedPhoneControl_get_AutoVolumeControl_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_put_AutoVolumeControlStep_Proxy(ITAutomatedPhoneControl * This,long lStepSize);
void __RPC_STUB ITAutomatedPhoneControl_put_AutoVolumeControlStep_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_get_AutoVolumeControlStep_Proxy(ITAutomatedPhoneControl * This,long *plStepSize);
void __RPC_STUB ITAutomatedPhoneControl_get_AutoVolumeControlStep_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_put_AutoVolumeControlRepeatDelay_Proxy(ITAutomatedPhoneControl * This,long lDelay);
void __RPC_STUB ITAutomatedPhoneControl_put_AutoVolumeControlRepeatDelay_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_get_AutoVolumeControlRepeatDelay_Proxy(ITAutomatedPhoneControl * This,long *plDelay);
void __RPC_STUB ITAutomatedPhoneControl_get_AutoVolumeControlRepeatDelay_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_put_AutoVolumeControlRepeatPeriod_Proxy(ITAutomatedPhoneControl * This,long lPeriod);
void __RPC_STUB ITAutomatedPhoneControl_put_AutoVolumeControlRepeatPeriod_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_get_AutoVolumeControlRepeatPeriod_Proxy(ITAutomatedPhoneControl * This,long *plPeriod);
void __RPC_STUB ITAutomatedPhoneControl_get_AutoVolumeControlRepeatPeriod_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_SelectCall_Proxy(ITAutomatedPhoneControl * This,ITCallInfo *pCall,VARIANT_BOOL fSelectDefaultTerminals);
void __RPC_STUB ITAutomatedPhoneControl_SelectCall_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_UnselectCall_Proxy(ITAutomatedPhoneControl * This,ITCallInfo *pCall);
void __RPC_STUB ITAutomatedPhoneControl_UnselectCall_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_EnumerateSelectedCalls_Proxy(ITAutomatedPhoneControl * This,IEnumCall **ppCallEnum);
void __RPC_STUB ITAutomatedPhoneControl_EnumerateSelectedCalls_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAutomatedPhoneControl_get_SelectedCalls_Proxy(ITAutomatedPhoneControl * This,VARIANT *pVariant);
...
EXTERN_C const IID IID_ITBasicCallControl;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE Connect(VARIANT_BOOL fSync)=0;
		virtual HRESULT STDMETHODCALLTYPE Answer(void)=0;
		virtual HRESULT STDMETHODCALLTYPE Disconnect(DISCONNECT_CODE code)=0;
		virtual HRESULT STDMETHODCALLTYPE Hold(VARIANT_BOOL fHold)=0;
		virtual HRESULT STDMETHODCALLTYPE HandoffDirect(BSTR pApplicationName)=0;
		virtual HRESULT STDMETHODCALLTYPE HandoffIndirect(long lMediaType)=0;
		virtual HRESULT STDMETHODCALLTYPE Conference(ITBasicCallControl *pCall,VARIANT_BOOL fSync)=0;
		virtual HRESULT STDMETHODCALLTYPE Transfer(ITBasicCallControl *pCall,VARIANT_BOOL fSync)=0;
		virtual HRESULT STDMETHODCALLTYPE BlindTransfer(BSTR pDestAddress)=0;
		virtual HRESULT STDMETHODCALLTYPE SwapHold(ITBasicCallControl *pCall)=0;
		virtual HRESULT STDMETHODCALLTYPE ParkDirect(BSTR pParkAddress)=0;
		virtual HRESULT STDMETHODCALLTYPE ParkIndirect(BSTR *ppNonDirAddress)=0;
		virtual HRESULT STDMETHODCALLTYPE Unpark(void)=0;
		virtual HRESULT STDMETHODCALLTYPE SetQOS(long lMediaType,QOS_SERVICE_LEVEL ServiceLevel)=0;
		virtual HRESULT STDMETHODCALLTYPE Pickup(BSTR pGroupID)=0;
		virtual HRESULT STDMETHODCALLTYPE Dial(BSTR pDestAddress)=0;
		virtual HRESULT STDMETHODCALLTYPE Finish(FINISH_MODE finishMode)=0;
		virtual HRESULT STDMETHODCALLTYPE RemoveFromConference(void)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_Connect_Proxy(ITBasicCallControl * This,VARIANT_BOOL fSync);
void __RPC_STUB ITBasicCallControl_Connect_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_Answer_Proxy(ITBasicCallControl * This);
void __RPC_STUB ITBasicCallControl_Answer_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_Disconnect_Proxy(ITBasicCallControl * This,DISCONNECT_CODE code);
void __RPC_STUB ITBasicCallControl_Disconnect_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_Hold_Proxy(ITBasicCallControl * This,VARIANT_BOOL fHold);
void __RPC_STUB ITBasicCallControl_Hold_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_HandoffDirect_Proxy(ITBasicCallControl * This,BSTR pApplicationName);
void __RPC_STUB ITBasicCallControl_HandoffDirect_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_HandoffIndirect_Proxy(ITBasicCallControl * This,long lMediaType);
void __RPC_STUB ITBasicCallControl_HandoffIndirect_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_Conference_Proxy(ITBasicCallControl * This,ITBasicCallControl *pCall,VARIANT_BOOL fSync);
void __RPC_STUB ITBasicCallControl_Conference_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_Transfer_Proxy(ITBasicCallControl * This,ITBasicCallControl *pCall,VARIANT_BOOL fSync);
void __RPC_STUB ITBasicCallControl_Transfer_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_BlindTransfer_Proxy(ITBasicCallControl * This,BSTR pDestAddress);
void __RPC_STUB ITBasicCallControl_BlindTransfer_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_SwapHold_Proxy(ITBasicCallControl * This,ITBasicCallControl *pCall);
void __RPC_STUB ITBasicCallControl_SwapHold_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_ParkDirect_Proxy(ITBasicCallControl * This,BSTR pParkAddress);
void __RPC_STUB ITBasicCallControl_ParkDirect_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_ParkIndirect_Proxy(ITBasicCallControl * This,BSTR *ppNonDirAddress);
void __RPC_STUB ITBasicCallControl_ParkIndirect_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_Unpark_Proxy(ITBasicCallControl * This);
void __RPC_STUB ITBasicCallControl_Unpark_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_SetQOS_Proxy(ITBasicCallControl * This,long lMediaType,QOS_SERVICE_LEVEL ServiceLevel);
void __RPC_STUB ITBasicCallControl_SetQOS_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_Pickup_Proxy(ITBasicCallControl * This,BSTR pGroupID);
void __RPC_STUB ITBasicCallControl_Pickup_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_Dial_Proxy(ITBasicCallControl * This,BSTR pDestAddress);
void __RPC_STUB ITBasicCallControl_Dial_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_Finish_Proxy(ITBasicCallControl * This,FINISH_MODE finishMode);
void __RPC_STUB ITBasicCallControl_Finish_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl_RemoveFromConference_Proxy(ITBasicCallControl * This);
...
EXTERN_C const IID IID_ITCallInfo;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Address(ITAddress **ppAddress)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CallState(CALL_STATE *pCallState)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Privilege(CALL_PRIVILEGE *pPrivilege)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CallHub(ITCallHub **ppCallHub)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CallInfoLong(CALLINFO_LONG CallInfoLong,long *plCallInfoLongVal)=0;
		virtual HRESULT STDMETHODCALLTYPE put_CallInfoLong(CALLINFO_LONG CallInfoLong,long lCallInfoLongVal)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CallInfoString(CALLINFO_STRING CallInfoString,BSTR *ppCallInfoString)=0;
		virtual HRESULT STDMETHODCALLTYPE put_CallInfoString(CALLINFO_STRING CallInfoString,BSTR pCallInfoString)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CallInfoBuffer(CALLINFO_BUFFER CallInfoBuffer,VARIANT *ppCallInfoBuffer)=0;
		virtual HRESULT STDMETHODCALLTYPE put_CallInfoBuffer(CALLINFO_BUFFER CallInfoBuffer,VARIANT pCallInfoBuffer)=0;
		virtual HRESULT STDMETHODCALLTYPE GetCallInfoBuffer(CALLINFO_BUFFER CallInfoBuffer,DWORD *pdwSize,BYTE **ppCallInfoBuffer)=0;
		virtual HRESULT STDMETHODCALLTYPE SetCallInfoBuffer(CALLINFO_BUFFER CallInfoBuffer,DWORD dwSize,BYTE *pCallInfoBuffer)=0;
		virtual HRESULT STDMETHODCALLTYPE ReleaseUserUserInfo(void)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITCallInfo_get_Address_Proxy(ITCallInfo * This,ITAddress **ppAddress);
void __RPC_STUB ITCallInfo_get_Address_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallInfo_get_CallState_Proxy(ITCallInfo * This,CALL_STATE *pCallState);
void __RPC_STUB ITCallInfo_get_CallState_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallInfo_get_Privilege_Proxy(ITCallInfo * This,CALL_PRIVILEGE *pPrivilege);
void __RPC_STUB ITCallInfo_get_Privilege_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallInfo_get_CallHub_Proxy(ITCallInfo * This,ITCallHub **ppCallHub);
void __RPC_STUB ITCallInfo_get_CallHub_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallInfo_get_CallInfoLong_Proxy(ITCallInfo * This,CALLINFO_LONG CallInfoLong,long *plCallInfoLongVal);
void __RPC_STUB ITCallInfo_get_CallInfoLong_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallInfo_put_CallInfoLong_Proxy(ITCallInfo * This,CALLINFO_LONG CallInfoLong,long lCallInfoLongVal);
void __RPC_STUB ITCallInfo_put_CallInfoLong_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallInfo_get_CallInfoString_Proxy(ITCallInfo * This,CALLINFO_STRING CallInfoString,BSTR *ppCallInfoString);
void __RPC_STUB ITCallInfo_get_CallInfoString_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallInfo_put_CallInfoString_Proxy(ITCallInfo * This,CALLINFO_STRING CallInfoString,BSTR pCallInfoString);
void __RPC_STUB ITCallInfo_put_CallInfoString_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallInfo_get_CallInfoBuffer_Proxy(ITCallInfo * This,CALLINFO_BUFFER CallInfoBuffer,VARIANT *ppCallInfoBuffer);
void __RPC_STUB ITCallInfo_get_CallInfoBuffer_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallInfo_put_CallInfoBuffer_Proxy(ITCallInfo * This,CALLINFO_BUFFER CallInfoBuffer,VARIANT pCallInfoBuffer);
void __RPC_STUB ITCallInfo_put_CallInfoBuffer_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallInfo_GetCallInfoBuffer_Proxy(ITCallInfo * This,CALLINFO_BUFFER CallInfoBuffer,DWORD *pdwSize,BYTE **ppCallInfoBuffer);
void __RPC_STUB ITCallInfo_GetCallInfoBuffer_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallInfo_SetCallInfoBuffer_Proxy(ITCallInfo * This,CALLINFO_BUFFER CallInfoBuffer,DWORD dwSize,BYTE *pCallInfoBuffer);
void __RPC_STUB ITCallInfo_SetCallInfoBuffer_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallInfo_ReleaseUserUserInfo_Proxy(ITCallInfo * This);
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITCallInfo2_get_EventFilter_Proxy(ITCallInfo2 * This,TAPI_EVENT TapiEvent,long lSubEvent,VARIANT_BOOL *pEnable);
void __RPC_STUB ITCallInfo2_get_EventFilter_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallInfo2_put_EventFilter_Proxy(ITCallInfo2 * This,TAPI_EVENT TapiEvent,long lSubEvent,VARIANT_BOOL bEnable);
...
EXTERN_C const IID IID_ITTerminal;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Name(BSTR *ppName)=0;
		virtual HRESULT STDMETHODCALLTYPE get_State(TERMINAL_STATE *pTerminalState)=0;
		virtual HRESULT STDMETHODCALLTYPE get_TerminalType(TERMINAL_TYPE *pType)=0;
		virtual HRESULT STDMETHODCALLTYPE get_TerminalClass(BSTR *ppTerminalClass)=0;
		virtual HRESULT STDMETHODCALLTYPE get_MediaType(long *plMediaType)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Direction(TERMINAL_DIRECTION *pDirection)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITTerminal_get_Name_Proxy(ITTerminal * This,BSTR *ppName);
void __RPC_STUB ITTerminal_get_Name_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTerminal_get_State_Proxy(ITTerminal * This,TERMINAL_STATE *pTerminalState);
void __RPC_STUB ITTerminal_get_State_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTerminal_get_TerminalType_Proxy(ITTerminal * This,TERMINAL_TYPE *pType);
void __RPC_STUB ITTerminal_get_TerminalType_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTerminal_get_TerminalClass_Proxy(ITTerminal * This,BSTR *ppTerminalClass);
void __RPC_STUB ITTerminal_get_TerminalClass_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTerminal_get_MediaType_Proxy(ITTerminal * This,long *plMediaType);
void __RPC_STUB ITTerminal_get_MediaType_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTerminal_get_Direction_Proxy(ITTerminal * This,TERMINAL_DIRECTION *pDirection);
...
EXTERN_C const IID IID_ITMultiTrackTerminal;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_TrackTerminals(VARIANT *pVariant)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateTrackTerminals(IEnumTerminal **ppEnumTerminal)=0;
		virtual HRESULT STDMETHODCALLTYPE CreateTrackTerminal(long MediaType,TERMINAL_DIRECTION TerminalDirection,ITTerminal **ppTerminal)=0;
		virtual HRESULT STDMETHODCALLTYPE get_MediaTypesInUse(long *plMediaTypesInUse)=0;
		virtual HRESULT STDMETHODCALLTYPE get_DirectionsInUse(TERMINAL_DIRECTION *plDirectionsInUsed)=0;
		virtual HRESULT STDMETHODCALLTYPE RemoveTrackTerminal(ITTerminal *pTrackTerminalToRemove)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITMultiTrackTerminal_get_TrackTerminals_Proxy(ITMultiTrackTerminal * This,VARIANT *pVariant);
void __RPC_STUB ITMultiTrackTerminal_get_TrackTerminals_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITMultiTrackTerminal_EnumerateTrackTerminals_Proxy(ITMultiTrackTerminal * This,IEnumTerminal **ppEnumTerminal);
void __RPC_STUB ITMultiTrackTerminal_EnumerateTrackTerminals_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITMultiTrackTerminal_CreateTrackTerminal_Proxy(ITMultiTrackTerminal * This,long MediaType,TERMINAL_DIRECTION TerminalDirection,ITTerminal **ppTerminal);
void __RPC_STUB ITMultiTrackTerminal_CreateTrackTerminal_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITMultiTrackTerminal_get_MediaTypesInUse_Proxy(ITMultiTrackTerminal * This,long *plMediaTypesInUse);
void __RPC_STUB ITMultiTrackTerminal_get_MediaTypesInUse_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITMultiTrackTerminal_get_DirectionsInUse_Proxy(ITMultiTrackTerminal * This,TERMINAL_DIRECTION *plDirectionsInUsed);
void __RPC_STUB ITMultiTrackTerminal_get_DirectionsInUse_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITMultiTrackTerminal_RemoveTrackTerminal_Proxy(ITMultiTrackTerminal * This,ITTerminal *pTrackTerminalToRemove);
...
enum TERMINAL_MEDIA_STATE
	{	TMS_IDLE	=0,TMS_ACTIVE	=TMS_IDLE + 1,TMS_PAUSED	=TMS_ACTIVE + 1,TMS_LASTITEM	=TMS_PAUSED
	} 	TERMINAL_MEDIA_STATE;
typedef 
enum FT_STATE_EVENT_CAUSE
	{	FTEC_NORMAL	=0,FTEC_END_OF_FILE	=FTEC_NORMAL + 1,FTEC_READ_ERROR	=FTEC_END_OF_FILE + 1,FTEC_WRITE_ERROR	=FTEC_READ_ERROR + 1
...
EXTERN_C const IID IID_ITFileTrack;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Format(AM_MEDIA_TYPE **ppmt)=0;
		virtual HRESULT STDMETHODCALLTYPE put_Format(const AM_MEDIA_TYPE *pmt)=0;
		virtual HRESULT STDMETHODCALLTYPE get_ControllingTerminal(ITTerminal **ppControllingTerminal)=0;
		virtual HRESULT STDMETHODCALLTYPE get_AudioFormatForScripting(ITScriptableAudioFormat **ppAudioFormat)=0;
		virtual HRESULT STDMETHODCALLTYPE put_AudioFormatForScripting(ITScriptableAudioFormat *pAudioFormat)=0;
		virtual HRESULT STDMETHODCALLTYPE get_EmptyAudioFormatForScripting(ITScriptableAudioFormat **ppAudioFormat)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITFileTrack_get_Format_Proxy(ITFileTrack * This,AM_MEDIA_TYPE **ppmt);
void __RPC_STUB ITFileTrack_get_Format_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITFileTrack_put_Format_Proxy(ITFileTrack * This,const AM_MEDIA_TYPE *pmt);
void __RPC_STUB ITFileTrack_put_Format_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITFileTrack_get_ControllingTerminal_Proxy(ITFileTrack * This,ITTerminal **ppControllingTerminal);
void __RPC_STUB ITFileTrack_get_ControllingTerminal_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITFileTrack_get_AudioFormatForScripting_Proxy(ITFileTrack * This,ITScriptableAudioFormat **ppAudioFormat);
void __RPC_STUB ITFileTrack_get_AudioFormatForScripting_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITFileTrack_put_AudioFormatForScripting_Proxy(ITFileTrack * This,ITScriptableAudioFormat *pAudioFormat);
void __RPC_STUB ITFileTrack_put_AudioFormatForScripting_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITFileTrack_get_EmptyAudioFormatForScripting_Proxy(ITFileTrack * This,ITScriptableAudioFormat **ppAudioFormat);
...
EXTERN_C const IID IID_ITMediaPlayback;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE put_PlayList(VARIANTARG PlayListVariant)=0;
		virtual HRESULT STDMETHODCALLTYPE get_PlayList(VARIANTARG *pPlayListVariant)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITMediaPlayback_put_PlayList_Proxy(ITMediaPlayback * This,VARIANTARG PlayListVariant);
void __RPC_STUB ITMediaPlayback_put_PlayList_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITMediaPlayback_get_PlayList_Proxy(ITMediaPlayback * This,VARIANTARG *pPlayListVariant);
...
EXTERN_C const IID IID_ITMediaRecord;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE put_FileName(BSTR bstrFileName)=0;
		virtual HRESULT STDMETHODCALLTYPE get_FileName(BSTR *pbstrFileName)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITMediaRecord_put_FileName_Proxy(ITMediaRecord * This,BSTR bstrFileName);
void __RPC_STUB ITMediaRecord_put_FileName_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITMediaRecord_get_FileName_Proxy(ITMediaRecord * This,BSTR *pbstrFileName);
...
EXTERN_C const IID IID_ITMediaControl;
	...
	public:
		...
		virtual HRESULT STDMETHODCALLTYPE get_MediaState(TERMINAL_MEDIA_STATE *pTerminalMediaState)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITMediaControl_Start_Proxy(ITMediaControl * This);
void __RPC_STUB ITMediaControl_Start_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITMediaControl_Stop_Proxy(ITMediaControl * This);
void __RPC_STUB ITMediaControl_Stop_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITMediaControl_Pause_Proxy(ITMediaControl * This);
void __RPC_STUB ITMediaControl_Pause_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITMediaControl_get_MediaState_Proxy(ITMediaControl * This,TERMINAL_MEDIA_STATE *pTerminalMediaState);
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITBasicAudioTerminal_put_Volume_Proxy(ITBasicAudioTerminal * This,long lVolume);
void __RPC_STUB ITBasicAudioTerminal_put_Volume_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicAudioTerminal_get_Volume_Proxy(ITBasicAudioTerminal * This,long *plVolume);
void __RPC_STUB ITBasicAudioTerminal_get_Volume_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicAudioTerminal_put_Balance_Proxy(ITBasicAudioTerminal * This,long lBalance);
void __RPC_STUB ITBasicAudioTerminal_put_Balance_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicAudioTerminal_get_Balance_Proxy(ITBasicAudioTerminal * This,long *plBalance);
...
EXTERN_C const IID IID_ITStaticAudioTerminal;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_WaveId(long *plWaveId)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITStaticAudioTerminal_get_WaveId_Proxy(ITStaticAudioTerminal * This,long *plWaveId);
...
EXTERN_C const IID IID_ITCallHub;
	...
	public:
		...
		virtual HRESULT STDMETHODCALLTYPE EnumerateCalls(IEnumCall **ppEnumCall)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Calls(VARIANT *pCalls)=0;
		virtual HRESULT STDMETHODCALLTYPE get_NumCalls(long *plCalls)=0;
		virtual HRESULT STDMETHODCALLTYPE get_State(CALLHUB_STATE *pState)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITCallHub_Clear_Proxy(ITCallHub * This);
void __RPC_STUB ITCallHub_Clear_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallHub_EnumerateCalls_Proxy(ITCallHub * This,IEnumCall **ppEnumCall);
void __RPC_STUB ITCallHub_EnumerateCalls_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallHub_get_Calls_Proxy(ITCallHub * This,VARIANT *pCalls);
void __RPC_STUB ITCallHub_get_Calls_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallHub_get_NumCalls_Proxy(ITCallHub * This,long *plCalls);
void __RPC_STUB ITCallHub_get_NumCalls_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallHub_get_State_Proxy(ITCallHub * This,CALLHUB_STATE *pState);
...
EXTERN_C const IID IID_ITLegacyAddressMediaControl;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE GetID(BSTR pDeviceClass,DWORD *pdwSize,BYTE **ppDeviceID)=0;
		virtual HRESULT STDMETHODCALLTYPE GetDevConfig(BSTR pDeviceClass,DWORD *pdwSize,BYTE **ppDeviceConfig)=0;
		virtual HRESULT STDMETHODCALLTYPE SetDevConfig(BSTR pDeviceClass,DWORD dwSize,BYTE *pDeviceConfig)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITLegacyAddressMediaControl_GetID_Proxy(ITLegacyAddressMediaControl * This,BSTR pDeviceClass,DWORD *pdwSize,BYTE **ppDeviceID);
void __RPC_STUB ITLegacyAddressMediaControl_GetID_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLegacyAddressMediaControl_GetDevConfig_Proxy(ITLegacyAddressMediaControl * This,BSTR pDeviceClass,DWORD *pdwSize,BYTE **ppDeviceConfig);
void __RPC_STUB ITLegacyAddressMediaControl_GetDevConfig_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLegacyAddressMediaControl_SetDevConfig_Proxy(ITLegacyAddressMediaControl * This,BSTR pDeviceClass,DWORD dwSize,BYTE *pDeviceConfig);
...
EXTERN_C const IID IID_ITPrivateEvent;
	...
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Address(ITAddress **ppAddress)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Call(ITCallInfo **ppCallInfo)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CallHub(ITCallHub **ppCallHub)=0;
		virtual HRESULT STDMETHODCALLTYPE get_EventCode(long *plEventCode)=0;
		virtual HRESULT STDMETHODCALLTYPE get_EventInterface(IDispatch **pEventInterface)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITPrivateEvent_get_Address_Proxy(ITPrivateEvent * This,ITAddress **ppAddress);
void __RPC_STUB ITPrivateEvent_get_Address_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPrivateEvent_get_Call_Proxy(ITPrivateEvent * This,ITCallInfo **ppCallInfo);
void __RPC_STUB ITPrivateEvent_get_Call_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPrivateEvent_get_CallHub_Proxy(ITPrivateEvent * This,ITCallHub **ppCallHub);
void __RPC_STUB ITPrivateEvent_get_CallHub_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPrivateEvent_get_EventCode_Proxy(ITPrivateEvent * This,long *plEventCode);
void __RPC_STUB ITPrivateEvent_get_EventCode_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPrivateEvent_get_EventInterface_Proxy(ITPrivateEvent * This,IDispatch **pEventInterface);
...
EXTERN_C const IID IID_ITLegacyAddressMediaControl2;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE ConfigDialog(HWND hwndOwner,BSTR pDeviceClass)=0;
		virtual HRESULT STDMETHODCALLTYPE ConfigDialogEdit(HWND hwndOwner,BSTR pDeviceClass,DWORD dwSizeIn,BYTE *pDeviceConfigIn,DWORD *pdwSizeOut,BYTE **ppDeviceConfigOut)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITLegacyAddressMediaControl2_ConfigDialog_Proxy(ITLegacyAddressMediaControl2 * This,HWND hwndOwner,BSTR pDeviceClass);
void __RPC_STUB ITLegacyAddressMediaControl2_ConfigDialog_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLegacyAddressMediaControl2_ConfigDialogEdit_Proxy(ITLegacyAddressMediaControl2 * This,HWND hwndOwner,BSTR pDeviceClass,DWORD dwSizeIn,BYTE *pDeviceConfigIn,DWORD *pdwSizeOut,BYTE **ppDeviceConfigOut);
...
EXTERN_C const IID IID_ITLegacyCallMediaControl;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE DetectDigits(TAPI_DIGITMODE DigitMode)=0;
		virtual HRESULT STDMETHODCALLTYPE GenerateDigits(BSTR pDigits,TAPI_DIGITMODE DigitMode)=0;
		virtual HRESULT STDMETHODCALLTYPE GetID(BSTR pDeviceClass,DWORD *pdwSize,BYTE **ppDeviceID)=0;
		virtual HRESULT STDMETHODCALLTYPE SetMediaType(long lMediaType)=0;
		virtual HRESULT STDMETHODCALLTYPE MonitorMedia(long lMediaType)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITLegacyCallMediaControl_DetectDigits_Proxy(ITLegacyCallMediaControl * This,TAPI_DIGITMODE DigitMode);
void __RPC_STUB ITLegacyCallMediaControl_DetectDigits_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLegacyCallMediaControl_GenerateDigits_Proxy(ITLegacyCallMediaControl * This,BSTR pDigits,TAPI_DIGITMODE DigitMode);
void __RPC_STUB ITLegacyCallMediaControl_GenerateDigits_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLegacyCallMediaControl_GetID_Proxy(ITLegacyCallMediaControl * This,BSTR pDeviceClass,DWORD *pdwSize,BYTE **ppDeviceID);
void __RPC_STUB ITLegacyCallMediaControl_GetID_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLegacyCallMediaControl_SetMediaType_Proxy(ITLegacyCallMediaControl * This,long lMediaType);
void __RPC_STUB ITLegacyCallMediaControl_SetMediaType_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLegacyCallMediaControl_MonitorMedia_Proxy(ITLegacyCallMediaControl * This,long lMediaType);
...
EXTERN_C const IID IID_ITLegacyCallMediaControl2;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE GenerateDigits2(BSTR pDigits,TAPI_DIGITMODE DigitMode,long lDuration)=0;
		virtual HRESULT STDMETHODCALLTYPE GatherDigits(TAPI_DIGITMODE DigitMode,long lNumDigits,BSTR pTerminationDigits,long lFirstDigitTimeout,long lInterDigitTimeout)=0;
		virtual HRESULT STDMETHODCALLTYPE DetectTones(TAPI_DETECTTONE *pToneList,long lNumTones)=0;
		virtual HRESULT STDMETHODCALLTYPE DetectTonesByCollection(ITCollection2 *pDetectToneCollection)=0;
		virtual HRESULT STDMETHODCALLTYPE GenerateTone(TAPI_TONEMODE ToneMode,long lDuration)=0;
		virtual HRESULT STDMETHODCALLTYPE GenerateCustomTones(TAPI_CUSTOMTONE *pToneList,long lNumTones,long lDuration)=0;
		virtual HRESULT STDMETHODCALLTYPE GenerateCustomTonesByCollection(ITCollection2 *pCustomToneCollection,long lDuration)=0;
		virtual HRESULT STDMETHODCALLTYPE CreateDetectToneObject(ITDetectTone **ppDetectTone)=0;
		virtual HRESULT STDMETHODCALLTYPE CreateCustomToneObject(ITCustomTone **ppCustomTone)=0;
		virtual HRESULT STDMETHODCALLTYPE GetIDAsVariant(BSTR bstrDeviceClass,VARIANT *pVarDeviceID)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITLegacyCallMediaControl2_GenerateDigits2_Proxy(ITLegacyCallMediaControl2 * This,BSTR pDigits,TAPI_DIGITMODE DigitMode,long lDuration);
void __RPC_STUB ITLegacyCallMediaControl2_GenerateDigits2_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLegacyCallMediaControl2_GatherDigits_Proxy(ITLegacyCallMediaControl2 * This,TAPI_DIGITMODE DigitMode,long lNumDigits,BSTR pTerminationDigits,long lFirstDigitTimeout,long lInterDigitTimeout);
void __RPC_STUB ITLegacyCallMediaControl2_GatherDigits_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLegacyCallMediaControl2_DetectTones_Proxy(ITLegacyCallMediaControl2 * This,TAPI_DETECTTONE *pToneList,long lNumTones);
void __RPC_STUB ITLegacyCallMediaControl2_DetectTones_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLegacyCallMediaControl2_DetectTonesByCollection_Proxy(ITLegacyCallMediaControl2 * This,ITCollection2 *pDetectToneCollection);
void __RPC_STUB ITLegacyCallMediaControl2_DetectTonesByCollection_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLegacyCallMediaControl2_GenerateTone_Proxy(ITLegacyCallMediaControl2 * This,TAPI_TONEMODE ToneMode,long lDuration);
void __RPC_STUB ITLegacyCallMediaControl2_GenerateTone_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLegacyCallMediaControl2_GenerateCustomTones_Proxy(ITLegacyCallMediaControl2 * This,TAPI_CUSTOMTONE *pToneList,long lNumTones,long lDuration);
void __RPC_STUB ITLegacyCallMediaControl2_GenerateCustomTones_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLegacyCallMediaControl2_GenerateCustomTonesByCollection_Proxy(ITLegacyCallMediaControl2 * This,ITCollection2 *pCustomToneCollection,long lDuration);
void __RPC_STUB ITLegacyCallMediaControl2_GenerateCustomTonesByCollection_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLegacyCallMediaControl2_CreateDetectToneObject_Proxy(ITLegacyCallMediaControl2 * This,ITDetectTone **ppDetectTone);
void __RPC_STUB ITLegacyCallMediaControl2_CreateDetectToneObject_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLegacyCallMediaControl2_CreateCustomToneObject_Proxy(ITLegacyCallMediaControl2 * This,ITCustomTone **ppCustomTone);
void __RPC_STUB ITLegacyCallMediaControl2_CreateCustomToneObject_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLegacyCallMediaControl2_GetIDAsVariant_Proxy(ITLegacyCallMediaControl2 * This,BSTR bstrDeviceClass,VARIANT *pVarDeviceID);
...
EXTERN_C const IID IID_ITDetectTone;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_AppSpecific(long *plAppSpecific)=0;
		virtual HRESULT STDMETHODCALLTYPE put_AppSpecific(long lAppSpecific)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Duration(long *plDuration)=0;
		virtual HRESULT STDMETHODCALLTYPE put_Duration(long lDuration)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Frequency(long Index,long *plFrequency)=0;
		virtual HRESULT STDMETHODCALLTYPE put_Frequency(long Index,long lFrequency)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITDetectTone_get_AppSpecific_Proxy(ITDetectTone * This,long *plAppSpecific);
void __RPC_STUB ITDetectTone_get_AppSpecific_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITDetectTone_put_AppSpecific_Proxy(ITDetectTone * This,long lAppSpecific);
void __RPC_STUB ITDetectTone_put_AppSpecific_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITDetectTone_get_Duration_Proxy(ITDetectTone * This,long *plDuration);
void __RPC_STUB ITDetectTone_get_Duration_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITDetectTone_put_Duration_Proxy(ITDetectTone * This,long lDuration);
void __RPC_STUB ITDetectTone_put_Duration_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITDetectTone_get_Frequency_Proxy(ITDetectTone * This,long Index,long *plFrequency);
void __RPC_STUB ITDetectTone_get_Frequency_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITDetectTone_put_Frequency_Proxy(ITDetectTone * This,long Index,long lFrequency);
...
EXTERN_C const IID IID_ITCustomTone;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Frequency(long *plFrequency)=0;
		virtual HRESULT STDMETHODCALLTYPE put_Frequency(long lFrequency)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CadenceOn(long *plCadenceOn)=0;
		virtual HRESULT STDMETHODCALLTYPE put_CadenceOn(long CadenceOn)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CadenceOff(long *plCadenceOff)=0;
		virtual HRESULT STDMETHODCALLTYPE put_CadenceOff(long lCadenceOff)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Volume(long *plVolume)=0;
		virtual HRESULT STDMETHODCALLTYPE put_Volume(long lVolume)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITCustomTone_get_Frequency_Proxy(ITCustomTone * This,long *plFrequency);
void __RPC_STUB ITCustomTone_get_Frequency_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCustomTone_put_Frequency_Proxy(ITCustomTone * This,long lFrequency);
void __RPC_STUB ITCustomTone_put_Frequency_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCustomTone_get_CadenceOn_Proxy(ITCustomTone * This,long *plCadenceOn);
void __RPC_STUB ITCustomTone_get_CadenceOn_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCustomTone_put_CadenceOn_Proxy(ITCustomTone * This,long CadenceOn);
void __RPC_STUB ITCustomTone_put_CadenceOn_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCustomTone_get_CadenceOff_Proxy(ITCustomTone * This,long *plCadenceOff);
void __RPC_STUB ITCustomTone_get_CadenceOff_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCustomTone_put_CadenceOff_Proxy(ITCustomTone * This,long lCadenceOff);
void __RPC_STUB ITCustomTone_put_CadenceOff_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCustomTone_get_Volume_Proxy(ITCustomTone * This,long *plVolume);
void __RPC_STUB ITCustomTone_get_Volume_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCustomTone_put_Volume_Proxy(ITCustomTone * This,long lVolume);
...
EXTERN_C const IID IID_IEnumPhone;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt,ITPhone **ppElements,ULONG *pceltFetched)=0;
		virtual HRESULT STDMETHODCALLTYPE Reset(void)=0;
		virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt)=0;
		virtual HRESULT STDMETHODCALLTYPE Clone(IEnumPhone **ppEnum)=0;
	};
#else 	
...
#endif 
#endif 	
HRESULT STDMETHODCALLTYPE IEnumPhone_Next_Proxy(IEnumPhone * This,ULONG celt,ITPhone **ppElements,ULONG *pceltFetched);
...
HRESULT STDMETHODCALLTYPE IEnumPhone_Reset_Proxy(IEnumPhone * This);
...
HRESULT STDMETHODCALLTYPE IEnumPhone_Skip_Proxy(IEnumPhone * This,ULONG celt);
...
HRESULT STDMETHODCALLTYPE IEnumPhone_Clone_Proxy(IEnumPhone * This,IEnumPhone **ppEnum);
...
EXTERN_C const IID IID_IEnumTerminal;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt,ITTerminal **ppElements,ULONG *pceltFetched)=0;
		virtual HRESULT STDMETHODCALLTYPE Reset(void)=0;
		virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt)=0;
		virtual HRESULT STDMETHODCALLTYPE Clone(IEnumTerminal **ppEnum)=0;
	};
#else 	
...
#endif 
#endif 	
HRESULT STDMETHODCALLTYPE IEnumTerminal_Next_Proxy(IEnumTerminal * This,ULONG celt,ITTerminal **ppElements,ULONG *pceltFetched);
...
HRESULT STDMETHODCALLTYPE IEnumTerminal_Reset_Proxy(IEnumTerminal * This);
...
HRESULT STDMETHODCALLTYPE IEnumTerminal_Skip_Proxy(IEnumTerminal * This,ULONG celt);
...
HRESULT STDMETHODCALLTYPE IEnumTerminal_Clone_Proxy(IEnumTerminal * This,IEnumTerminal **ppEnum);
...
EXTERN_C const IID IID_IEnumTerminalClass;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt,GUID *pElements,ULONG *pceltFetched)=0;
		virtual HRESULT STDMETHODCALLTYPE Reset(void)=0;
		virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt)=0;
		virtual HRESULT STDMETHODCALLTYPE Clone(IEnumTerminalClass **ppEnum)=0;
	};
#else 	
...
#endif 
#endif 	
HRESULT STDMETHODCALLTYPE IEnumTerminalClass_Next_Proxy(IEnumTerminalClass * This,ULONG celt,GUID *pElements,ULONG *pceltFetched);
...
HRESULT STDMETHODCALLTYPE IEnumTerminalClass_Reset_Proxy(IEnumTerminalClass * This);
...
HRESULT STDMETHODCALLTYPE IEnumTerminalClass_Skip_Proxy(IEnumTerminalClass * This,ULONG celt);
...
HRESULT STDMETHODCALLTYPE IEnumTerminalClass_Clone_Proxy(IEnumTerminalClass * This,IEnumTerminalClass **ppEnum);
...
EXTERN_C const IID IID_IEnumCall;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt,ITCallInfo **ppElements,ULONG *pceltFetched)=0;
		virtual HRESULT STDMETHODCALLTYPE Reset(void)=0;
		virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt)=0;
		virtual HRESULT STDMETHODCALLTYPE Clone(IEnumCall **ppEnum)=0;
	};
#else 	
...
#endif 
#endif 	
HRESULT STDMETHODCALLTYPE IEnumCall_Next_Proxy(IEnumCall * This,ULONG celt,ITCallInfo **ppElements,ULONG *pceltFetched);
...
HRESULT STDMETHODCALLTYPE IEnumCall_Reset_Proxy(IEnumCall * This);
...
HRESULT STDMETHODCALLTYPE IEnumCall_Skip_Proxy(IEnumCall * This,ULONG celt);
...
HRESULT STDMETHODCALLTYPE IEnumCall_Clone_Proxy(IEnumCall * This,IEnumCall **ppEnum);
...
EXTERN_C const IID IID_IEnumAddress;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt,ITAddress **ppElements,ULONG *pceltFetched)=0;
		virtual HRESULT STDMETHODCALLTYPE Reset(void)=0;
		virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt)=0;
		virtual HRESULT STDMETHODCALLTYPE Clone(IEnumAddress **ppEnum)=0;
	};
#else 	
...
#endif 
#endif 	
HRESULT STDMETHODCALLTYPE IEnumAddress_Next_Proxy(IEnumAddress * This,ULONG celt,ITAddress **ppElements,ULONG *pceltFetched);
...
HRESULT STDMETHODCALLTYPE IEnumAddress_Reset_Proxy(IEnumAddress * This);
...
HRESULT STDMETHODCALLTYPE IEnumAddress_Skip_Proxy(IEnumAddress * This,ULONG celt);
...
HRESULT STDMETHODCALLTYPE IEnumAddress_Clone_Proxy(IEnumAddress * This,IEnumAddress **ppEnum);
...
EXTERN_C const IID IID_IEnumCallHub;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt,ITCallHub **ppElements,ULONG *pceltFetched)=0;
		virtual HRESULT STDMETHODCALLTYPE Reset(void)=0;
		virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt)=0;
		virtual HRESULT STDMETHODCALLTYPE Clone(IEnumCallHub **ppEnum)=0;
	};
#else 	
...
#endif 
#endif 	
HRESULT STDMETHODCALLTYPE IEnumCallHub_Next_Proxy(IEnumCallHub * This,ULONG celt,ITCallHub **ppElements,ULONG *pceltFetched);
...
HRESULT STDMETHODCALLTYPE IEnumCallHub_Reset_Proxy(IEnumCallHub * This);
...
HRESULT STDMETHODCALLTYPE IEnumCallHub_Skip_Proxy(IEnumCallHub * This,ULONG celt);
...
HRESULT STDMETHODCALLTYPE IEnumCallHub_Clone_Proxy(IEnumCallHub * This,IEnumCallHub **ppEnum);
...
EXTERN_C const IID IID_IEnumBstr;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt,BSTR *ppStrings,ULONG *pceltFetched)=0;
		virtual HRESULT STDMETHODCALLTYPE Reset(void)=0;
		virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt)=0;
		virtual HRESULT STDMETHODCALLTYPE Clone(IEnumBstr **ppEnum)=0;
	};
#else 	
...
#endif 
#endif 	
HRESULT STDMETHODCALLTYPE IEnumBstr_Next_Proxy(IEnumBstr * This,ULONG celt,BSTR *ppStrings,ULONG *pceltFetched);
...
HRESULT STDMETHODCALLTYPE IEnumBstr_Reset_Proxy(IEnumBstr * This);
...
HRESULT STDMETHODCALLTYPE IEnumBstr_Skip_Proxy(IEnumBstr * This,ULONG celt);
...
HRESULT STDMETHODCALLTYPE IEnumBstr_Clone_Proxy(IEnumBstr * This,IEnumBstr **ppEnum);
...
EXTERN_C const IID IID_IEnumPluggableTerminalClassInfo;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt,ITPluggableTerminalClassInfo **ppElements,ULONG *pceltFetched)=0;
		virtual HRESULT STDMETHODCALLTYPE Reset(void)=0;
		virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt)=0;
		virtual HRESULT STDMETHODCALLTYPE Clone(IEnumPluggableTerminalClassInfo **ppEnum)=0;
	};
#else 	
...
#endif 
#endif 	
HRESULT STDMETHODCALLTYPE IEnumPluggableTerminalClassInfo_Next_Proxy(IEnumPluggableTerminalClassInfo * This,ULONG celt,ITPluggableTerminalClassInfo **ppElements,ULONG *pceltFetched);
...
HRESULT STDMETHODCALLTYPE IEnumPluggableTerminalClassInfo_Reset_Proxy(IEnumPluggableTerminalClassInfo * This);
...
HRESULT STDMETHODCALLTYPE IEnumPluggableTerminalClassInfo_Skip_Proxy(IEnumPluggableTerminalClassInfo * This,ULONG celt);
...
HRESULT STDMETHODCALLTYPE IEnumPluggableTerminalClassInfo_Clone_Proxy(IEnumPluggableTerminalClassInfo * This,IEnumPluggableTerminalClassInfo **ppEnum);
...
EXTERN_C const IID IID_IEnumPluggableSuperclassInfo;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt,ITPluggableTerminalSuperclassInfo **ppElements,ULONG *pceltFetched)=0;
		virtual HRESULT STDMETHODCALLTYPE Reset(void)=0;
		virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt)=0;
		virtual HRESULT STDMETHODCALLTYPE Clone(IEnumPluggableSuperclassInfo **ppEnum)=0;
	};
#else 	
...
#endif 
#endif 	
HRESULT STDMETHODCALLTYPE IEnumPluggableSuperclassInfo_Next_Proxy(IEnumPluggableSuperclassInfo * This,ULONG celt,ITPluggableTerminalSuperclassInfo **ppElements,ULONG *pceltFetched);
...
HRESULT STDMETHODCALLTYPE IEnumPluggableSuperclassInfo_Reset_Proxy(IEnumPluggableSuperclassInfo * This);
...
HRESULT STDMETHODCALLTYPE IEnumPluggableSuperclassInfo_Skip_Proxy(IEnumPluggableSuperclassInfo * This,ULONG celt);
...
HRESULT STDMETHODCALLTYPE IEnumPluggableSuperclassInfo_Clone_Proxy(IEnumPluggableSuperclassInfo * This,IEnumPluggableSuperclassInfo **ppEnum);
...
EXTERN_C const IID IID_ITPhoneEvent;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Phone(ITPhone **ppPhone)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Event(PHONE_EVENT *pEvent)=0;
		virtual HRESULT STDMETHODCALLTYPE get_ButtonState(PHONE_BUTTON_STATE *pState)=0;
		virtual HRESULT STDMETHODCALLTYPE get_HookSwitchState(PHONE_HOOK_SWITCH_STATE *pState)=0;
		virtual HRESULT STDMETHODCALLTYPE get_HookSwitchDevice(PHONE_HOOK_SWITCH_DEVICE *pDevice)=0;
		virtual HRESULT STDMETHODCALLTYPE get_RingMode(long *plRingMode)=0;
		virtual HRESULT STDMETHODCALLTYPE get_ButtonLampId(long *plButtonLampId)=0;
		virtual HRESULT STDMETHODCALLTYPE get_NumberGathered(BSTR *ppNumber)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Call(ITCallInfo **ppCallInfo)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITPhoneEvent_get_Phone_Proxy(ITPhoneEvent * This,ITPhone **ppPhone);
void __RPC_STUB ITPhoneEvent_get_Phone_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhoneEvent_get_Event_Proxy(ITPhoneEvent * This,PHONE_EVENT *pEvent);
void __RPC_STUB ITPhoneEvent_get_Event_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhoneEvent_get_ButtonState_Proxy(ITPhoneEvent * This,PHONE_BUTTON_STATE *pState);
void __RPC_STUB ITPhoneEvent_get_ButtonState_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhoneEvent_get_HookSwitchState_Proxy(ITPhoneEvent * This,PHONE_HOOK_SWITCH_STATE *pState);
void __RPC_STUB ITPhoneEvent_get_HookSwitchState_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhoneEvent_get_HookSwitchDevice_Proxy(ITPhoneEvent * This,PHONE_HOOK_SWITCH_DEVICE *pDevice);
void __RPC_STUB ITPhoneEvent_get_HookSwitchDevice_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhoneEvent_get_RingMode_Proxy(ITPhoneEvent * This,long *plRingMode);
void __RPC_STUB ITPhoneEvent_get_RingMode_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhoneEvent_get_ButtonLampId_Proxy(ITPhoneEvent * This,long *plButtonLampId);
void __RPC_STUB ITPhoneEvent_get_ButtonLampId_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhoneEvent_get_NumberGathered_Proxy(ITPhoneEvent * This,BSTR *ppNumber);
void __RPC_STUB ITPhoneEvent_get_NumberGathered_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhoneEvent_get_Call_Proxy(ITPhoneEvent * This,ITCallInfo **ppCallInfo);
...
EXTERN_C const IID IID_ITCallStateEvent;
	...
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Call(ITCallInfo **ppCallInfo)=0;
		virtual HRESULT STDMETHODCALLTYPE get_State(CALL_STATE *pCallState)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Cause(CALL_STATE_EVENT_CAUSE *pCEC)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CallbackInstance(long *plCallbackInstance)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITCallStateEvent_get_Call_Proxy(ITCallStateEvent * This,ITCallInfo **ppCallInfo);
void __RPC_STUB ITCallStateEvent_get_Call_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallStateEvent_get_State_Proxy(ITCallStateEvent * This,CALL_STATE *pCallState);
void __RPC_STUB ITCallStateEvent_get_State_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallStateEvent_get_Cause_Proxy(ITCallStateEvent * This,CALL_STATE_EVENT_CAUSE *pCEC);
void __RPC_STUB ITCallStateEvent_get_Cause_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallStateEvent_get_CallbackInstance_Proxy(ITCallStateEvent * This,long *plCallbackInstance);
...
EXTERN_C const IID IID_ITPhoneDeviceSpecificEvent;
	...
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Phone(ITPhone **ppPhone)=0;
		virtual HRESULT STDMETHODCALLTYPE get_lParam1(long *pParam1)=0;
		virtual HRESULT STDMETHODCALLTYPE get_lParam2(long *pParam2)=0;
		virtual HRESULT STDMETHODCALLTYPE get_lParam3(long *pParam3)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITPhoneDeviceSpecificEvent_get_Phone_Proxy(ITPhoneDeviceSpecificEvent * This,ITPhone **ppPhone);
void __RPC_STUB ITPhoneDeviceSpecificEvent_get_Phone_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhoneDeviceSpecificEvent_get_lParam1_Proxy(ITPhoneDeviceSpecificEvent * This,long *pParam1);
void __RPC_STUB ITPhoneDeviceSpecificEvent_get_lParam1_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhoneDeviceSpecificEvent_get_lParam2_Proxy(ITPhoneDeviceSpecificEvent * This,long *pParam2);
void __RPC_STUB ITPhoneDeviceSpecificEvent_get_lParam2_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITPhoneDeviceSpecificEvent_get_lParam3_Proxy(ITPhoneDeviceSpecificEvent * This,long *pParam3);
...
EXTERN_C const IID IID_ITCallMediaEvent;
	...
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Call(ITCallInfo **ppCallInfo)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Event(CALL_MEDIA_EVENT *pCallMediaEvent)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Error(HRESULT *phrError)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Terminal(ITTerminal **ppTerminal)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Stream(ITStream **ppStream)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Cause(CALL_MEDIA_EVENT_CAUSE *pCause)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITCallMediaEvent_get_Call_Proxy(ITCallMediaEvent * This,ITCallInfo **ppCallInfo);
void __RPC_STUB ITCallMediaEvent_get_Call_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallMediaEvent_get_Event_Proxy(ITCallMediaEvent * This,CALL_MEDIA_EVENT *pCallMediaEvent);
void __RPC_STUB ITCallMediaEvent_get_Event_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallMediaEvent_get_Error_Proxy(ITCallMediaEvent * This,HRESULT *phrError);
void __RPC_STUB ITCallMediaEvent_get_Error_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallMediaEvent_get_Terminal_Proxy(ITCallMediaEvent * This,ITTerminal **ppTerminal);
void __RPC_STUB ITCallMediaEvent_get_Terminal_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallMediaEvent_get_Stream_Proxy(ITCallMediaEvent * This,ITStream **ppStream);
void __RPC_STUB ITCallMediaEvent_get_Stream_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallMediaEvent_get_Cause_Proxy(ITCallMediaEvent * This,CALL_MEDIA_EVENT_CAUSE *pCause);
...
EXTERN_C const IID IID_ITDigitDetectionEvent;
	...
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Call(ITCallInfo **ppCallInfo)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Digit(unsigned char *pucDigit)=0;
		virtual HRESULT STDMETHODCALLTYPE get_DigitMode(TAPI_DIGITMODE *pDigitMode)=0;
		virtual HRESULT STDMETHODCALLTYPE get_TickCount(long *plTickCount)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CallbackInstance(long *plCallbackInstance)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITDigitDetectionEvent_get_Call_Proxy(ITDigitDetectionEvent * This,ITCallInfo **ppCallInfo);
void __RPC_STUB ITDigitDetectionEvent_get_Call_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITDigitDetectionEvent_get_Digit_Proxy(ITDigitDetectionEvent * This,unsigned char *pucDigit);
void __RPC_STUB ITDigitDetectionEvent_get_Digit_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITDigitDetectionEvent_get_DigitMode_Proxy(ITDigitDetectionEvent * This,TAPI_DIGITMODE *pDigitMode);
void __RPC_STUB ITDigitDetectionEvent_get_DigitMode_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITDigitDetectionEvent_get_TickCount_Proxy(ITDigitDetectionEvent * This,long *plTickCount);
void __RPC_STUB ITDigitDetectionEvent_get_TickCount_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITDigitDetectionEvent_get_CallbackInstance_Proxy(ITDigitDetectionEvent * This,long *plCallbackInstance);
...
EXTERN_C const IID IID_ITDigitGenerationEvent;
	...
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Call(ITCallInfo **ppCallInfo)=0;
		virtual HRESULT STDMETHODCALLTYPE get_GenerationTermination(long *plGenerationTermination)=0;
		virtual HRESULT STDMETHODCALLTYPE get_TickCount(long *plTickCount)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CallbackInstance(long *plCallbackInstance)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITDigitGenerationEvent_get_Call_Proxy(ITDigitGenerationEvent * This,ITCallInfo **ppCallInfo);
void __RPC_STUB ITDigitGenerationEvent_get_Call_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITDigitGenerationEvent_get_GenerationTermination_Proxy(ITDigitGenerationEvent * This,long *plGenerationTermination);
void __RPC_STUB ITDigitGenerationEvent_get_GenerationTermination_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITDigitGenerationEvent_get_TickCount_Proxy(ITDigitGenerationEvent * This,long *plTickCount);
void __RPC_STUB ITDigitGenerationEvent_get_TickCount_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITDigitGenerationEvent_get_CallbackInstance_Proxy(ITDigitGenerationEvent * This,long *plCallbackInstance);
...
EXTERN_C const IID IID_ITDigitsGatheredEvent;
	...
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Call(ITCallInfo **ppCallInfo)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Digits(BSTR *ppDigits)=0;
		virtual HRESULT STDMETHODCALLTYPE get_GatherTermination(TAPI_GATHERTERM *pGatherTermination)=0;
		virtual HRESULT STDMETHODCALLTYPE get_TickCount(long *plTickCount)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CallbackInstance(long *plCallbackInstance)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITDigitsGatheredEvent_get_Call_Proxy(ITDigitsGatheredEvent * This,ITCallInfo **ppCallInfo);
void __RPC_STUB ITDigitsGatheredEvent_get_Call_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITDigitsGatheredEvent_get_Digits_Proxy(ITDigitsGatheredEvent * This,BSTR *ppDigits);
void __RPC_STUB ITDigitsGatheredEvent_get_Digits_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITDigitsGatheredEvent_get_GatherTermination_Proxy(ITDigitsGatheredEvent * This,TAPI_GATHERTERM *pGatherTermination);
void __RPC_STUB ITDigitsGatheredEvent_get_GatherTermination_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITDigitsGatheredEvent_get_TickCount_Proxy(ITDigitsGatheredEvent * This,long *plTickCount);
void __RPC_STUB ITDigitsGatheredEvent_get_TickCount_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITDigitsGatheredEvent_get_CallbackInstance_Proxy(ITDigitsGatheredEvent * This,long *plCallbackInstance);
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITToneDetectionEvent_get_Call_Proxy(ITToneDetectionEvent * This,ITCallInfo **ppCallInfo);
void __RPC_STUB ITToneDetectionEvent_get_Call_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITToneDetectionEvent_get_AppSpecific_Proxy(ITToneDetectionEvent * This,long *plAppSpecific);
void __RPC_STUB ITToneDetectionEvent_get_AppSpecific_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITToneDetectionEvent_get_TickCount_Proxy(ITToneDetectionEvent * This,long *plTickCount);
void __RPC_STUB ITToneDetectionEvent_get_TickCount_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITToneDetectionEvent_get_CallbackInstance_Proxy(ITToneDetectionEvent * This,long *plCallbackInstance);
...
EXTERN_C const IID IID_ITTAPIObjectEvent;
	...
	public:
		virtual HRESULT STDMETHODCALLTYPE get_TAPIObject(ITTAPI **ppTAPIObject)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Event(TAPIOBJECT_EVENT *pEvent)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Address(ITAddress **ppAddress)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CallbackInstance(long *plCallbackInstance)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITTAPIObjectEvent_get_TAPIObject_Proxy(ITTAPIObjectEvent * This,ITTAPI **ppTAPIObject);
void __RPC_STUB ITTAPIObjectEvent_get_TAPIObject_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPIObjectEvent_get_Event_Proxy(ITTAPIObjectEvent * This,TAPIOBJECT_EVENT *pEvent);
void __RPC_STUB ITTAPIObjectEvent_get_Event_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPIObjectEvent_get_Address_Proxy(ITTAPIObjectEvent * This,ITAddress **ppAddress);
void __RPC_STUB ITTAPIObjectEvent_get_Address_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTAPIObjectEvent_get_CallbackInstance_Proxy(ITTAPIObjectEvent * This,long *plCallbackInstance);
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITTAPIObjectEvent2_get_Phone_Proxy(ITTAPIObjectEvent2 * This,ITPhone **ppPhone);
...
EXTERN_C const IID IID_ITTAPIEventNotification;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE Event(TAPI_EVENT TapiEvent,IDispatch *pEvent)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITTAPIEventNotification_Event_Proxy(ITTAPIEventNotification * This,TAPI_EVENT TapiEvent,IDispatch *pEvent);
...
EXTERN_C const IID IID_ITCallHubEvent;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Event(CALLHUB_EVENT *pEvent)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CallHub(ITCallHub **ppCallHub)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Call(ITCallInfo **ppCall)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITCallHubEvent_get_Event_Proxy(ITCallHubEvent * This,CALLHUB_EVENT *pEvent);
void __RPC_STUB ITCallHubEvent_get_Event_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallHubEvent_get_CallHub_Proxy(ITCallHubEvent * This,ITCallHub **ppCallHub);
void __RPC_STUB ITCallHubEvent_get_CallHub_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallHubEvent_get_Call_Proxy(ITCallHubEvent * This,ITCallInfo **ppCall);
...
EXTERN_C const IID IID_ITAddressEvent;
	...
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Address(ITAddress **ppAddress)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Event(ADDRESS_EVENT *pEvent)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Terminal(ITTerminal **ppTerminal)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITAddressEvent_get_Address_Proxy(ITAddressEvent * This,ITAddress **ppAddress);
void __RPC_STUB ITAddressEvent_get_Address_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressEvent_get_Event_Proxy(ITAddressEvent * This,ADDRESS_EVENT *pEvent);
void __RPC_STUB ITAddressEvent_get_Event_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressEvent_get_Terminal_Proxy(ITAddressEvent * This,ITTerminal **ppTerminal);
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITAddressDeviceSpecificEvent_get_Address_Proxy(ITAddressDeviceSpecificEvent * This,ITAddress **ppAddress);
void __RPC_STUB ITAddressDeviceSpecificEvent_get_Address_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressDeviceSpecificEvent_get_Call_Proxy(ITAddressDeviceSpecificEvent * This,ITCallInfo **ppCall);
void __RPC_STUB ITAddressDeviceSpecificEvent_get_Call_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressDeviceSpecificEvent_get_lParam1_Proxy(ITAddressDeviceSpecificEvent * This,long *pParam1);
void __RPC_STUB ITAddressDeviceSpecificEvent_get_lParam1_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressDeviceSpecificEvent_get_lParam2_Proxy(ITAddressDeviceSpecificEvent * This,long *pParam2);
void __RPC_STUB ITAddressDeviceSpecificEvent_get_lParam2_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressDeviceSpecificEvent_get_lParam3_Proxy(ITAddressDeviceSpecificEvent * This,long *pParam3);
...
EXTERN_C const IID IID_ITFileTerminalEvent;
	...
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Terminal(ITTerminal **ppTerminal)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Track(ITFileTrack **ppTrackTerminal)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Call(ITCallInfo **ppCall)=0;
		virtual HRESULT STDMETHODCALLTYPE get_State(TERMINAL_MEDIA_STATE *pState)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Cause(FT_STATE_EVENT_CAUSE *pCause)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Error(HRESULT *phrErrorCode)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITFileTerminalEvent_get_Terminal_Proxy(ITFileTerminalEvent * This,ITTerminal **ppTerminal);
void __RPC_STUB ITFileTerminalEvent_get_Terminal_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITFileTerminalEvent_get_Track_Proxy(ITFileTerminalEvent * This,ITFileTrack **ppTrackTerminal);
void __RPC_STUB ITFileTerminalEvent_get_Track_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITFileTerminalEvent_get_Call_Proxy(ITFileTerminalEvent * This,ITCallInfo **ppCall);
void __RPC_STUB ITFileTerminalEvent_get_Call_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITFileTerminalEvent_get_State_Proxy(ITFileTerminalEvent * This,TERMINAL_MEDIA_STATE *pState);
void __RPC_STUB ITFileTerminalEvent_get_State_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITFileTerminalEvent_get_Cause_Proxy(ITFileTerminalEvent * This,FT_STATE_EVENT_CAUSE *pCause);
void __RPC_STUB ITFileTerminalEvent_get_Cause_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITFileTerminalEvent_get_Error_Proxy(ITFileTerminalEvent * This,HRESULT *phrErrorCode);
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITTTSTerminalEvent_get_Terminal_Proxy(ITTTSTerminalEvent * This,ITTerminal **ppTerminal);
void __RPC_STUB ITTTSTerminalEvent_get_Terminal_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTTSTerminalEvent_get_Call_Proxy(ITTTSTerminalEvent * This,ITCallInfo **ppCall);
void __RPC_STUB ITTTSTerminalEvent_get_Call_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITTTSTerminalEvent_get_Error_Proxy(ITTTSTerminalEvent * This,HRESULT *phrErrorCode);
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITASRTerminalEvent_get_Terminal_Proxy(ITASRTerminalEvent * This,ITTerminal **ppTerminal);
void __RPC_STUB ITASRTerminalEvent_get_Terminal_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITASRTerminalEvent_get_Call_Proxy(ITASRTerminalEvent * This,ITCallInfo **ppCall);
void __RPC_STUB ITASRTerminalEvent_get_Call_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITASRTerminalEvent_get_Error_Proxy(ITASRTerminalEvent * This,HRESULT *phrErrorCode);
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITToneTerminalEvent_get_Terminal_Proxy(ITToneTerminalEvent * This,ITTerminal **ppTerminal);
void __RPC_STUB ITToneTerminalEvent_get_Terminal_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITToneTerminalEvent_get_Call_Proxy(ITToneTerminalEvent * This,ITCallInfo **ppCall);
void __RPC_STUB ITToneTerminalEvent_get_Call_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITToneTerminalEvent_get_Error_Proxy(ITToneTerminalEvent * This,HRESULT *phrErrorCode);
...
EXTERN_C const IID IID_ITQOSEvent;
	...
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Call(ITCallInfo **ppCall)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Event(QOS_EVENT *pQosEvent)=0;
		virtual HRESULT STDMETHODCALLTYPE get_MediaType(long *plMediaType)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITQOSEvent_get_Call_Proxy(ITQOSEvent * This,ITCallInfo **ppCall);
void __RPC_STUB ITQOSEvent_get_Call_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITQOSEvent_get_Event_Proxy(ITQOSEvent * This,QOS_EVENT *pQosEvent);
void __RPC_STUB ITQOSEvent_get_Event_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITQOSEvent_get_MediaType_Proxy(ITQOSEvent * This,long *plMediaType);
...
EXTERN_C const IID IID_ITCallInfoChangeEvent;
	...
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Call(ITCallInfo **ppCall)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Cause(CALLINFOCHANGE_CAUSE *pCIC)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CallbackInstance(long *plCallbackInstance)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITCallInfoChangeEvent_get_Call_Proxy(ITCallInfoChangeEvent * This,ITCallInfo **ppCall);
void __RPC_STUB ITCallInfoChangeEvent_get_Call_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallInfoChangeEvent_get_Cause_Proxy(ITCallInfoChangeEvent * This,CALLINFOCHANGE_CAUSE *pCIC);
void __RPC_STUB ITCallInfoChangeEvent_get_Cause_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallInfoChangeEvent_get_CallbackInstance_Proxy(ITCallInfoChangeEvent * This,long *plCallbackInstance);
...
EXTERN_C const IID IID_ITRequest;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE MakeCall(BSTR pDestAddress,BSTR pAppName,BSTR pCalledParty,BSTR pComment)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITRequest_MakeCall_Proxy(ITRequest * This,BSTR pDestAddress,BSTR pAppName,BSTR pCalledParty,BSTR pComment);
...
EXTERN_C const IID IID_ITRequestEvent;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_RegistrationInstance(long *plRegistrationInstance)=0;
		virtual HRESULT STDMETHODCALLTYPE get_RequestMode(long *plRequestMode)=0;
		virtual HRESULT STDMETHODCALLTYPE get_DestAddress(BSTR *ppDestAddress)=0;
		virtual HRESULT STDMETHODCALLTYPE get_AppName(BSTR *ppAppName)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CalledParty(BSTR *ppCalledParty)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Comment(BSTR *ppComment)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITRequestEvent_get_RegistrationInstance_Proxy(ITRequestEvent * This,long *plRegistrationInstance);
void __RPC_STUB ITRequestEvent_get_RegistrationInstance_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITRequestEvent_get_RequestMode_Proxy(ITRequestEvent * This,long *plRequestMode);
void __RPC_STUB ITRequestEvent_get_RequestMode_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITRequestEvent_get_DestAddress_Proxy(ITRequestEvent * This,BSTR *ppDestAddress);
void __RPC_STUB ITRequestEvent_get_DestAddress_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITRequestEvent_get_AppName_Proxy(ITRequestEvent * This,BSTR *ppAppName);
void __RPC_STUB ITRequestEvent_get_AppName_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITRequestEvent_get_CalledParty_Proxy(ITRequestEvent * This,BSTR *ppCalledParty);
void __RPC_STUB ITRequestEvent_get_CalledParty_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITRequestEvent_get_Comment_Proxy(ITRequestEvent * This,BSTR *ppComment);
...
EXTERN_C const IID IID_ITCollection;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Count(long *lCount)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Item(long Index,VARIANT *pVariant)=0;
		virtual HRESULT STDMETHODCALLTYPE get__NewEnum(IUnknown **ppNewEnum)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITCollection_get_Count_Proxy(ITCollection * This,long *lCount);
void __RPC_STUB ITCollection_get_Count_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCollection_get_Item_Proxy(ITCollection * This,long Index,VARIANT *pVariant);
void __RPC_STUB ITCollection_get_Item_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCollection_get__NewEnum_Proxy(ITCollection * This,IUnknown **ppNewEnum);
...
EXTERN_C const IID IID_ITCollection2;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE Add(long Index,VARIANT *pVariant)=0;
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITCollection2_Add_Proxy(ITCollection2 * This,long Index,VARIANT *pVariant);
void __RPC_STUB ITCollection2_Add_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCollection2_Remove_Proxy(ITCollection2 * This,long Index);
...
EXTERN_C const IID IID_ITForwardInformation;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE put_NumRingsNoAnswer(long lNumRings)=0;
		virtual HRESULT STDMETHODCALLTYPE get_NumRingsNoAnswer(long *plNumRings)=0;
		virtual HRESULT STDMETHODCALLTYPE SetForwardType(long ForwardType,BSTR pDestAddress,BSTR pCallerAddress)=0;
		virtual HRESULT STDMETHODCALLTYPE get_ForwardTypeDestination(long ForwardType,BSTR *ppDestAddress)=0;
		virtual HRESULT STDMETHODCALLTYPE get_ForwardTypeCaller(long Forwardtype,BSTR *ppCallerAddress)=0;
		virtual HRESULT STDMETHODCALLTYPE GetForwardType(long ForwardType,BSTR *ppDestinationAddress,BSTR *ppCallerAddress)=0;
		virtual HRESULT STDMETHODCALLTYPE Clear(void)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITForwardInformation_put_NumRingsNoAnswer_Proxy(ITForwardInformation * This,long lNumRings);
void __RPC_STUB ITForwardInformation_put_NumRingsNoAnswer_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITForwardInformation_get_NumRingsNoAnswer_Proxy(ITForwardInformation * This,long *plNumRings);
void __RPC_STUB ITForwardInformation_get_NumRingsNoAnswer_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITForwardInformation_SetForwardType_Proxy(ITForwardInformation * This,long ForwardType,BSTR pDestAddress,BSTR pCallerAddress);
void __RPC_STUB ITForwardInformation_SetForwardType_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITForwardInformation_get_ForwardTypeDestination_Proxy(ITForwardInformation * This,long ForwardType,BSTR *ppDestAddress);
void __RPC_STUB ITForwardInformation_get_ForwardTypeDestination_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITForwardInformation_get_ForwardTypeCaller_Proxy(ITForwardInformation * This,long Forwardtype,BSTR *ppCallerAddress);
void __RPC_STUB ITForwardInformation_get_ForwardTypeCaller_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITForwardInformation_GetForwardType_Proxy(ITForwardInformation * This,long ForwardType,BSTR *ppDestinationAddress,BSTR *ppCallerAddress);
void __RPC_STUB ITForwardInformation_GetForwardType_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITForwardInformation_Clear_Proxy(ITForwardInformation * This);
...
EXTERN_C const IID IID_ITForwardInformation2;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE SetForwardType2(long ForwardType,BSTR pDestAddress,long DestAddressType,BSTR pCallerAddress,long CallerAddressType)=0;
		virtual HRESULT STDMETHODCALLTYPE GetForwardType2(long ForwardType,BSTR *ppDestinationAddress,long *pDestAddressType,BSTR *ppCallerAddress,long *pCallerAddressType)=0;
		virtual HRESULT STDMETHODCALLTYPE get_ForwardTypeDestinationAddressType(long ForwardType,long *pDestAddressType)=0;
		virtual HRESULT STDMETHODCALLTYPE get_ForwardTypeCallerAddressType(long Forwardtype,long *pCallerAddressType)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITForwardInformation2_SetForwardType2_Proxy(ITForwardInformation2 * This,long ForwardType,BSTR pDestAddress,long DestAddressType,BSTR pCallerAddress,long CallerAddressType);
void __RPC_STUB ITForwardInformation2_SetForwardType2_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITForwardInformation2_GetForwardType2_Proxy(ITForwardInformation2 * This,long ForwardType,BSTR *ppDestinationAddress,long *pDestAddressType,BSTR *ppCallerAddress,long *pCallerAddressType);
void __RPC_STUB ITForwardInformation2_GetForwardType2_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITForwardInformation2_get_ForwardTypeDestinationAddressType_Proxy(ITForwardInformation2 * This,long ForwardType,long *pDestAddressType);
void __RPC_STUB ITForwardInformation2_get_ForwardTypeDestinationAddressType_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITForwardInformation2_get_ForwardTypeCallerAddressType_Proxy(ITForwardInformation2 * This,long Forwardtype,long *pCallerAddressType);
...
EXTERN_C const IID IID_ITAddressTranslation;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE TranslateAddress(BSTR pAddressToTranslate,long lCard,long lTranslateOptions,ITAddressTranslationInfo **ppTranslated)=0;
		virtual HRESULT STDMETHODCALLTYPE TranslateDialog(TAPIHWND hwndOwner,BSTR pAddressIn)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateLocations(IEnumLocation **ppEnumLocation)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Locations(VARIANT *pVariant)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateCallingCards(IEnumCallingCard **ppEnumCallingCard)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CallingCards(VARIANT *pVariant)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITAddressTranslation_TranslateAddress_Proxy(ITAddressTranslation * This,BSTR pAddressToTranslate,long lCard,long lTranslateOptions,ITAddressTranslationInfo **ppTranslated);
void __RPC_STUB ITAddressTranslation_TranslateAddress_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressTranslation_TranslateDialog_Proxy(ITAddressTranslation * This,TAPIHWND hwndOwner,BSTR pAddressIn);
void __RPC_STUB ITAddressTranslation_TranslateDialog_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressTranslation_EnumerateLocations_Proxy(ITAddressTranslation * This,IEnumLocation **ppEnumLocation);
void __RPC_STUB ITAddressTranslation_EnumerateLocations_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressTranslation_get_Locations_Proxy(ITAddressTranslation * This,VARIANT *pVariant);
void __RPC_STUB ITAddressTranslation_get_Locations_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressTranslation_EnumerateCallingCards_Proxy(ITAddressTranslation * This,IEnumCallingCard **ppEnumCallingCard);
void __RPC_STUB ITAddressTranslation_EnumerateCallingCards_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressTranslation_get_CallingCards_Proxy(ITAddressTranslation * This,VARIANT *pVariant);
...
EXTERN_C const IID IID_ITAddressTranslationInfo;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_DialableString(BSTR *ppDialableString)=0;
		virtual HRESULT STDMETHODCALLTYPE get_DisplayableString(BSTR *ppDisplayableString)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CurrentCountryCode(long *CountryCode)=0;
		virtual HRESULT STDMETHODCALLTYPE get_DestinationCountryCode(long *CountryCode)=0;
		virtual HRESULT STDMETHODCALLTYPE get_TranslationResults(long *plResults)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITAddressTranslationInfo_get_DialableString_Proxy(ITAddressTranslationInfo * This,BSTR *ppDialableString);
void __RPC_STUB ITAddressTranslationInfo_get_DialableString_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressTranslationInfo_get_DisplayableString_Proxy(ITAddressTranslationInfo * This,BSTR *ppDisplayableString);
void __RPC_STUB ITAddressTranslationInfo_get_DisplayableString_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressTranslationInfo_get_CurrentCountryCode_Proxy(ITAddressTranslationInfo * This,long *CountryCode);
void __RPC_STUB ITAddressTranslationInfo_get_CurrentCountryCode_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressTranslationInfo_get_DestinationCountryCode_Proxy(ITAddressTranslationInfo * This,long *CountryCode);
void __RPC_STUB ITAddressTranslationInfo_get_DestinationCountryCode_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITAddressTranslationInfo_get_TranslationResults_Proxy(ITAddressTranslationInfo * This,long *plResults);
...
EXTERN_C const IID IID_ITLocationInfo;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_PermanentLocationID(long *plLocationID)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CountryCode(long *plCountryCode)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CountryID(long *plCountryID)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Options(long *plOptions)=0;
		virtual HRESULT STDMETHODCALLTYPE get_PreferredCardID(long *plCardID)=0;
		virtual HRESULT STDMETHODCALLTYPE get_LocationName(BSTR *ppLocationName)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CityCode(BSTR *ppCode)=0;
		virtual HRESULT STDMETHODCALLTYPE get_LocalAccessCode(BSTR *ppCode)=0;
		virtual HRESULT STDMETHODCALLTYPE get_LongDistanceAccessCode(BSTR *ppCode)=0;
		virtual HRESULT STDMETHODCALLTYPE get_TollPrefixList(BSTR *ppTollList)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CancelCallWaitingCode(BSTR *ppCode)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITLocationInfo_get_PermanentLocationID_Proxy(ITLocationInfo * This,long *plLocationID);
void __RPC_STUB ITLocationInfo_get_PermanentLocationID_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLocationInfo_get_CountryCode_Proxy(ITLocationInfo * This,long *plCountryCode);
void __RPC_STUB ITLocationInfo_get_CountryCode_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLocationInfo_get_CountryID_Proxy(ITLocationInfo * This,long *plCountryID);
void __RPC_STUB ITLocationInfo_get_CountryID_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLocationInfo_get_Options_Proxy(ITLocationInfo * This,long *plOptions);
void __RPC_STUB ITLocationInfo_get_Options_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLocationInfo_get_PreferredCardID_Proxy(ITLocationInfo * This,long *plCardID);
void __RPC_STUB ITLocationInfo_get_PreferredCardID_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLocationInfo_get_LocationName_Proxy(ITLocationInfo * This,BSTR *ppLocationName);
void __RPC_STUB ITLocationInfo_get_LocationName_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLocationInfo_get_CityCode_Proxy(ITLocationInfo * This,BSTR *ppCode);
void __RPC_STUB ITLocationInfo_get_CityCode_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLocationInfo_get_LocalAccessCode_Proxy(ITLocationInfo * This,BSTR *ppCode);
void __RPC_STUB ITLocationInfo_get_LocalAccessCode_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLocationInfo_get_LongDistanceAccessCode_Proxy(ITLocationInfo * This,BSTR *ppCode);
void __RPC_STUB ITLocationInfo_get_LongDistanceAccessCode_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLocationInfo_get_TollPrefixList_Proxy(ITLocationInfo * This,BSTR *ppTollList);
void __RPC_STUB ITLocationInfo_get_TollPrefixList_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITLocationInfo_get_CancelCallWaitingCode_Proxy(ITLocationInfo * This,BSTR *ppCode);
...
EXTERN_C const IID IID_IEnumLocation;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt,ITLocationInfo **ppElements,ULONG *pceltFetched)=0;
		virtual HRESULT STDMETHODCALLTYPE Reset(void)=0;
		virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt)=0;
		virtual HRESULT STDMETHODCALLTYPE Clone(IEnumLocation **ppEnum)=0;
	};
#else 	
...
#endif 
#endif 	
HRESULT STDMETHODCALLTYPE IEnumLocation_Next_Proxy(IEnumLocation * This,ULONG celt,ITLocationInfo **ppElements,ULONG *pceltFetched);
...
HRESULT STDMETHODCALLTYPE IEnumLocation_Reset_Proxy(IEnumLocation * This);
...
HRESULT STDMETHODCALLTYPE IEnumLocation_Skip_Proxy(IEnumLocation * This,ULONG celt);
...
HRESULT STDMETHODCALLTYPE IEnumLocation_Clone_Proxy(IEnumLocation * This,IEnumLocation **ppEnum);
...
EXTERN_C const IID IID_ITCallingCard;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_PermanentCardID(long *plCardID)=0;
		virtual HRESULT STDMETHODCALLTYPE get_NumberOfDigits(long *plDigits)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Options(long *plOptions)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CardName(BSTR *ppCardName)=0;
		virtual HRESULT STDMETHODCALLTYPE get_SameAreaDialingRule(BSTR *ppRule)=0;
		virtual HRESULT STDMETHODCALLTYPE get_LongDistanceDialingRule(BSTR *ppRule)=0;
		virtual HRESULT STDMETHODCALLTYPE get_InternationalDialingRule(BSTR *ppRule)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITCallingCard_get_PermanentCardID_Proxy(ITCallingCard * This,long *plCardID);
void __RPC_STUB ITCallingCard_get_PermanentCardID_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallingCard_get_NumberOfDigits_Proxy(ITCallingCard * This,long *plDigits);
void __RPC_STUB ITCallingCard_get_NumberOfDigits_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallingCard_get_Options_Proxy(ITCallingCard * This,long *plOptions);
void __RPC_STUB ITCallingCard_get_Options_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallingCard_get_CardName_Proxy(ITCallingCard * This,BSTR *ppCardName);
void __RPC_STUB ITCallingCard_get_CardName_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallingCard_get_SameAreaDialingRule_Proxy(ITCallingCard * This,BSTR *ppRule);
void __RPC_STUB ITCallingCard_get_SameAreaDialingRule_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallingCard_get_LongDistanceDialingRule_Proxy(ITCallingCard * This,BSTR *ppRule);
void __RPC_STUB ITCallingCard_get_LongDistanceDialingRule_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallingCard_get_InternationalDialingRule_Proxy(ITCallingCard * This,BSTR *ppRule);
...
EXTERN_C const IID IID_IEnumCallingCard;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt,ITCallingCard **ppElements,ULONG *pceltFetched)=0;
		virtual HRESULT STDMETHODCALLTYPE Reset(void)=0;
		virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt)=0;
		virtual HRESULT STDMETHODCALLTYPE Clone(IEnumCallingCard **ppEnum)=0;
	};
#else 	
...
#endif 
#endif 	
HRESULT STDMETHODCALLTYPE IEnumCallingCard_Next_Proxy(IEnumCallingCard * This,ULONG celt,ITCallingCard **ppElements,ULONG *pceltFetched);
...
HRESULT STDMETHODCALLTYPE IEnumCallingCard_Reset_Proxy(IEnumCallingCard * This);
...
HRESULT STDMETHODCALLTYPE IEnumCallingCard_Skip_Proxy(IEnumCallingCard * This,ULONG celt);
...
HRESULT STDMETHODCALLTYPE IEnumCallingCard_Clone_Proxy(IEnumCallingCard * This,IEnumCallingCard **ppEnum);
...
EXTERN_C const IID IID_ITCallNotificationEvent;
	...
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Call(ITCallInfo **ppCall)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Event(CALL_NOTIFICATION_EVENT *pCallNotificationEvent)=0;
		virtual HRESULT STDMETHODCALLTYPE get_CallbackInstance(long *plCallbackInstance)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITCallNotificationEvent_get_Call_Proxy(ITCallNotificationEvent * This,ITCallInfo **ppCall);
void __RPC_STUB ITCallNotificationEvent_get_Call_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallNotificationEvent_get_Event_Proxy(ITCallNotificationEvent * This,CALL_NOTIFICATION_EVENT *pCallNotificationEvent);
void __RPC_STUB ITCallNotificationEvent_get_Event_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITCallNotificationEvent_get_CallbackInstance_Proxy(ITCallNotificationEvent * This,long *plCallbackInstance);
...
EXTERN_C const IID IID_ITDispatchMapper;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE QueryDispatchInterface(BSTR pIID,IDispatch *pInterfaceToMap,IDispatch **ppReturnedInterface)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITDispatchMapper_QueryDispatchInterface_Proxy(ITDispatchMapper * This,BSTR pIID,IDispatch *pInterfaceToMap,IDispatch **ppReturnedInterface);
...
EXTERN_C const IID IID_ITStreamControl;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE CreateStream(long lMediaType,TERMINAL_DIRECTION td,ITStream **ppStream)=0;
		virtual HRESULT STDMETHODCALLTYPE RemoveStream(ITStream *pStream)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateStreams(IEnumStream **ppEnumStream)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Streams(VARIANT *pVariant)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITStreamControl_CreateStream_Proxy(ITStreamControl * This,long lMediaType,TERMINAL_DIRECTION td,ITStream **ppStream);
void __RPC_STUB ITStreamControl_CreateStream_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITStreamControl_RemoveStream_Proxy(ITStreamControl * This,ITStream *pStream);
void __RPC_STUB ITStreamControl_RemoveStream_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITStreamControl_EnumerateStreams_Proxy(ITStreamControl * This,IEnumStream **ppEnumStream);
void __RPC_STUB ITStreamControl_EnumerateStreams_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITStreamControl_get_Streams_Proxy(ITStreamControl * This,VARIANT *pVariant);
...
EXTERN_C const IID IID_ITStream;
	...
	public:
		virtual HRESULT STDMETHODCALLTYPE get_MediaType(long *plMediaType)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Direction(TERMINAL_DIRECTION *pTD)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Name(BSTR *ppName)=0;
		virtual HRESULT STDMETHODCALLTYPE StartStream(void)=0;
		virtual HRESULT STDMETHODCALLTYPE PauseStream(void)=0;
		virtual HRESULT STDMETHODCALLTYPE StopStream(void)=0;
		virtual HRESULT STDMETHODCALLTYPE SelectTerminal(ITTerminal *pTerminal)=0;
		virtual HRESULT STDMETHODCALLTYPE UnselectTerminal(ITTerminal *pTerminal)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateTerminals(IEnumTerminal **ppEnumTerminal)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Terminals(VARIANT *pTerminals)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITStream_get_MediaType_Proxy(ITStream * This,long *plMediaType);
void __RPC_STUB ITStream_get_MediaType_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITStream_get_Direction_Proxy(ITStream * This,TERMINAL_DIRECTION *pTD);
void __RPC_STUB ITStream_get_Direction_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITStream_get_Name_Proxy(ITStream * This,BSTR *ppName);
void __RPC_STUB ITStream_get_Name_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITStream_StartStream_Proxy(ITStream * This);
void __RPC_STUB ITStream_StartStream_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITStream_PauseStream_Proxy(ITStream * This);
void __RPC_STUB ITStream_PauseStream_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITStream_StopStream_Proxy(ITStream * This);
void __RPC_STUB ITStream_StopStream_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITStream_SelectTerminal_Proxy(ITStream * This,ITTerminal *pTerminal);
void __RPC_STUB ITStream_SelectTerminal_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITStream_UnselectTerminal_Proxy(ITStream * This,ITTerminal *pTerminal);
void __RPC_STUB ITStream_UnselectTerminal_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITStream_EnumerateTerminals_Proxy(ITStream * This,IEnumTerminal **ppEnumTerminal);
void __RPC_STUB ITStream_EnumerateTerminals_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITStream_get_Terminals_Proxy(ITStream * This,VARIANT *pTerminals);
...
EXTERN_C const IID IID_IEnumStream;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt,ITStream **ppElements,ULONG *pceltFetched)=0;
		virtual HRESULT STDMETHODCALLTYPE Reset(void)=0;
		virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt)=0;
		virtual HRESULT STDMETHODCALLTYPE Clone(IEnumStream **ppEnum)=0;
	};
#else 	
...
#endif 
#endif 	
HRESULT STDMETHODCALLTYPE IEnumStream_Next_Proxy(IEnumStream * This,ULONG celt,ITStream **ppElements,ULONG *pceltFetched);
...
HRESULT STDMETHODCALLTYPE IEnumStream_Reset_Proxy(IEnumStream * This);
...
HRESULT STDMETHODCALLTYPE IEnumStream_Skip_Proxy(IEnumStream * This,ULONG celt);
...
HRESULT STDMETHODCALLTYPE IEnumStream_Clone_Proxy(IEnumStream * This,IEnumStream **ppEnum);
...
EXTERN_C const IID IID_ITSubStreamControl;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE CreateSubStream(ITSubStream **ppSubStream)=0;
		virtual HRESULT STDMETHODCALLTYPE RemoveSubStream(ITSubStream *pSubStream)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateSubStreams(IEnumSubStream **ppEnumSubStream)=0;
		virtual HRESULT STDMETHODCALLTYPE get_SubStreams(VARIANT *pVariant)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITSubStreamControl_CreateSubStream_Proxy(ITSubStreamControl * This,ITSubStream **ppSubStream);
void __RPC_STUB ITSubStreamControl_CreateSubStream_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITSubStreamControl_RemoveSubStream_Proxy(ITSubStreamControl * This,ITSubStream *pSubStream);
void __RPC_STUB ITSubStreamControl_RemoveSubStream_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITSubStreamControl_EnumerateSubStreams_Proxy(ITSubStreamControl * This,IEnumSubStream **ppEnumSubStream);
void __RPC_STUB ITSubStreamControl_EnumerateSubStreams_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITSubStreamControl_get_SubStreams_Proxy(ITSubStreamControl * This,VARIANT *pVariant);
...
EXTERN_C const IID IID_ITSubStream;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE StartSubStream(void)=0;
		virtual HRESULT STDMETHODCALLTYPE PauseSubStream(void)=0;
		virtual HRESULT STDMETHODCALLTYPE StopSubStream(void)=0;
		virtual HRESULT STDMETHODCALLTYPE SelectTerminal(ITTerminal *pTerminal)=0;
		virtual HRESULT STDMETHODCALLTYPE UnselectTerminal(ITTerminal *pTerminal)=0;
		virtual HRESULT STDMETHODCALLTYPE EnumerateTerminals(IEnumTerminal **ppEnumTerminal)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Terminals(VARIANT *pTerminals)=0;
		virtual HRESULT STDMETHODCALLTYPE get_Stream(ITStream **ppITStream)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITSubStream_StartSubStream_Proxy(ITSubStream * This);
void __RPC_STUB ITSubStream_StartSubStream_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITSubStream_PauseSubStream_Proxy(ITSubStream * This);
void __RPC_STUB ITSubStream_PauseSubStream_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITSubStream_StopSubStream_Proxy(ITSubStream * This);
void __RPC_STUB ITSubStream_StopSubStream_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITSubStream_SelectTerminal_Proxy(ITSubStream * This,ITTerminal *pTerminal);
void __RPC_STUB ITSubStream_SelectTerminal_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITSubStream_UnselectTerminal_Proxy(ITSubStream * This,ITTerminal *pTerminal);
void __RPC_STUB ITSubStream_UnselectTerminal_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITSubStream_EnumerateTerminals_Proxy(ITSubStream * This,IEnumTerminal **ppEnumTerminal);
void __RPC_STUB ITSubStream_EnumerateTerminals_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITSubStream_get_Terminals_Proxy(ITSubStream * This,VARIANT *pTerminals);
void __RPC_STUB ITSubStream_get_Terminals_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITSubStream_get_Stream_Proxy(ITSubStream * This,ITStream **ppITStream);
...
EXTERN_C const IID IID_IEnumSubStream;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE Next(ULONG celt,ITSubStream **ppElements,ULONG *pceltFetched)=0;
		virtual HRESULT STDMETHODCALLTYPE Reset(void)=0;
		virtual HRESULT STDMETHODCALLTYPE Skip(ULONG celt)=0;
		virtual HRESULT STDMETHODCALLTYPE Clone(IEnumSubStream **ppEnum)=0;
	};
#else 	
...
#endif 
#endif 	
HRESULT STDMETHODCALLTYPE IEnumSubStream_Next_Proxy(IEnumSubStream * This,ULONG celt,ITSubStream **ppElements,ULONG *pceltFetched);
...
HRESULT STDMETHODCALLTYPE IEnumSubStream_Reset_Proxy(IEnumSubStream * This);
...
HRESULT STDMETHODCALLTYPE IEnumSubStream_Skip_Proxy(IEnumSubStream * This,ULONG celt);
...
HRESULT STDMETHODCALLTYPE IEnumSubStream_Clone_Proxy(IEnumSubStream * This,IEnumSubStream **ppEnum);
...
#endif 	
HRESULT STDMETHODCALLTYPE ITLegacyWaveSupport_IsFullDuplex_Proxy(ITLegacyWaveSupport * This,FULLDUPLEX_SUPPORT *pSupport);
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITBasicCallControl2_RequestTerminal_Proxy(ITBasicCallControl2 * This,BSTR bstrTerminalClassGUID,long lMediaType,TERMINAL_DIRECTION Direction,ITTerminal **ppTerminal);
void __RPC_STUB ITBasicCallControl2_RequestTerminal_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl2_SelectTerminalOnCall_Proxy(ITBasicCallControl2 * This,ITTerminal *pTerminal);
void __RPC_STUB ITBasicCallControl2_SelectTerminalOnCall_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITBasicCallControl2_UnselectTerminalOnCall_Proxy(ITBasicCallControl2 * This,ITTerminal *pTerminal);
...
EXTERN_C const IID IID_ITScriptableAudioFormat;
	...
	{
	public:
		virtual HRESULT STDMETHODCALLTYPE get_Channels(long *pVal)=0;
		virtual HRESULT STDMETHODCALLTYPE put_Channels(const long nNewVal)=0;
		virtual HRESULT STDMETHODCALLTYPE get_SamplesPerSec(long *pVal)=0;
		virtual HRESULT STDMETHODCALLTYPE put_SamplesPerSec(const long nNewVal)=0;
		virtual HRESULT STDMETHODCALLTYPE get_AvgBytesPerSec(long *pVal)=0;
		virtual HRESULT STDMETHODCALLTYPE put_AvgBytesPerSec(const long nNewVal)=0;
		virtual HRESULT STDMETHODCALLTYPE get_BlockAlign(long *pVal)=0;
		virtual HRESULT STDMETHODCALLTYPE put_BlockAlign(const long nNewVal)=0;
		virtual HRESULT STDMETHODCALLTYPE get_BitsPerSample(long *pVal)=0;
		virtual HRESULT STDMETHODCALLTYPE put_BitsPerSample(const long nNewVal)=0;
		virtual HRESULT STDMETHODCALLTYPE get_FormatTag(long *pVal)=0;
		virtual HRESULT STDMETHODCALLTYPE put_FormatTag(const long nNewVal)=0;
	};
#else 	
...
#endif 
#endif 	
 HRESULT STDMETHODCALLTYPE ITScriptableAudioFormat_get_Channels_Proxy(ITScriptableAudioFormat * This,long *pVal);
void __RPC_STUB ITScriptableAudioFormat_get_Channels_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITScriptableAudioFormat_put_Channels_Proxy(ITScriptableAudioFormat * This,const long nNewVal);
void __RPC_STUB ITScriptableAudioFormat_put_Channels_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITScriptableAudioFormat_get_SamplesPerSec_Proxy(ITScriptableAudioFormat * This,long *pVal);
void __RPC_STUB ITScriptableAudioFormat_get_SamplesPerSec_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITScriptableAudioFormat_put_SamplesPerSec_Proxy(ITScriptableAudioFormat * This,const long nNewVal);
void __RPC_STUB ITScriptableAudioFormat_put_SamplesPerSec_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITScriptableAudioFormat_get_AvgBytesPerSec_Proxy(ITScriptableAudioFormat * This,long *pVal);
void __RPC_STUB ITScriptableAudioFormat_get_AvgBytesPerSec_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITScriptableAudioFormat_put_AvgBytesPerSec_Proxy(ITScriptableAudioFormat * This,const long nNewVal);
void __RPC_STUB ITScriptableAudioFormat_put_AvgBytesPerSec_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITScriptableAudioFormat_get_BlockAlign_Proxy(ITScriptableAudioFormat * This,long *pVal);
void __RPC_STUB ITScriptableAudioFormat_get_BlockAlign_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITScriptableAudioFormat_put_BlockAlign_Proxy(ITScriptableAudioFormat * This,const long nNewVal);
void __RPC_STUB ITScriptableAudioFormat_put_BlockAlign_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITScriptableAudioFormat_get_BitsPerSample_Proxy(ITScriptableAudioFormat * This,long *pVal);
void __RPC_STUB ITScriptableAudioFormat_get_BitsPerSample_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITScriptableAudioFormat_put_BitsPerSample_Proxy(ITScriptableAudioFormat * This,const long nNewVal);
void __RPC_STUB ITScriptableAudioFormat_put_BitsPerSample_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITScriptableAudioFormat_get_FormatTag_Proxy(ITScriptableAudioFormat * This,long *pVal);
void __RPC_STUB ITScriptableAudioFormat_get_FormatTag_Stub(IRpcStubBuffer *This,IRpcChannelBuffer *_pRpcChannelBuffer,PRPC_MESSAGE _pRpcMessage,DWORD *_pdwStubPhase);
 HRESULT STDMETHODCALLTYPE ITScriptableAudioFormat_put_FormatTag_Proxy(ITScriptableAudioFormat * This,const long nNewVal);
