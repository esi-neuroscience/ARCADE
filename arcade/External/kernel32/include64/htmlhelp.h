...
#define HH_SET_WIN_TYPE 4
#define HH_GET_WIN_TYPE 5
#define HH_GET_WIN_HANDLE 6
#define HH_ENUM_INFO_TYPE 7
#define HH_SET_INFO_TYPE 8
#define HH_SYNC 9
#define HH_RESERVED1 0xA
#define HH_RESERVED2 0xB
#define HH_RESERVED3 0xC
...
typedef struct tagHH_POPUP { int cbStruct; HINSTANCE hinst;
	UINT idString; LPCTSTR pszText; POINT pt; COLORREF clrForeground;
	COLORREF clrBackground; RECT rcMargins; LPCTSTR pszFont;
} HH_POPUP;
typedef struct tagHH_AKLINK { int cbStruct; BOOL fReserved;
	LPCTSTR pszKeywords;
	LPCTSTR pszUrl;
	LPCTSTR pszMsgText;
	LPCTSTR pszMsgTitle;
...
enum { HHWIN_NAVTYPE_TOC, HHWIN_NAVTYPE_INDEX, HHWIN_NAVTYPE_SEARCH,
	HHWIN_NAVTYPE_FAVORITES, HHWIN_NAVTYPE_HISTORY, HHWIN_NAVTYPE_AUTHOR,
	HHWIN_NAVTYPE_CUSTOM_FIRST = 11
};

enum { IT_INCLUSIVE, IT_EXCLUSIVE, IT_HIDDEN, };
typedef struct tagHH_ENUM_IT { int cbStruct; int iType; LPCSTR pszCatName;
	LPCSTR pszITName; LPCSTR pszITDescription; } HH_ENUM_IT, *PHH_ENUM_IT;
...
enum { HH_TAB_CONTENTS, HH_TAB_INDEX, HH_TAB_SEARCH, HH_TAB_FAVORITES,
	HH_TAB_HISTORY, HH_TAB_AUTHOR, HH_TAB_CUSTOM_FIRST = 11,
...
enum { HHACT_TAB_CONTENTS, HHACT_TAB_INDEX, HHACT_TAB_SEARCH, HHACT_TAB_HISTORY,
	...
	HHACT_JUMP1, HHACT_JUMP2, HHACT_ZOOM, HHACT_TOC_NEXT,
...
HWND HtmlHelpA(HWND,LPCSTR,UINT,DWORD_PTR);
HWND HtmlHelpW(HWND,LPCWSTR,UINT,DWORD_PTR);
#ifdef UNICODE
