...
#define INTERNET_REQFLAG_PASSIVE 16 
#define INTERNET_REQFLAG_CACHE_WRITE_DISABLED 64 
#define INTERNET_REQFLAG_NET_TIMEOUT 128 
...
#define INTERNET_FLAG_CACHE_ASYNC 128 
#define INTERNET_FLAG_FORMS_SUBMIT 64 
#define INTERNET_FLAG_FWD_BACK 32 
...
#define INTERNET_ERROR_MASK_COMBINED_SEC_CERT 2
#define INTERNET_ERROR_MASK_NEED_MSN_SSPI_PKG 0X4
#define INTERNET_ERROR_MASK_LOGIN_FAILURE_DISPLAY_ENTITY_BODY 8
...
typedef enum {
	INTERNET_SCHEME_PARTIAL=-2,INTERNET_SCHEME_UNKNOWN=-1,INTERNET_SCHEME_DEFAULT=0,INTERNET_SCHEME_FTP,INTERNET_SCHEME_GOPHER,INTERNET_SCHEME_HTTP,INTERNET_SCHEME_HTTPS,INTERNET_SCHEME_FILE,INTERNET_SCHEME_NEWS,INTERNET_SCHEME_MAILTO,INTERNET_SCHEME_SOCKS,
	INTERNET_SCHEME_JAVASCRIPT,INTERNET_SCHEME_VBSCRIPT,INTERNET_SCHEME_RES,INTERNET_SCHEME_FIRST=INTERNET_SCHEME_FTP,INTERNET_SCHEME_LAST=INTERNET_SCHEME_RES
...
#define IDSI_FLAG_KEEP_ALIVE 1 
#define IDSI_FLAG_SECURE 2 
#define IDSI_FLAG_PROXY 4 
#define IDSI_FLAG_TUNNEL 8 
typedef struct {
	DWORD dwAccessType;
	LPCTSTR lpszProxy;
...
#define AUTO_PROXY_FLAG_USER_SET 1 
#define AUTO_PROXY_FLAG_ALWAYS_DETECT 2 
#define AUTO_PROXY_FLAG_DETECTION_RUN 4 
#define AUTO_PROXY_FLAG_MIGRATED 8 
#define AUTO_PROXY_FLAG_DONT_CACHE_PROXY_RESULT 16 
#define AUTO_PROXY_FLAG_CACHE_INIT_RUN 32 
#define AUTO_PROXY_FLAG_DETECTION_SUSPECT 64 
typedef struct {
...
BOOLAPI InternetTimeToSystemTimeA(LPCSTR lpszTime,SYSTEMTIME *pst,__null DWORD dwReserved);
BOOLAPI InternetTimeToSystemTimeW(LPCWSTR lpszTime,SYSTEMTIME *pst,__null DWORD dwReserved);
#ifdef UNICODE
...
#else
BOOLAPI InternetTimeToSystemTime(LPCSTR lpszTime,SYSTEMTIME *pst,__null DWORD dwReserved);
#endif 
#endif 
...
InternetConnectA(HINTERNET hInternet,LPCSTR lpszServerName,INTERNET_PORT nServerPort,LPCSTR lpszUserName,LPCSTR lpszPassword,DWORD dwService,DWORD dwFlags,DWORD_PTR dwContext);
INTERNETAPI_(HINTERNET)
InternetConnectW(HINTERNET hInternet,LPCWSTR lpszServerName,INTERNET_PORT nServerPort,LPCWSTR lpszUserName,LPCWSTR lpszPassword,DWORD dwService,DWORD dwFlags,DWORD_PTR dwContext);
#ifdef UNICODE
...
INTERNETAPI_(DWORD) InternetSetFilePointer(HINTERNET hFile,LONG lDistanceToMove,__null PVOID pReserved,DWORD dwMoveMethod,__null DWORD_PTR dwContext);
...
#define AUTH_FLAG_DISABLE_NEGOTIATE 1
#define AUTH_FLAG_ENABLE_NEGOTIATE 2
#define AUTH_FLAG_DISABLE_BASIC_CLEARCHANNEL 4
...
#define SECURITY_FLAG_IETFSSL4 32
...
#define SECURITY_FLAG_IGNORE_REVOCATION 128
#define SECURITY_FLAG_IGNORE_UNKNOWN_CA 256
#define SECURITY_FLAG_IGNORE_WRONG_USAGE 512
...
#endif 
typedef VOID 
(CALLBACK * INTERNET_STATUS_CALLBACK)(HINTERNET hInternet,DWORD_PTR dwContext,DWORD dwInternetStatus,LPVOID lpvStatusInformation,DWORD dwStatusInformationLength);
...
#define INTERNET_STATE_DISCONNECTED_BY_USER 16 
#define INTERNET_STATE_IDLE 256 
#define INTERNET_STATE_BUSY 512 
typedef enum {
	COOKIE_STATE_UNKNOWN=0x0,COOKIE_STATE_ACCEPT=0x1,COOKIE_STATE_PROMPT=0x2,COOKIE_STATE_LEASH=0x3,COOKIE_STATE_DOWNGRADE=0x4,COOKIE_STATE_REJECT=0x5,COOKIE_STATE_MAX=COOKIE_STATE_REJECT,
}
InternetCookieState;
typedef struct {
	int cSession; 
...
#define GOPHER_TYPE_TN3270 2048
...
#endif 
BOOLAPI HttpQueryInfoA(HINTERNET hRequest,DWORD dwInfoLevel,__inout_bcount_opt(*lpdwBufferLength) LPVOID lpBuffer,LPDWORD lpdwBufferLength,LPDWORD lpdwIndex);
BOOLAPI HttpQueryInfoW(HINTERNET hRequest,DWORD dwInfoLevel,__inout_bcount_opt(*lpdwBufferLength) LPVOID lpBuffer,LPDWORD lpdwBufferLength,LPDWORD lpdwIndex);
#ifdef UNICODE
#define HttpQueryInfo HttpQueryInfoW
#else
#define HttpQueryInfo HttpQueryInfoA
#endif 
#define INTERNET_COOKIE_IS_SECURE 1
#define INTERNET_COOKIE_IS_SESSION 2
#define INTERNET_COOKIE_THIRD_PARTY 16
#define INTERNET_COOKIE_PROMPT_REQUIRED 32
#define INTERNET_COOKIE_EVALUATE_P3P 64
#define INTERNET_COOKIE_APPLY_P3P 128
#define INTERNET_COOKIE_P3P_ENABLED 256
#define INTERNET_COOKIE_IS_RESTRICTED 512
#define INTERNET_COOKIE_IE6 1024
#define INTERNET_COOKIE_IS_LEGACY 2048
...
#endif 
INTERNETAPI_(DWORD)
InternetSetCookieExA(LPCSTR lpszUrl,LPCSTR lpszCookieName,LPCSTR lpszCookieData,DWORD dwFlags,__null DWORD_PTR dwReserved);
INTERNETAPI_(DWORD)
InternetSetCookieExW(LPCWSTR lpszUrl,LPCWSTR lpszCookieName,LPCWSTR lpszCookieData,DWORD dwFlags,__null DWORD_PTR dwReserved);
#ifdef UNICODE
#define InternetSetCookieEx InternetSetCookieExW
#else
#define InternetSetCookieEx InternetSetCookieExA
#endif 
BOOLAPI InternetGetCookieExA(LPCSTR lpszUrl,LPCSTR lpszCookieName,LPSTR lpszCookieData,LPDWORD lpdwSize,DWORD dwFlags,__null LPVOID lpReserved);
BOOLAPI InternetGetCookieExW(LPCWSTR lpszUrl,LPCWSTR lpszCookieName,LPWSTR lpszCookieData,LPDWORD lpdwSize,DWORD dwFlags,__null LPVOID lpReserved);
#ifdef UNICODE
...
#endif 
INTERNETAPI_(DWORD)
InternetAttemptConnect(__null DWORD dwReserved);
BOOLAPI InternetCheckConnectionA(LPCSTR lpszUrl,DWORD dwFlags,__null DWORD dwReserved);
BOOLAPI InternetCheckConnectionW(LPCWSTR lpszUrl,DWORD dwFlags,__null DWORD dwReserved);
#ifdef UNICODE
...
#define FLAGS_ERROR_UI_SERIALIZE_DIALOGS 16
DWORD InternetAuthNotifyCallback
(DWORD_PTR dwContext,DWORD dwReturn,LPVOID lpReserved );
...
#define EDITED_CACHE_ENTRY 8
#define TRACK_OFFLINE_CACHE_ENTRY 16
#define TRACK_ONLINE_CACHE_ENTRY 32
...
#define CACHEGROUP_ATTRIBUTE_BASIC 1
#define CACHEGROUP_ATTRIBUTE_FLAG 2
#define CACHEGROUP_ATTRIBUTE_TYPE 4
#define CACHEGROUP_ATTRIBUTE_QUOTA 8
#define CACHEGROUP_ATTRIBUTE_GROUPNAME 16
#define CACHEGROUP_ATTRIBUTE_STORAGE 32
#define CACHEGROUP_FLAG_NONPURGEABLE 1
#define CACHEGROUP_FLAG_GIDONLY 4
#define CACHEGROUP_FLAG_FLUSHURL_ONDELETE 2
#define CACHEGROUP_SEARCH_ALL 0
#define CACHEGROUP_SEARCH_BYURL 1
#define CACHEGROUP_TYPE_INVALID 1
...
#endif 
BOOLAPI CreateUrlCacheEntryA(LPCSTR lpszUrlName,DWORD dwExpectedFileSize,LPCSTR lpszFileExtension,LPSTR lpszFileName,__null DWORD dwReserved);
BOOLAPI CreateUrlCacheEntryW(LPCWSTR lpszUrlName,DWORD dwExpectedFileSize,LPCWSTR lpszFileExtension,LPWSTR lpszFileName,__null DWORD dwReserved);
#ifdef UNICODE
...
BOOLAPI CommitUrlCacheEntryA(LPCSTR lpszUrlName,LPCSTR lpszLocalFileName,FILETIME ExpireTime,FILETIME LastModifiedTime,DWORD CacheEntryType,LPBYTE lpHeaderInfo,DWORD dwHeaderSize,__null LPCSTR lpszFileExtension,LPCSTR lpszOriginalUrl);
BOOLAPI CommitUrlCacheEntryW(LPCWSTR lpszUrlName,LPCWSTR lpszLocalFileName,FILETIME ExpireTime,FILETIME LastModifiedTime,DWORD CacheEntryType,LPWSTR lpszHeaderInfo,DWORD dwHeaders,__null LPCWSTR lpszFileExtension,LPCWSTR lpszOriginalUrl);
#ifdef UNICODE
...
#endif
#else
CommitUrlCacheEntryA(LPCSTR lpszUrlName,LPCSTR lpszLocalFileName,FILETIME ExpireTime,FILETIME LastModifiedTime,DWORD CacheEntryType,LPCSTR lpHeaderInfo,DWORD dwHeaderSize,__null LPCSTR lpszFileExtension,LPCSTR lpszOriginalUrl);
CommitUrlCacheEntryW(LPCWSTR lpszUrlName,LPCWSTR lpszLocalFileName,FILETIME ExpireTime,FILETIME LastModifiedTime,DWORD CacheEntryType,LPCWSTR lpHeaderInfo,DWORD dwHeaderSize,__null LPCWSTR lpszFileExtension,LPCWSTR lpszOriginalUrl);
#ifdef UNICODE
#define CommitUrlCacheEntry CommitUrlCacheEntryW
#else
#define CommitUrlCacheEntry CommitUrlCacheEntryA
#endif 
#endif
BOOLAPI RetrieveUrlCacheEntryFileA(LPCSTR lpszUrlName,LPINTERNET_CACHE_ENTRY_INFOA lpCacheEntryInfo,LPDWORD lpcbCacheEntryInfo,__null DWORD dwReserved);
BOOLAPI RetrieveUrlCacheEntryFileW(LPCWSTR lpszUrlName,LPINTERNET_CACHE_ENTRY_INFOW lpCacheEntryInfo,LPDWORD lpcbCacheEntryInfo,__null DWORD dwReserved);
#ifdef UNICODE
#define RetrieveUrlCacheEntryFile RetrieveUrlCacheEntryFileW
#else
#define RetrieveUrlCacheEntryFile RetrieveUrlCacheEntryFileA
#endif 
BOOLAPI UnlockUrlCacheEntryFileA(LPCSTR lpszUrlName,__null DWORD dwReserved);
BOOLAPI UnlockUrlCacheEntryFileW(LPCWSTR lpszUrlName,__null DWORD dwReserved);
#ifdef UNICODE
...
#else
BOOLAPI UnlockUrlCacheEntryFile(LPCSTR lpszUrlName,__null DWORD dwReserved);
#endif 
#endif 
INTERNETAPI_(HANDLE)
RetrieveUrlCacheEntryStreamA(LPCSTR lpszUrlName,LPINTERNET_CACHE_ENTRY_INFOA lpCacheEntryInfo,LPDWORD lpcbCacheEntryInfo,BOOL fRandomRead,__null DWORD dwReserved);
INTERNETAPI_(HANDLE)
RetrieveUrlCacheEntryStreamW(LPCWSTR lpszUrlName,LPINTERNET_CACHE_ENTRY_INFOW lpCacheEntryInfo,LPDWORD lpcbCacheEntryInfo,BOOL fRandomRead,__null DWORD dwReserved);
#ifdef UNICODE
...
#endif 
BOOLAPI ReadUrlCacheEntryStream(HANDLE hUrlCacheStream,DWORD dwLocation,LPVOID lpBuffer,LPDWORD lpdwLen,__null DWORD Reserved);
BOOLAPI UnlockUrlCacheEntryStream(HANDLE hUrlCacheStream,__null DWORD Reserved);
URLCACHEAPI_(BOOL)
GetUrlCacheEntryInfoA(LPCSTR lpszUrlName,LPINTERNET_CACHE_ENTRY_INFOA lpCacheEntryInfo,LPDWORD lpcbCacheEntryInfo);
URLCACHEAPI_(BOOL)
GetUrlCacheEntryInfoW(LPCWSTR lpszUrlName,LPINTERNET_CACHE_ENTRY_INFOW lpCacheEntryInfo,LPDWORD lpcbCacheEntryInfo);
#ifdef UNICODE
#define GetUrlCacheEntryInfo GetUrlCacheEntryInfoW
#else
#define GetUrlCacheEntryInfo GetUrlCacheEntryInfoA
#endif 
URLCACHEAPI_(HANDLE) FindFirstUrlCacheGroup(DWORD dwFlags,DWORD dwFilter,__null LPVOID lpSearchCondition,DWORD dwSearchCondition,GROUPID* lpGroupId,
	__null LPVOID lpReserved);
URLCACHEAPI_(BOOL) FindNextUrlCacheGroup(HANDLE hFind,GROUPID* lpGroupId,__null LPVOID lpReserved);
URLCACHEAPI_(BOOL) GetUrlCacheGroupAttributeA(GROUPID gid,__null DWORD dwFlags,DWORD dwAttributes,LPINTERNET_CACHE_GROUP_INFOA lpGroupInfo,LPDWORD lpdwGroupInfo,
	__null LPVOID lpReserved);
URLCACHEAPI_(BOOL) GetUrlCacheGroupAttributeW(GROUPID gid,__null DWORD dwFlags,DWORD dwAttributes,LPINTERNET_CACHE_GROUP_INFOW lpGroupInfo,LPDWORD lpdwGroupInfo,
	__null LPVOID lpReserved);
#ifdef UNICODE
...
#endif 
URLCACHEAPI_(BOOL) SetUrlCacheGroupAttributeA(GROUPID gid,__null DWORD dwFlags,DWORD dwAttributes,LPINTERNET_CACHE_GROUP_INFOA lpGroupInfo,__null LPVOID lpReserved);
URLCACHEAPI_(BOOL) SetUrlCacheGroupAttributeW(GROUPID gid,__null DWORD dwFlags,DWORD dwAttributes,LPINTERNET_CACHE_GROUP_INFOW lpGroupInfo,__null LPVOID lpReserved);
#ifdef UNICODE
#define SetUrlCacheGroupAttribute SetUrlCacheGroupAttributeW
#else
#define SetUrlCacheGroupAttribute SetUrlCacheGroupAttributeA
#endif 
INTERNETAPI_(GROUPID) CreateUrlCacheGroup(DWORD dwFlags,__null LPVOID lpReserved);
BOOLAPI DeleteUrlCacheGroup(GROUPID GroupId,DWORD dwFlags,__null LPVOID lpReserved);
BOOLAPI GetUrlCacheEntryInfoExA(LPCSTR lpszUrl,LPINTERNET_CACHE_ENTRY_INFOA lpCacheEntryInfo,LPDWORD lpcbCacheEntryInfo,__null LPSTR lpszRedirectUrl,__null LPDWORD lpcbRedirectUrl,__null LPVOID lpReserved,DWORD dwFlags);
BOOLAPI GetUrlCacheEntryInfoExW(LPCWSTR lpszUrl,LPINTERNET_CACHE_ENTRY_INFOW lpCacheEntryInfo,LPDWORD lpcbCacheEntryInfo,__null LPWSTR lpszRedirectUrl,__null LPDWORD lpcbRedirectUrl,__null LPVOID lpReserved,DWORD dwFlags);
#ifdef UNICODE
...
#define CACHE_ENTRY_HITRATE_FC 16
#define CACHE_ENTRY_MODTIME_FC 64
#define CACHE_ENTRY_EXPTIME_FC 128
#define CACHE_ENTRY_ACCTIME_FC 256
#define CACHE_ENTRY_SYNCTIME_FC 512
#define CACHE_ENTRY_HEADERINFO_FC 1024
#define CACHE_ENTRY_EXEMPT_DELTA_FC 2048
...
BOOLAPI SetUrlCacheEntryGroupA(LPCSTR lpszUrlName,DWORD dwFlags,GROUPID GroupId,__null LPBYTE pbGroupAttributes,__null DWORD cbGroupAttributes,__null LPVOID lpReserved );
BOOLAPI SetUrlCacheEntryGroupW(LPCWSTR lpszUrlName,DWORD dwFlags,GROUPID GroupId,__null LPBYTE pbGroupAttributes,__null DWORD cbGroupAttributes,__null LPVOID lpReserved );
#ifdef UNICODE
...
#else
BOOLAPI SetUrlCacheEntryGroup(LPCSTR lpszUrlName,DWORD dwFlags,GROUPID GroupId,__null LPBYTE pbGroupAttributes,__null DWORD cbGroupAttributes,__null LPVOID lpReserved );
#endif 
#endif 
INTERNETAPI_(HANDLE)
FindFirstUrlCacheEntryExA(LPCSTR lpszUrlSearchPattern,DWORD dwFlags,DWORD dwFilter,GROUPID GroupId,LPINTERNET_CACHE_ENTRY_INFOA lpFirstCacheEntryInfo,LPDWORD lpcbEntryInfo,__null LPVOID lpGroupAttributes,__null LPDWORD lpcbGroupAttributes,
	__null LPVOID lpReserved);
INTERNETAPI_(HANDLE)
FindFirstUrlCacheEntryExW(LPCWSTR lpszUrlSearchPattern,DWORD dwFlags,DWORD dwFilter,GROUPID GroupId,LPINTERNET_CACHE_ENTRY_INFOW lpFirstCacheEntryInfo,LPDWORD lpcbEntryInfo,__null LPVOID lpGroupAttributes,__null LPDWORD lpcbGroupAttributes,
	__null LPVOID lpReserved);
#ifdef UNICODE
...
#endif 
BOOLAPI FindNextUrlCacheEntryExA(HANDLE hEnumHandle,LPINTERNET_CACHE_ENTRY_INFOA lpNextCacheEntryInfo,LPDWORD lpcbEntryInfo,__null LPVOID lpGroupAttributes,__null LPDWORD lpcbGroupAttributes,__null LPVOID lpReserved);
BOOLAPI FindNextUrlCacheEntryExW(HANDLE hEnumHandle,LPINTERNET_CACHE_ENTRY_INFOW lpNextCacheEntryInfo,LPDWORD lpcbEntryInfo,__null LPVOID lpGroupAttributes,__null LPDWORD lpcbGroupAttributes,__null LPVOID lpReserved);
#ifdef UNICODE
...
#endif 
INTERNETAPI_(HANDLE)
FindFirstUrlCacheEntryA(LPCSTR lpszUrlSearchPattern,LPINTERNET_CACHE_ENTRY_INFOA lpFirstCacheEntryInfo,LPDWORD lpcbCacheEntryInfo);
INTERNETAPI_(HANDLE)
FindFirstUrlCacheEntryW(LPCWSTR lpszUrlSearchPattern,LPINTERNET_CACHE_ENTRY_INFOW lpFirstCacheEntryInfo,LPDWORD lpcbCacheEntryInfo);
#ifdef UNICODE
...
#endif 
#endif 
INTERNETAPI_(DWORD) InternetDialA(HWND hwndParent,LPSTR lpszConnectoid,DWORD dwFlags,DWORD_PTR *lpdwConnection,__null DWORD dwReserved);
INTERNETAPI_(DWORD) InternetDialW(HWND hwndParent,LPWSTR lpszConnectoid,DWORD dwFlags,DWORD_PTR *lpdwConnection,__null DWORD dwReserved);
#ifdef UNICODE
...
#else
INTERNETAPI_(DWORD) InternetDial(HWND hwndParent,LPSTR lpszConnectoid,DWORD dwFlags,LPDWORD lpdwConnection,__null DWORD dwReserved);
#endif 
#endif 
#define INTERNET_DIAL_FORCE_PROMPT 0x2000
#define INTERNET_DIAL_SHOW_OFFLINE 0x4000
#define INTERNET_DIAL_UNATTENDED 0x8000
INTERNETAPI_(DWORD) InternetHangUp(DWORD_PTR dwConnection,__null DWORD dwReserved);
#define INTERENT_GOONLINE_REFRESH 1
#define INTERENT_GOONLINE_MASK 1
INTERNETAPI_(BOOL) InternetGoOnlineA(LPSTR lpszURL,HWND hwndParent,DWORD dwFlags);
INTERNETAPI_(BOOL) InternetGoOnlineW(LPWSTR lpszURL,HWND hwndParent,DWORD dwFlags);
#ifdef UNICODE
...
INTERNETAPI_(BOOL) InternetAutodialHangup(__null DWORD dwReserved);
INTERNETAPI_(BOOL) InternetGetConnectedState(LPDWORD lpdwFlags,__null DWORD dwReserved);
INTERNETAPI_(BOOL)
InternetGetConnectedStateExA(LPDWORD lpdwFlags,LPSTR lpszConnectionName,DWORD dwBufLen,__null DWORD dwReserved);
INTERNETAPI_(BOOL)
InternetGetConnectedStateExW(LPDWORD lpdwFlags,LPWSTR lpszConnectionName,DWORD dwBufLen,__null DWORD dwReserved);
...
INTERNETAPI_(BOOL) InternetInitializeAutoProxyDll(__null DWORD dwReserved);
INTERNETAPI_(BOOL) InternetDeInitializeAutoProxyDll(LPSTR lpszMime,__null DWORD dwReserved);
INTERNETAPI_(BOOL) InternetGetProxyInfo(LPCSTR lpszUrl,DWORD dwUrlLength,LPSTR lpszUrlHostName,DWORD dwUrlHostNameLength,LPSTR * lplpszProxyHostName,LPDWORD lpdwProxyHostNameLength);
...
#else
INTERNETAPI_(BOOL) InternetGetConnectedStateEx(LPDWORD lpdwFlags,LPSTR lpszConnectionName,DWORD dwNameLen,__null DWORD dwReserved);
#endif 
#endif 
...
INTERNETAPI_(BOOL) InternetSetDialStateA(LPCSTR lpszConnectoid,DWORD dwState,__null DWORD dwReserved);
INTERNETAPI_(BOOL) InternetSetDialStateW(LPCWSTR lpszConnectoid,DWORD dwState,__null DWORD dwReserved);
#ifdef UNICODE
...
#else
INTERNETAPI_(BOOL) InternetSetDialState(LPCSTR lpszConnectoid,DWORD dwState,__null DWORD dwReserved);
#endif 
#endif 
...
#endif 
#define INTERNET_IDENTITY_FLAG_PRIVATE_CACHE 1
#define INTERNET_IDENTITY_FLAG_SHARED_CACHE 2
#define INTERNET_IDENTITY_FLAG_CLEAR_DATA 4
#define INTERNET_IDENTITY_FLAG_CLEAR_COOKIES 8
#define INTERNET_IDENTITY_FLAG_CLEAR_HISTORY 16
#define INTERNET_IDENTITY_FLAG_CLEAR_CONTENT 32
#define INTERNET_SUPPRESS_RESET_ALL 0
#define INTERNET_SUPPRESS_COOKIE_POLICY 1
#define INTERNET_SUPPRESS_COOKIE_POLICY_RESET 2
...
INTERNETAPI_(DWORD)
PrivacySetZonePreferenceW(DWORD dwZone,DWORD dwType,DWORD dwTemplate,LPCWSTR pszPreference);
INTERNETAPI_(DWORD)
PrivacyGetZonePreferenceW(DWORD dwZone,DWORD dwType,LPDWORD pdwTemplate,LPWSTR pszBuffer,LPDWORD pdwBufferLength);
#include <poppack.h>
#endif 
