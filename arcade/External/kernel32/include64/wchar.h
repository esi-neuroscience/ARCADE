...
/* also declared in io.h */
 ...
 long  _wfindnext(long, struct _wfinddata_t *);
...
/* also declared in stdio.h */
 ...
 int  swnprintf(wchar_t *, size_t ,const wchar_t *, ...);
 int swprintf(wchar_t * restrict s, size_t n, const wchar_t * restrict format, ...);
 int  vfwprintf(FILE *, const wchar_t *, va_list);
 int  vwprintf(const wchar_t *, va_list);
 int  _vsnwprintf(wchar_t *, size_t, const wchar_t *, va_list);
 int  vswprintf(wchar_t *, size_t,const wchar_t *, va_list);
int vstprintfw(wchar_t *,const wchar_t *, va_list);
...
#endif /* !__STDC__ */
int wcsrepl(wchar_t *inputstring,wchar_t *tofind,wchar_t *replacement,wchar_t *output);
