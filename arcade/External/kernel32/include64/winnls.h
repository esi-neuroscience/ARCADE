...
#define LCMAP_HIRAGANA 0x100000 
#define LCMAP_KATAKANA 0x200000 
#define LCMAP_HALFWIDTH 0x400000 
#define LCMAP_FULLWIDTH 0x800000 
#define LCMAP_LINGUISTIC_CASING 0x1000000 
...
enum SYSGEOTYPE {
	GEO_NATION=0x0001,GEO_LATITUDE=0x0002,GEO_LONGITUDE=0x0003,GEO_ISO2=0x0004,GEO_ISO3=0x0005,GEO_RFC1766=0x0006,GEO_LCID=0x0007,GEO_FRIENDLYNAME=0x0008,
	GEO_OFFICIALNAME=0x0009,GEO_TIMEZONES=0x000A,GEO_OFFICIALLANGUAGES=0x000B,};
enum SYSGEOCLASS {
