...
typedef uInt32             TaskHandle; // recommended fix - Jarrod 
...
#define DAQmx_Dev_AI_MaxMultiChanRate                                    0x298D // Indicates the maximum rate for an analog input task if the task contains multiple channels from this device. For multiplexed devices, divide this rate by the number of channels to aqcuire data from (including cold-junction compensation and autozero channels) to determine the maximum sampling rate.
...
#define DAQmx_Val_Switch_Topology_2531_2_Wire_4x64_Matrix         "2531/2-Wire 4x64 Matrix"           // 2531/2-Wire 4x64 Matrix
#define DAQmx_Val_Switch_Topology_2531_2_Wire_8x32_Matrix         "2531/2-Wire 8x32 Matrix"           // 2531/2-Wire 8x32 Matrix
